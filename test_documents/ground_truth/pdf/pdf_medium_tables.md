...
Erik Alestig¹, Birgitta Arnholm², Anders Eilard¹, Martin Lagging¹, Staffan Nilsson³, Gunnar Norkrans¹,
Thomas Wahlberg⁴, Rune Wejstål¹, Johan Westin¹ and Magnus Lindh¹
...
therapy with pegylated interferon and ribavirin (Peg-
IFN/RBV), given for 24 to 72 weeks, may eradicate the
...
70 (R70Q) and 91 (L91M) respond less well to treat-
ment [11-13], and it was suggested that pre- and on-
treatment analysis of core region polymorphism may be
...
region. For sequencing, nucleic acid extraction was per-
formed on 200 µl of patient serum using a MagNA Pure
LC Instrument (Roche Applied Science, Mannheim, Ger-
many). Complementary DNA was created with random
...
(709R).
Strains of genotype 1b were also amplified using pri-
mers outer forward GTCACAACTCCCATGCGAGC
...
and MacVector (MacVector Inc., Cambridge, UK) soft-
ware were used for editing and phylogenetic analysis.
...
subtype 1b strains with Q70 and one subtype la strain
...
linked to subgenotype 1b: Six (5 non-SVR) of 13 geno-
type 1b strains had Q70, while only one of 37 subgeno-
type la strain had a substitution (P70) at this site (p =
0.0007). Similarly, all la strains had cysteine at residue
...
with better treatment response in several previous stu-
dies, was identified in 18 patients, and 16 of them (89%)
were achieved SVR. The unfavourable SNP genotype
(TT) was found in 8 patients and none of them was
responder. The remaining 24 patients were CT hetero-
zygous, 13 (54%) of them achieved SVR. In an attempt
...
non-SVR) with subgenotype la infection carried strains
with R70. A similar lack of impact by core mutations in
subgenotype la was recently reported by others [21].
The mechanism for the potential impact on treatment
response is unknown, and it is possible that the varia-
tion at residue 70 is only indirectly linked to response.
...
carrying HCV-1b strains, was observed in 98% of la
sequences from GenBank (Table 3). Conversely, Q70,
which seems to be associated with non-SVR in patients
carrying subgenotype HCV-1b, is the predominant var-
iant in genotypes 5 and 6, despite the fact that patients
...
observations do not exclude a direct effect of core resi-
due 70 on treatment response, because glutamine at
position 70 might influence conformation and function
of the core protein differently in HCV-1b than in HCV-
la or other genotypes. Indeed, a previous study has
described that subgenotype la and 1b show different
...
rate in patients with 1b than in those with la [24].
In order to find out if the core 70 or 91 variants might
be linked to the phylogeny HCV-1b, core sequences
from the 9 patients included in this study and 100 ran-
domly chosen database sequences were compared by
...
substitutions in the ISDR in the NS5A region are asso-
ciated with treatment response in patients infected with
...
favourable CC genotype at rs12979860, than in Cauca-
sian populations where also the CT and TT IL28B geno-
types are frequent. However, we did not find any
...
that HCV core analysis might be clinically relevant, pri-
marily in patients with the CTrs12979860 genotype. Multi-
...
casian patients with chronic hepatitis C. The observation
