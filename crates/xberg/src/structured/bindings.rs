...
/// # Errors
///
/// Returns [`crate::XbergError::Validation`] when either JSON argument is
/// malformed.  All other failures from the underlying
/// [`super::extract_structured_sync`] call are mapped onto [`crate::XbergError`]
...
/// Returns [`crate::XbergError::Validation`] when either JSON argument is
/// malformed.  All other failures from the underlying
/// [`super::split_and_extract_sync`] call are mapped onto [`crate::XbergError`]
/// via [`From<StructuredError>`](super::StructuredError).
