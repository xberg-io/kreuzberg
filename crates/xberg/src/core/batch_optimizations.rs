...
impl BatchProcessor {
    ...
    ///
    /// ```rust,no_run
    /// use xberg::core::batch_optimizations::BatchProcessor;
    ///
    ...
    ///
    /// ```rust,no_run
    /// use xberg::core::batch_optimizations::{BatchProcessor, BatchProcessorConfig};
    ///
    ...
    /// ```ignore
    /// use xberg::core::batch_optimizations::BatchProcessor;
    /// use xberg::utils::pool_sizing::estimate_pool_size;
    ///
