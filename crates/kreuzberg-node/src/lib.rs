...
// alef:hash:73a2d321a96278fd3dc9e847617cab0b89688e38a5ce6222bc68c3753a3c7036
...
#[allow(clippy::missing_errors_doc)]
#[napi(js_name = "extractFileSyncFfi")]
...
pub async fn extract_file_ffi(
    ...
    let config_core: kreuzberg::ExtractionConfig = serde_json::from_str(&config_json)
        .map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))?;
    kreuzberg::extract_file_ffi(&path, &mime_type, &config_core)
        .await
        .map(|val| val.into())
        .map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))
}
