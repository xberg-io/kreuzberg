...
// alef:hash:7c54b58cff626d7a423ebaf553ec10ee98c36c0a9a6e35552dfd5f90fa3f1a25
...
pub fn unregister_embedding_backend(name: String) -> Result<()> {
...
pub fn pdf_page_count(pdf_bytes: Vec<u8>, password: Option<String>) -> Result<i64> {
