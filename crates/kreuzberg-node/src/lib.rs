...
// alef:hash:83cd5e3efdaceacea7ffa1d0f46e36f9d10ba45592b78de02e6cb09b9ac81251
...
#[allow(clippy::missing_errors_doc)]
#[napi(js_name = "renderHtmlStr")]
pub fn render_html_str(html: String) -> Result<String> {
    kreuzberg::render_html_str(&html).map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))
}

#[allow(clippy::missing_errors_doc)]
#[napi(js_name = "renderMarkdownStr")]
pub fn render_markdown_str(html: String) -> Result<String> {
    kreuzberg::render_markdown_str(&html).map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))
}

#[allow(clippy::missing_errors_doc)]
#[napi(js_name = "renderDjotStr")]
pub fn render_djot_str(html: String) -> Result<String> {
    kreuzberg::render_djot_str(&html).map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))
}

#[allow(clippy::missing_errors_doc)]
#[napi(js_name = "renderJsonStr")]
pub fn render_json_str(html: String) -> Result<String> {
    kreuzberg::render_json_str(&html).map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))
}

#[allow(clippy::missing_errors_doc)]
#[napi(js_name = "renderPlainStr")]
pub fn render_plain_str(html: String) -> Result<String> {
    kreuzberg::render_plain_str(&html).map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))
}
...
#[allow(clippy::missing_errors_doc)]
#[napi(js_name = "extractDocText")]
pub fn extract_doc_text(content: Vec<u8>) -> Result<JsDocExtractionResult> {
...
pub fn extract_pptx_from_bytes(data: Vec<u8>) -> Result<JsPptxExtractionResult> {
...
#[allow(clippy::missing_errors_doc)]
#[napi(js_name = "extractFileToToon")]
pub fn extract_file_to_toon(path: String, config: JsExtractionConfig) -> Result<String> {
    let config_json =
        serde_json::to_string(&config).map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))?;
    let config_core: kreuzberg::ExtractionConfig = serde_json::from_str(&config_json)
        .map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))?;
...
#[allow(clippy::missing_errors_doc)]
#[napi(js_name = "extractFileToJson")]
pub fn extract_file_to_json(path: String, config: JsExtractionConfig) -> Result<String> {
    let config_json =
        serde_json::to_string(&config).map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))?;
    let config_core: kreuzberg::ExtractionConfig = serde_json::from_str(&config_json)
        .map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))?;
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsDocExtractionResult> for kreuzberg::DocExtractionResult {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::DocExtractionResult> for JsDocExtractionResult {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsDocMetadata> for kreuzberg::DocMetadata {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::DocMetadata> for JsDocMetadata {
