...
// alef:hash:491087e0d94440da84d003c17e85c332267a1e4a2775068a2d61eacf877ca8e3
 ...
 */
export declare function extractDocText(content: Uint8Array): JsDocExtractionResult;
...
export declare function extractFileToJson(path: string, config: JsExtractionConfig): string;
 ...
 */
export declare function extractFileToToon(path: string, config: JsExtractionConfig): string;
 ...
 */
export declare function extractPptxFromBytes(data: Uint8Array): JsPptxExtractionResult;
 ...
 */
export declare function fixMojibake(text: string): string;
 ...
 */
export declare function generateCacheKey(parts: Array<Array<string>>): string;
 ...
 * ```
 */
export declare function renderDjotStr(html: string): string;
 ...
 * ```
 */
export declare function renderJsonStr(html: string): string;
 ...
 * ```
 */
export declare function renderMarkdownStr(html: string): string;
 ...
 * ```
 */
export declare function renderPlainStr(html: string): string;
