...
export interface DocumentExtractor {
   ...
   */
  extract_bytes(content: Uint8Array, mimeType: string, config?: ExtractionConfig | undefined | null): string
  /**
   * Extract content from a file.
   *
   ...
   */
  extract_file?(path: string, mimeType: string, config?: ExtractionConfig | undefined | null): string
  /**
...
export interface EmbeddingBackend {
   ...
   */
  embed(texts: Array<string>): string
}
...
export interface OcrBackend {
   ...
   * ```
   */
  process_image(imageBytes: Uint8Array, config?: OcrConfig | undefined | null): string
  /**
   ...
   */
  process_image_file?(path: string, config?: OcrConfig | undefined | null): string
  /**
   ...
   * @param config - OCR configuration
   */
  process_document?(path: string, config?: OcrConfig | undefined | null): string
}
...
export interface PostProcessor {
   ...
   * ```
   */
  process(result?: ExtractionResult | undefined | null, config?: ExtractionConfig | undefined | null): void
  /**
...
export interface Validator {
   ...
   * ```
   */
  validate(result?: ExtractionResult | undefined | null, config?: ExtractionConfig | undefined | null): void
  /**
