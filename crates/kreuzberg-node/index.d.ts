...
// alef:hash:9f4d97666fc2dbcdab302269ffe67a01abcbecc465d00b4e2ccda55820047091
 ...
 */
export declare function extractFileFfi(path: string, mimeType: string, config: JsExtractionConfig): Promise<JsExtractionResult>;
 ...
 */
export declare function extractFileSyncFfi(path: string, mimeType: string, config: JsExtractionConfig): JsExtractionResult;
