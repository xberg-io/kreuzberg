...
// alef:hash:a0085717d0562db9fe6a317c01d380a1e44ab86dc42dbe120214a3dd9c6e2602
...
export interface CacheWarmParams {
  /** Download all embedding model presets */
  readonly allEmbeddings: boolean
...
export interface DetectMimeTypeParams {
  /** Path to the file */
  readonly path: string
  /** Use content-based detection (default: true) */
  readonly useContent: boolean
}
 ...
 */
export interface DoclingCompatResponse {
...
export interface EmbedTextParams {
   ...
   */
  readonly embeddingPlugin?: string
}
...
export interface HtmlExtractionResult {
  readonly markdown: string
  readonly images: Array<ExtractedInlineImage>
 ...
 */
export interface OdtProperties {
  ...
  readonly initialCreator?: string
  ...
  readonly editingDuration?: string
  /** Number of edits/revisions (meta:editing-cycles) */
  readonly editingCycles?: string
 ...
 */
export interface OpenWebDocumentResponse {
  /** Extracted text content */
...
export interface PageMarginsPoints {
  readonly top?: number
  readonly right?: number
  readonly bottom?: number
  readonly left?: number
 ...
 * ```typescript
 */
export interface SyncExtractor {
  /**
   ...
   * @returns An `InternalDocument` containing the extracted elements, metadata, and tables.
   */
  extractSync?(content: Uint8Array, mimeType: string, config: ExtractionConfig): InternalDocument
}
...
export declare class TracingLayer {
}
...
export interface WarmResponse {
  ...
  readonly alreadyCached: Array<string>
}
