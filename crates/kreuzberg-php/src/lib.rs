...
impl KreuzbergApi {
    ...
    pub fn extract_bytes(
        ...
        let config_core: Option<kreuzberg::ExtractionConfig> = config.as_ref().map(|v| v.clone().into());
    ...
    pub fn embed_texts_async(texts: Vec<String>, config: Option<&EmbeddingConfig>) -> PhpResult<Vec<Vec<f32>>> {
        let config_core: Option<kreuzberg::EmbeddingConfig> = config.as_ref().map(|v| v.clone().into());
        WORKER_RUNTIME.block_on(async {
