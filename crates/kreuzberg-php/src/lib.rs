...
// alef:hash:cd3bf745d1aab6f682588230fdb46cbbbe2aaee457206287d03ad7b2b8d423fd
...
impl Metadata {
    ...
    #[php(getter)]
    pub fn get_additional(&self) -> HashMap<String, serde_json::Value> {
        self.additional.clone()
    }
...
impl DocxMetadata {
    ...
    #[php(getter)]
    pub fn get_customProperties(&self) -> Option<HashMap<String, serde_json::Value>> {
...
impl OcrElement {
    ...
    #[php(getter)]
    pub fn get_backendMetadata(&self) -> HashMap<String, serde_json::Value> {
