...
// alef:hash:8726df07f79d98cb7238e0cf1faf1b11b047cfccc5cebb90527e28a60cc96a95
...
#[derive(Clone, serde::Serialize, serde::Deserialize, Default)]
#[php_class]
#[php(name = "Kreuzberg\\DocExtractionResult")]
...
impl DocExtractionResult {
    ...
    #[php(getter)]
    pub fn get_metadata(&self) -> DocMetadata {
        self.metadata.clone()
    }
}
...
#[derive(Clone, serde::Serialize, serde::Deserialize, Default)]
#[php_class]
#[php(name = "Kreuzberg\\DocMetadata")]
...
impl NodeContent {
    ...
    #[php(getter)]
    pub fn get_grid(&self) -> Option<String> {
        self.grid.clone()
    }
...
impl KreuzbergApi {
    ...
    pub fn blake3_hash_file(path: String) -> PhpResult<String> {
        let result = kreuzberg::blake3_hash_file(std::path::Path::new(&path))
            .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
     ...
     * ```
     */
    pub fn validate_port(port: u32) -> PhpResult<()> {
        let result =
            kreuzberg::validate_port(port).map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
    ...
    pub fn validate_host(host: String) -> PhpResult<()> {
        let result =
            kreuzberg::validate_host(&host).map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
    ...
    pub fn validate_binarization_method(method: String) -> PhpResult<()> {
        let result = kreuzberg::validate_binarization_method(&method)
            .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
    ...
    pub fn validate_token_reduction_level(level: String) -> PhpResult<()> {
        let result = kreuzberg::validate_token_reduction_level(&level)
            .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
    ...
    pub fn validate_ocr_backend(backend: String) -> PhpResult<()> {
        let result = kreuzberg::validate_ocr_backend(&backend)
            .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
    ...
    pub fn validate_language_code(code: String) -> PhpResult<()> {
        let result = kreuzberg::validate_language_code(&code)
            .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
    ...
    pub fn validate_tesseract_psm(psm: i32) -> PhpResult<()> {
        let result = kreuzberg::validate_tesseract_psm(psm)
            .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
    ...
    pub fn validate_tesseract_oem(oem: i32) -> PhpResult<()> {
        let result = kreuzberg::validate_tesseract_oem(oem)
            .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
    ...
    pub fn validate_output_format(format: String) -> PhpResult<()> {
        let result = kreuzberg::validate_output_format(&format)
            .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
    ...
    pub fn validate_confidence(confidence: f64) -> PhpResult<()> {
        let result = kreuzberg::validate_confidence(confidence)
            .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
    ...
    pub fn validate_chunking_params(max_chars: i64, max_overlap: i64) -> PhpResult<()> {
        let result = kreuzberg::validate_chunking_params(max_chars as usize, max_overlap as usize)
            .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
    ...
    pub fn djot_to_html(djot_source: String) -> PhpResult<String> {
        let result = kreuzberg::djot_to_html(&djot_source)
            .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
     ...
     * ```
     */
    pub fn render_html_str(html: String) -> PhpResult<String> {
        let result = kreuzberg::render_html_str(&html)
            .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
     ...
     * ```
     */
    pub fn render_markdown_str(html: String) -> PhpResult<String> {
        let result = kreuzberg::render_markdown_str(&html)
            .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
     ...
     * ```
     */
    pub fn render_djot_str(html: String) -> PhpResult<String> {
        let result = kreuzberg::render_djot_str(&html)
            .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
     ...
     * ```
     */
    pub fn render_json_str(html: String) -> PhpResult<String> {
        let result = kreuzberg::render_json_str(&html)
            .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
     ...
     * ```
     */
    pub fn render_plain_str(html: String) -> PhpResult<String> {
        let result = kreuzberg::render_plain_str(&html)
            .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
     ...
     */
    pub fn warm_model(model_type: &EmbeddingModelType, cache_dir: Option<String>) -> PhpResult<()> {
     ...
     */
    pub fn download_model(model_type: &EmbeddingModelType, cache_dir: Option<String>) -> PhpResult<()> {
        let model_type_json = serde_json::to_string(&model_type).map_err(|e| format!("{e}"))?;
        let model_type_core: kreuzberg::EmbeddingModelType =
            serde_json::from_str(&model_type_json).map_err(|e| format!("{e}"))?;
    ...
    pub fn detect_languages(text: String, config: &LanguageDetectionConfig) -> PhpResult<Option<Vec<String>>> {
        ...
        let config_core: kreuzberg::LanguageDetectionConfig =
            serde_json::from_str(&config_json).map_err(|e| format!("{e}"))?;
        let result = kreuzberg::detect_languages(&text, &config_core)
            .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
    ...
    pub fn extract_text_from_pdf(pdf_bytes: Vec<u8>) -> PhpResult<String> {
        let result = kreuzberg::extract_text_from_pdf(&pdf_bytes)
            .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
     ...
     */
    pub fn convert_html_to_markdown(html: String) -> PhpResult<String> {
        let result = kreuzberg::convert_html_to_markdown(&html)
            .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
     ...
     */
    pub fn extract_doc_text(content: Vec<u8>) -> PhpResult<DocExtractionResult> {
        let result = kreuzberg::extract_doc_text(&content)
            .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result.into())
    }
     ...
     */
    pub fn extract_pptx_from_bytes(data: Vec<u8>) -> PhpResult<PptxExtractionResult> {
        let result = kreuzberg::extract_pptx_from_bytes(&data)
            .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result.into())
    }
     ...
     */
    pub fn extract_file_to_toon(path: String, config: &ExtractionConfig) -> PhpResult<String> {
        let config_json = serde_json::to_string(&config).map_err(|e| format!("{e}"))?;
        let config_core: kreuzberg::ExtractionConfig =
            serde_json::from_str(&config_json).map_err(|e| format!("{e}"))?;
        let result = kreuzberg::extract_file_to_toon(std::path::PathBuf::from(path), &config_core)
            .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
     ...
     */
    pub fn extract_file_to_json(path: String, config: &ExtractionConfig) -> PhpResult<String> {
        let config_json = serde_json::to_string(&config).map_err(|e| format!("{e}"))?;
        let config_core: kreuzberg::ExtractionConfig =
            serde_json::from_str(&config_json).map_err(|e| format!("{e}"))?;
        let result = kreuzberg::extract_file_to_json(std::path::PathBuf::from(path), &config_core)
            .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
}
