...
// alef:hash:52b37a50f6de45c914bccd69496f56946444da60b1acaa7a4a6d348cf91619fa
...
impl KreuzbergApi {
     ...
     */
    pub fn unregister_embedding_backend(name: String) -> PhpResult<()> {
        let result = kreuzberg::plugins::unregister_embedding_backend(&name)
            .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
    ...
    pub fn list_embedding_backends() -> PhpResult<Vec<String>> {
        let result = kreuzberg::plugins::list_embedding_backends()
            .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
     ...
     */
    pub fn clear_embedding_backends() -> PhpResult<()> {
        let result = kreuzberg::plugins::clear_embedding_backends()
            .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
     ...
     * ```
     */
    pub fn pdf_page_count(pdf_bytes: Vec<u8>, password: Option<String>) -> PhpResult<i64> {
        let result = kreuzberg::pdf::rendering::pdf_page_count(&pdf_bytes, password.as_deref())
            .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result as i64)
    }
