...
//! binaries live in the kreuzberg codebase itself.

#![cfg(feature = "heic")]

use kreuzberg::core::config::ExtractionConfig;
use kreuzberg::core::mime::list_supported_formats;
use kreuzberg::{FormatMetadata, extract_bytes};
...
async fn extract_image_metadata(bytes: &'static [u8], mime: &str) -> kreuzberg::ImageMetadata {
