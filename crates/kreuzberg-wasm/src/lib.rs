...
// alef:hash:dcd5e0c9e007302e3f047e82cfc5932da69b7f23779332462d1ae2db5891a184
...
pub fn unregister_embedding_backend(name: String) -> Result<(), JsValue> {
    let result =
        kreuzberg::plugins::unregister_embedding_backend(&name).map_err(|e| JsValue::from_str(&e.to_string()))?;
    Ok(result)
}
...
pub fn list_embedding_backends() -> Result<Vec<String>, JsValue> {
    let result = kreuzberg::plugins::list_embedding_backends().map_err(|e| JsValue::from_str(&e.to_string()))?;
    Ok(result)
}
...
pub fn clear_embedding_backends() -> Result<(), JsValue> {
    let result = kreuzberg::plugins::clear_embedding_backends().map_err(|e| JsValue::from_str(&e.to_string()))?;
    Ok(result)
}
...
pub fn pdf_page_count(pdf_bytes: Vec<u8>, password: Option<String>) -> Result<usize, JsValue> {
