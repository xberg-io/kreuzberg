...
// alef:hash:ae619d2b877ffbe184af81d545b192eaaf40e39dce225e01bae62b4566d13313
...
#[derive(Clone, Default)]
#[wasm_bindgen(js_name = "CharShape")]
...
#[derive(Clone)]
#[wasm_bindgen(js_name = "StreamReader")]
...
#[derive(Clone, Default)]
#[wasm_bindgen(js_name = "HtmlExtractionResult")]
...
#[derive(Clone, Default)]
#[wasm_bindgen(js_name = "ExtractedInlineImage")]
...
impl WasmDrawing {
    ...
    #[wasm_bindgen(constructor)]
    pub fn new(
        drawingType: Option<String>,
        extent: Option<String>,
        docProperties: Option<String>,
        imageRef: Option<String>,
    ) -> WasmDrawing {
        WasmDrawing {
            drawing_type: drawingType.unwrap_or_default(),
            extent,
...
#[derive(Clone, Default)]
#[wasm_bindgen(js_name = "AnchorProperties")]
...
impl WasmAnchorProperties {
    ...
    #[wasm_bindgen(constructor)]
    pub fn new(
        behindDoc: Option<bool>,
        layoutInCell: Option<bool>,
        wrapType: Option<String>,
        relativeHeight: Option<i64>,
        positionH: Option<String>,
        positionV: Option<String>,
    ) -> WasmAnchorProperties {
        WasmAnchorProperties {
            behind_doc: behindDoc.unwrap_or_default(),
            layout_in_cell: layoutInCell.unwrap_or_default(),
            relative_height: relativeHeight,
            position_h: positionH,
            position_v: positionV,
            wrap_type: wrapType.unwrap_or_default(),
        }
    }
...
#[derive(Clone, Default)]
#[wasm_bindgen(js_name = "PageMarginsPoints")]
...
#[derive(Clone, Default)]
#[wasm_bindgen(js_name = "StyleDefinition")]
...
#[derive(Clone, Default)]
#[wasm_bindgen(js_name = "ResolvedStyle")]
...
impl WasmResolvedStyle {
    #[allow(non_snake_case)]
    #[wasm_bindgen(constructor)]
    pub fn new(paragraphProperties: Option<String>, runProperties: Option<String>) -> WasmResolvedStyle {
        WasmResolvedStyle {
            paragraph_properties: paragraphProperties.unwrap_or_default(),
            run_properties: runProperties.unwrap_or_default(),
        }
    }
...
#[derive(Clone, Default)]
#[wasm_bindgen(js_name = "DocxAppProperties")]
...
#[derive(Clone, Default)]
#[wasm_bindgen(js_name = "XlsxAppProperties")]
...
#[derive(Clone, Default)]
#[wasm_bindgen(js_name = "PptxAppProperties")]
...
#[derive(Clone, Default)]
#[wasm_bindgen(js_name = "CoreProperties")]
...
#[derive(Clone, Default)]
#[wasm_bindgen(js_name = "OdtProperties")]
...
impl WasmOdtProperties {
    ...
    pub fn new(
        ...
        language: Option<String>,
        generator: Option<String>,
        editingDuration: Option<String>,
        editingCycles: Option<String>,
        pageCount: Option<i32>,
        wordCount: Option<i32>,
        characterCount: Option<i32>,
        paragraphCount: Option<i32>,
        tableCount: Option<i32>,
        imageCount: Option<i32>,
    ) -> WasmOdtProperties {
        WasmOdtProperties {
            title,
            subject,
...
#[derive(Clone, Default)]
#[wasm_bindgen(js_name = "DetectedBoundary")]
...
impl WasmDetectedBoundary {
    #[allow(non_snake_case)]
    #[wasm_bindgen(constructor)]
    pub fn new(byteOffset: usize, isHeader: bool) -> WasmDetectedBoundary {
...
#[derive(Clone, Default)]
#[wasm_bindgen(js_name = "ChunkingResult")]
...
impl WasmChunkingResult {
    #[allow(non_snake_case)]
    #[wasm_bindgen(constructor)]
    pub fn new(chunks: Vec<WasmChunk>, chunkCount: usize) -> WasmChunkingResult {
        WasmChunkingResult {
            chunks,
...
#[derive(Clone, Default)]
#[wasm_bindgen(js_name = "MergedChunk")]
...
impl WasmMergedChunk {
    #[allow(non_snake_case)]
    #[wasm_bindgen(constructor)]
    pub fn new(text: String, byteStart: usize, byteEnd: usize) -> WasmMergedChunk {
        WasmMergedChunk {
            text,
            byte_start: byteStart,
            byte_end: byteEnd,
