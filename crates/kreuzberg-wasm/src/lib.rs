...
// alef:hash:d0325e3dd0693ef39de22726535ca80347f139d44e5c2d9735ccec4cd829a8d9
...
/// Hardware acceleration configuration for ONNX Runtime models./// /// Controls which execution provider (CPU, CoreML, CUDA, TensorRT) is used/// for inference in layout detection and embedding generation./// /// # Example/// /// ```rust/// use kreuzberg::AccelerationConfig;/// /// // Auto-select: CoreML on macOS, CUDA on Linux, CPU elsewhere/// let config = AccelerationConfig::default();/// /// // Force CPU only/// let config = AccelerationConfig {///     provider: kreuzberg::ExecutionProviderType::Cpu,///     ..Default::default()/// };/// ```#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Configuration for email extraction.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Main extraction configuration./// /// This struct contains all configuration options for the extraction process./// It can be loaded from TOML, YAML, or JSON files, or created programmatically./// /// # Example/// /// ```rust/// use kreuzberg::core::config::ExtractionConfig;/// /// // Create with defaults/// let config = ExtractionConfig::default();/// /// // Load from TOML file/// // let config = ExtractionConfig::from_toml_file("kreuzberg.toml")?;/// ```#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Batch item for byte array extraction./// /// Used with `batch_extract_bytes` and `batch_extract_bytes_sync`/// to represent a single item in a batch extraction job.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Batch item for file extraction./// /// Used with `batch_extract_files` and `batch_extract_files_sync`/// to represent a single file in a batch extraction job.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Image extraction configuration.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Token reduction configuration.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Language detection configuration.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Configuration for styled HTML output./// /// When set on [`ExtractionConfig::html_output`] alongside/// `output_format = OutputFormat::Html`, the pipeline builds a/// [`StyledHtmlRenderer`](crate::rendering::StyledHtmlRenderer) instead of/// the plain comrak-based renderer./// /// # Example/// /// ```rust/// use kreuzberg::core::config::{HtmlOutputConfig, HtmlTheme};/// /// let config = HtmlOutputConfig {///     theme: HtmlTheme::GitHub,///     css: Some(".kb-p { font-size: 1.1rem; }".to_string()),///     ..Default::default()/// };/// ```#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Quality thresholds for OCR fallback decisions and pipeline quality gating./// /// All fields default to the values that match the previous hardcoded behavior,/// so `OcrQualityThresholds::default()` preserves existing semantics exactly.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// A single backend stage in the OCR pipeline.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Multi-backend OCR pipeline with quality-based fallback./// /// Backends are tried in priority order (highest first). After each backend/// produces output, quality is evaluated. If it meets `quality_thresholds.pipeline_min_quality`,/// the result is accepted. Otherwise the next backend is tried.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// OCR configuration.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Page extraction and tracking configuration./// /// Controls how pages are extracted, tracked, and represented in the extraction results./// When `None`, page tracking is disabled./// /// Page range tracking in chunk metadata (first_page/last_page) is automatically enabled/// when page boundaries are available and chunking is configured.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// PDF-specific configuration.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Hierarchy extraction configuration for PDF text structure analysis./// /// Enables extraction of document hierarchy levels (H1-H6) based on font size/// clustering and semantic analysis. When enabled, hierarchical blocks are/// included in page content.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Post-processor configuration.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Chunking configuration./// /// Configures text chunking for document content, including chunk size,/// overlap, trimming behavior, and optional embeddings./// /// Use `..Default::default()` when constructing to allow for future field additions:/// ```rust/// let config = ChunkingConfig {///     max_characters: 500,///     ..Default::default()/// };/// ```#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// A supported document format entry./// /// Represents a file extension and its corresponding MIME type that Kreuzberg can process.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Result of HTML extraction with optional images and warnings.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Extracted inline image with metadata.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// A drawing object extracted from `<w:drawing>`.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Properties for anchored drawings.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Page margins converted to points (1/72 inch).#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// A single style definition parsed from `<w:style>` in `word/styles.xml`.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Fully resolved (flattened) style after walking the inheritance chain.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Table-level properties from `<w:tblPr>`.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Application properties from docProps/app.xml for DOCX/// /// Contains Word-specific document statistics and metadata.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Application properties from docProps/app.xml for XLSX/// /// Contains Excel-specific document metadata.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Application properties from docProps/app.xml for PPTX/// /// Contains PowerPoint-specific document metadata.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Dublin Core metadata from docProps/core.xml/// /// Contains standard metadata fields defined by the Dublin Core standard/// and Office-specific extensions.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Custom properties from docProps/custom.xml/// /// Maps property names to their values. Values are converted to JSON types/// based on the VT (Variant Type) specified in the XML.#[derive(Clone)]
#[wasm_bindgen]
...
/// OpenDocument metadata from meta.xml/// /// Contains metadata fields defined by the OASIS OpenDocument Format standard./// Uses Dublin Core elements (dc:) and OpenDocument meta elements (meta:).#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Configuration for security limits across extractors./// /// All limits are intentionally conservative to prevent DoS attacks/// while still supporting legitimate documents.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Helper struct for validating ZIP archives for security issues.#[derive(Clone)]
#[wasm_bindgen]
...
/// Extractor for Hangul Word Processor XML (.hwpx) files./// /// Supports HWPX (Open HWPML), the ZIP-based XML successor to the binary HWP 5.0 format.#[derive(Clone)]
#[wasm_bindgen]
...
/// A PDF annotation extracted from a document page.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Block-level element in a Djot document./// /// Represents structural elements like headings, paragraphs, lists, code blocks, etc.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Inline element within a block./// /// Represents text with formatting, links, images, etc.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Image element in Djot.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Link element in Djot.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Footnote in Djot.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// A resolved relationship between two nodes in the document tree.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// A single node in the document tree./// /// Each node has deterministic `id`, typed `content`, optional `parent`/`children`/// for tree structure, and metadata like page number, bounding box, and content layer.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Structured table grid with cell-level metadata./// /// Stores row/column dimensions and a flat list of cells with position info.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Individual grid cell with position and span metadata.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Inline text annotation — byte-range based formatting and links./// /// Annotations reference byte offsets into the node's text content,/// enabling precise identification of formatted regions.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// General extraction result used by the core extraction API./// /// This is the main result type returned by all extraction functions.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// A single file extracted from an archive./// /// When archives (ZIP, TAR, 7Z, GZIP) are extracted with recursive extraction/// enabled, each processable file produces its own full `ExtractionResult`.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Token usage and cost data for a single LLM call made during extraction./// /// Populated when VLM OCR, structured extraction, or LLM-based embeddings/// are used. Multiple entries may be present when multiple LLM calls occur/// within one extraction (e.g. VLM OCR + structured extraction).#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// A text chunk with optional embedding and metadata./// /// Chunks are created when chunking is enabled in `ExtractionConfig`. Each chunk/// contains the text content, optional embedding vector (if embedding generation/// is configured), and metadata about its position in the document.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Heading context for a chunk within a Markdown document./// /// Contains the heading hierarchy from document root to this chunk's section.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// A single heading in the hierarchy.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Metadata about a chunk's position in the original document.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Extracted image from a document./// /// Contains raw image data, metadata, and optional nested OCR results./// Raw bytes allow cross-language compatibility - users can convert to/// PIL.Image (Python), Sharp (Node.js), or other formats as needed.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Metadata for a semantic element.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Semantic element extracted from document./// /// Represents a logical unit of content with semantic classification,/// unique identifier, and metadata for tracking origin and position.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Excel workbook representation./// /// Contains all sheets from an Excel file (.xlsx, .xls, etc.) with/// extracted content and metadata.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Single Excel worksheet./// /// Represents one sheet from an Excel workbook with its content/// converted to Markdown format and dimensional statistics.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// XML extraction result./// /// Contains extracted text content from XML files along with/// structural statistics about the XML document.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Plain text and Markdown extraction result./// /// Contains the extracted text along with statistics and,/// for Markdown files, structural elements like headers and links.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// PowerPoint (PPTX) extraction result./// /// Contains extracted slide content, metadata, and embedded images/tables.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Email extraction result./// /// Complete representation of an extracted email message (.eml or .msg)/// including headers, body content, and attachments.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Email attachment representation./// /// Contains metadata and optionally the content of an email attachment.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// OCR extraction result./// /// Result of performing OCR on an image or scanned document,/// including recognized text and detected tables.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Table detected via OCR./// /// Represents a table structure recognized during OCR processing.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Bounding box for an OCR-detected table in pixel coordinates.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Image preprocessing configuration for OCR./// /// These settings control how images are preprocessed before OCR to improve/// text recognition quality. Different preprocessing strategies work better/// for different document types.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Image preprocessing metadata./// /// Tracks the transformations applied to an image during OCR preprocessing,/// including DPI normalization, resizing, and resampling.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Extraction result metadata./// /// Contains common fields applicable to all formats, format-specific metadata/// via a discriminated union, and additional custom fields from postprocessors.#[derive(Clone, Default)]
#[wasm_bindgen]
...
impl WasmMetadata {
    ...
    /// Returns `true` when no metadata fields, format-specific metadata, or/// additional postprocessor fields are populated.#[wasm_bindgen(js_name = "isEmpty")]
    pub fn is_empty(&self) -> bool {
        kreuzberg::Metadata::from(self.clone()).is_empty()
    }
}

/// Excel/spreadsheet format metadata./// /// Identifies the document as a spreadsheet source via the `FormatMetadata::Excel`/// discriminant. Sheet count and sheet names are stored inside this struct.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Email metadata extracted from .eml and .msg files./// /// Includes sender/recipient information, message ID, and attachment list.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Archive (ZIP/TAR/7Z) metadata./// /// Extracted from compressed archive files containing file lists and size information.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Image metadata extracted from image files./// /// Includes dimensions, format, and EXIF data.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// XML metadata extracted during XML parsing./// /// Provides statistics about XML document structure.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Text/Markdown metadata./// /// Extracted from plain text and Markdown files. Includes word counts and,/// for Markdown, structural elements like headers and links.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Header/heading element metadata.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Link element metadata.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Image element metadata.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Structured data (Schema.org, microdata, RDFa) block.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// HTML metadata extracted from HTML documents./// /// Includes document-level metadata, Open Graph data, Twitter Card metadata,/// and extracted structural elements (headers, links, images, structured data).#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// OCR processing metadata./// /// Captures information about OCR processing configuration and results.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Error metadata (for batch operations).#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// PowerPoint presentation metadata./// /// Extracted from PPTX files containing slide counts and presentation details.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Word document metadata./// /// Extracted from DOCX files using shared Office Open XML metadata extraction./// Integrates with `office_metadata` module for core/app/custom properties.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// CSV/TSV file metadata.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// BibTeX bibliography metadata.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Citation file metadata (RIS, PubMed, EndNote).#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Year range for bibliographic metadata.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// FictionBook (FB2) metadata.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// dBASE (DBF) file metadata.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// dBASE field information.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// JATS (Journal Article Tag Suite) metadata.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// JATS contributor with role.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// EPUB metadata (Dublin Core extensions).#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Outlook PST archive metadata.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Confidence scores for an OCR element./// /// Separates detection confidence (how confident that text exists at this location)/// from recognition confidence (how confident about the actual text content).#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Rotation information for an OCR element.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// A unified OCR element representing detected text with full metadata./// /// This is the primary type for structured OCR output, preserving all information/// from both Tesseract and PaddleOCR backends.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Configuration for OCR element extraction./// /// Controls how OCR elements are extracted and filtered.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Unified page structure for documents./// /// Supports different page types (PDF pages, PPTX slides, Excel sheets)/// with character offset boundaries for chunk-to-page mapping.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Byte offset boundary for a page./// /// Tracks where a specific page's content starts and ends in the main content string,/// enabling mapping from byte positions to page numbers. Offsets are guaranteed to be/// at valid UTF-8 character boundaries when using standard String methods (push_str, push, etc.).#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Metadata for individual page/slide/sheet./// /// Captures per-page information including dimensions, content counts,/// and visibility state (for presentations).#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// A detected layout region on a page./// /// When layout detection is enabled, each page may have layout regions/// identifying different content types (text, pictures, tables, etc.)/// with confidence scores and spatial positions.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Page hierarchy structure containing heading levels and block information./// /// Used when PDF text hierarchy extraction is enabled. Contains hierarchical/// blocks with heading levels (H1-H6) for semantic document structure.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// A text block with hierarchy level assignment./// /// Represents a block of text with semantic heading information extracted from/// font size clustering and hierarchical analysis.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Extracted table structure./// /// Represents a table detected and extracted from a document (PDF, image, etc.)./// Tables are converted to both structured cell data and Markdown format.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Individual table cell with content and optional styling./// /// Future extension point for rich table support with cell-level metadata.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// A URI extracted from a document./// /// Represents any link, reference, or resource pointer found during extraction./// The `kind` field classifies the URI semantically, while `label` carries/// optional human-readable display text.#[derive(Clone, Default)]
#[wasm_bindgen]
pub struct WasmUri {
    url: String,
    label: Option<String>,
...
/// Convenience type alias for a pooled String.#[derive(Clone)]
#[wasm_bindgen]
...
/// Convenience type alias for a pooled Vec<u8>.#[derive(Clone)]
#[wasm_bindgen]
...
/// A detected structural boundary in the text.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Result of a text chunking operation./// /// Contains the generated chunks and metadata about the chunking.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// A merged chunk produced by [`merge_segments`].#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// Embedded file descriptor extracted from the PDF name tree.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// PDF-specific metadata./// /// Contains metadata fields specific to PDF documents that are not in the common/// `Metadata` structure. Common fields like title, authors, keywords, and dates/// are at the `Metadata` level.#[derive(Clone, Default)]
#[wasm_bindgen]
...
/// ONNX Runtime execution provider type./// /// Determines which hardware backend is used for model inference./// `Auto` (default) selects the best available provider per platform.
#[wasm_bindgen]
...
/// Processing stages for post-processors./// /// Post-processors are executed in stage order (Early → Middle → Late)./// Use stages to control the order of post-processing operations.
#[wasm_bindgen]
#[derive(Clone, Copy, PartialEq, Eq)]
...
/// Content layer classification for document nodes./// /// Replaces separate body/furniture arrays with per-node granularity.
#[wasm_bindgen]
#[derive(Clone, Copy, PartialEq, Eq)]
...
/// Tagged enum for node content. Each variant carries only type-specific data./// /// Uses `#[serde(tag = "node_type")]` to avoid "type" keyword collision in/// Go/Java/TypeScript bindings.
#[wasm_bindgen]
#[derive(Clone, Copy, PartialEq, Eq)]
...
/// Semantic structural classification of a text chunk./// /// Assigned by the heuristic classifier in `chunking::classifier`./// Defaults to `Unknown` when no rule matches./// Designed to be extended in future versions without breaking changes.
#[wasm_bindgen]
#[derive(Clone, Copy, PartialEq, Eq)]
...
/// Result-shape selection for extraction results./// /// Distinct from `OutputFormat` (which controls rendering — Plain, Markdown,/// HTML, etc.). `ResultFormat` controls the *shape* of the result: a unified content/// blob vs. an element-based decomposition.
#[wasm_bindgen]
#[derive(Clone, Copy, PartialEq, Eq)]
...
/// Semantic element type classification./// /// Categorizes text content into semantic units for downstream processing./// Supports the element types commonly found in Unstructured documents.
#[wasm_bindgen]
#[derive(Clone, Copy, PartialEq, Eq)]
...
/// Format-specific metadata (discriminated union)./// /// Only one format type can exist per extraction result. This provides/// type-safe, clean metadata without nested optionals.
#[wasm_bindgen]
#[derive(Clone, Copy, PartialEq, Eq)]
...
/// Bounding geometry for an OCR element./// /// Supports both axis-aligned rectangles (from Tesseract) and 4-point quadrilaterals/// (from PaddleOCR and rotated text detection).
#[wasm_bindgen]
#[derive(Clone, Copy, PartialEq, Eq)]
...
/// Hierarchical level of an OCR element./// /// Maps to Tesseract's page segmentation hierarchy and provides/// equivalent semantics for PaddleOCR.
#[wasm_bindgen]
#[derive(Clone, Copy, PartialEq, Eq)]
...
/// Type of paginated unit in a document./// /// Distinguishes between different types of "pages" (PDF pages, presentation slides, spreadsheet sheets).
#[wasm_bindgen]
#[derive(Clone, Copy, PartialEq, Eq)]
...
/// Extract content from a file./// /// This is the main entry point for file-based extraction. It performs the following steps:/// 1. Check cache for existing result (if caching enabled)/// 2. Detect or validate MIME type/// 3. Select appropriate extractor from registry/// 4. Extract content/// 5. Run post-processing pipeline/// 6. Store result in cache (if caching enabled)/// /// # Arguments/// /// * `path` - Path to the file to extract/// * `mime_type` - Optional MIME type override. If None, will be auto-detected/// * `config` - Extraction configuration/// /// # Returns/// /// An `ExtractionResult` containing the extracted content and metadata./// /// # Errors/// /// Returns `KreuzbergError::Io` if the file doesn't exist (NotFound) or for other file I/O errors./// Returns `KreuzbergError::UnsupportedFormat` if MIME type is not supported./// /// # Example/// /// ```rust,no_run/// use kreuzberg::core::extractor::extract_file;/// use kreuzberg::core::config::ExtractionConfig;/// /// let config = ExtractionConfig::default();/// let result = extract_file("document.pdf", None, &config).await?;/// println!("Content: {}", result.content);/// ```#[allow(clippy::missing_errors_doc)]
...
/// List names of all registered document extractors.#[allow(clippy::missing_errors_doc)]
...
/// List all registered post-processor names./// /// Returns a vector of all post-processor names currently registered in the/// global registry./// /// # Returns/// /// - `Ok(Vec<String>)` - Vector of post-processor names/// - `Err(...)` if the registry lock is poisoned/// /// # Example/// /// ```rust/// use kreuzberg::plugins::list_post_processors;/// /// let processors = list_post_processors()?;/// for name in processors {///     println!("Registered post-processor: {}", name);/// }/// ```#[allow(clippy::missing_errors_doc)]
...
/// List names of all registered renderers./// /// # Errors/// /// Returns an error if the registry lock is poisoned.#[allow(clippy::missing_errors_doc)]
...
/// List names of all registered validators.#[allow(clippy::missing_errors_doc)]
...
/// Render a single PDF page to PNG bytes./// /// Returns raw PNG-encoded bytes for the specified page at the given DPI./// Uses pdf_oxide with tiny-skia for pure-Rust rendering./// /// # Arguments/// /// * `pdf_bytes` - Raw PDF file bytes/// * `page_index` - Zero-based page index/// * `dpi` - Resolution in dots per inch (default: 150)/// * `password` - Optional password for encrypted PDFs/// /// # Errors/// /// Returns `KreuzbergError::Parsing` if the PDF cannot be opened, authenticated,/// or rendered, or if `page_index` is out of range.#[allow(clippy::missing_errors_doc)]
...
/// Detect the MIME type of a file at the given path./// /// Uses the file extension and optionally the file content to determine the MIME type./// Set `check_exists` to `true` to verify the file exists before detection.#[allow(clippy::missing_errors_doc)]
