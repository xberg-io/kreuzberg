...
// alef:hash:58782a69cfbea5218c3561816b55f3b7047de0267642591b039f8aacff9e633a
...
pub async fn extract_bytes(
    ...
    let config_core: kreuzberg::ExtractionConfig = match config {
        Some(config_val) => serde_wasm_bindgen::from_value::<kreuzberg::ExtractionConfig>(config_val)
