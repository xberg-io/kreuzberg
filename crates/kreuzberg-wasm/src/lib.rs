...
// alef:hash:643e96d9fca2c1776a8150931520f626716744d97333fabf1a14e302e1340553
...
#[derive(Clone, Default)]
#[wasm_bindgen]
pub struct WasmDocExtractionResult {
    content: String,
    metadata: WasmDocMetadata,
}

#[wasm_bindgen]
impl WasmDocExtractionResult {
    #[wasm_bindgen(constructor)]
    pub fn new(content: String, metadata: WasmDocMetadata) -> WasmDocExtractionResult {
        WasmDocExtractionResult { content, metadata }
    }
    ...
    #[wasm_bindgen(getter)]
    pub fn metadata(&self) -> WasmDocMetadata {
        self.metadata.clone()
    }

    #[wasm_bindgen(setter)]
    pub fn set_metadata(&mut self, value: WasmDocMetadata) {
        self.metadata = value;
    }
}
...
pub fn validate_port(port: u32) -> Result<(), JsValue> {
...
/// ```
#[allow(clippy::missing_errors_doc)]
#[wasm_bindgen(js_name = "renderHtmlStr")]
pub fn render_html_str(html: String) -> Result<String, JsValue> {
    let result = kreuzberg::render_html_str(&html).map_err(|e| JsValue::from_str(&e.to_string()))?;
    Ok(result)
}
...
/// ```
#[allow(clippy::missing_errors_doc)]
#[wasm_bindgen(js_name = "renderMarkdownStr")]
pub fn render_markdown_str(html: String) -> Result<String, JsValue> {
    let result = kreuzberg::render_markdown_str(&html).map_err(|e| JsValue::from_str(&e.to_string()))?;
    Ok(result)
}
...
/// ```
#[allow(clippy::missing_errors_doc)]
#[wasm_bindgen(js_name = "renderDjotStr")]
pub fn render_djot_str(html: String) -> Result<String, JsValue> {
    let result = kreuzberg::render_djot_str(&html).map_err(|e| JsValue::from_str(&e.to_string()))?;
    Ok(result)
}
...
/// ```
#[allow(clippy::missing_errors_doc)]
#[wasm_bindgen(js_name = "renderJsonStr")]
pub fn render_json_str(html: String) -> Result<String, JsValue> {
    let result = kreuzberg::render_json_str(&html).map_err(|e| JsValue::from_str(&e.to_string()))?;
    Ok(result)
}
...
/// ```
#[allow(clippy::missing_errors_doc)]
#[wasm_bindgen(js_name = "renderPlainStr")]
pub fn render_plain_str(html: String) -> Result<String, JsValue> {
    let result = kreuzberg::render_plain_str(&html).map_err(|e| JsValue::from_str(&e.to_string()))?;
    Ok(result)
}
...
pub fn normalize_whitespace(_s: String) -> String {
...
pub fn chunk_text(
    ...
    let page_boundaries_core: Option<Vec<kreuzberg::PageBoundary>> = page_boundaries
        ...
        .transpose()?;
    let result = kreuzberg::chunk_text(&text, &config_core, page_boundaries_core.as_deref())
        .map_err(|e| JsValue::from_str(&e.to_string()))?;
    Ok(result.into())
}
...
pub fn chunk_semantic(
    ...
    let page_boundaries_core: Option<Vec<kreuzberg::PageBoundary>> = page_boundaries
        ...
        .transpose()?;
    let result = kreuzberg::chunk_semantic(&text, &config_core, page_boundaries_core.as_deref())
        .map_err(|e| JsValue::from_str(&e.to_string()))?;
    Ok(result.into())
}
...
pub fn detect_languages(text: String, config: JsValue) -> Result<Option<Vec<String>>, JsValue> {
    let config_core: kreuzberg::LanguageDetectionConfig =
        serde_wasm_bindgen::from_value::<kreuzberg::LanguageDetectionConfig>(config)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;
    let result = kreuzberg::detect_languages(&text, &config_core).map_err(|e| JsValue::from_str(&e.to_string()))?;
    Ok(result)
}
...
pub fn generate_cache_key(parts: JsValue) -> String {
    let parts: Vec<Vec<String>> = serde_wasm_bindgen::from_value::<Vec<Vec<String>>>(parts).expect("deserialize parts");
...
pub fn convert_html_to_markdown(html: String) -> Result<String, JsValue> {
    let result = kreuzberg::convert_html_to_markdown(&html).map_err(|e| JsValue::from_str(&e.to_string()))?;
    Ok(result)
}
...
pub fn extract_doc_text(content: Vec<u8>) -> Result<WasmDocExtractionResult, JsValue> {
    let result = kreuzberg::extract_doc_text(&content).map_err(|e| JsValue::from_str(&e.to_string()))?;
    Ok(result.into())
}
...
pub fn extract_pptx_from_bytes(data: Vec<u8>) -> Result<WasmPptxExtractionResult, JsValue> {
    let result = kreuzberg::extract_pptx_from_bytes(&data).map_err(|e| JsValue::from_str(&e.to_string()))?;
    Ok(result.into())
}
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<WasmDocExtractionResult> for kreuzberg::DocExtractionResult {
    fn from(val: WasmDocExtractionResult) -> Self {
        Self {
            content: val.content,
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::DocExtractionResult> for WasmDocExtractionResult {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<WasmDocMetadata> for kreuzberg::DocMetadata {
    fn from(val: WasmDocMetadata) -> Self {
        Self {
            title: val.title,
            subject: val.subject,
            author: val.author,
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::DocMetadata> for WasmDocMetadata {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<WasmPptxExtractionResult> for kreuzberg::PptxExtractionResult {
    fn from(val: WasmPptxExtractionResult) -> Self {
        Self {
            content: val.content,
            metadata: val.metadata.into(),
            ...
            office_metadata: serde_wasm_bindgen::from_value(val.office_metadata.clone()).unwrap_or_default(),
        }
    }
}
