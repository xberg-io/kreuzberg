...
#[unsafe(no_mangle)]
pub extern "C" fn kreuzberg_parse_heading_style(value: *const c_char) -> i32 {
    if value.is_null() {
        return -1;
    }
...
pub extern "C" fn kreuzberg_heading_style_to_string(discriminant: i32) -> *const c_char {
    match discriminant {
        0 => b"atx\0".as_ptr() as *const c_char,
        1 => b"underlined\0".as_ptr() as *const c_char,
        2 => b"atx_closed\0".as_ptr() as *const c_char,
        _ => ptr::null(),
    }
}
...
#[unsafe(no_mangle)]
pub extern "C" fn kreuzberg_parse_code_block_style(value: *const c_char) -> i32 {
    if value.is_null() {
        return -1;
    }
...
pub extern "C" fn kreuzberg_code_block_style_to_string(discriminant: i32) -> *const c_char {
    match discriminant {
        0 => b"indented\0".as_ptr() as *const c_char,
        1 => b"backticks\0".as_ptr() as *const c_char,
        2 => b"tildes\0".as_ptr() as *const c_char,
        _ => ptr::null(),
    }
}
...
#[unsafe(no_mangle)]
pub extern "C" fn kreuzberg_parse_highlight_style(value: *const c_char) -> i32 {
    if value.is_null() {
        return -1;
    }
...
pub extern "C" fn kreuzberg_highlight_style_to_string(discriminant: i32) -> *const c_char {
    match discriminant {
        0 => b"double_equal\0".as_ptr() as *const c_char,
        1 => b"html\0".as_ptr() as *const c_char,
        2 => b"bold\0".as_ptr() as *const c_char,
        3 => b"none\0".as_ptr() as *const c_char,
        _ => ptr::null(),
    }
}
...
#[unsafe(no_mangle)]
pub extern "C" fn kreuzberg_parse_list_indent_type(value: *const c_char) -> i32 {
    if value.is_null() {
        return -1;
    }
...
pub extern "C" fn kreuzberg_list_indent_type_to_string(discriminant: i32) -> *const c_char {
    match discriminant {
        0 => b"spaces\0".as_ptr() as *const c_char,
        1 => b"tabs\0".as_ptr() as *const c_char,
        _ => ptr::null(),
    }
}
...
#[unsafe(no_mangle)]
pub extern "C" fn kreuzberg_parse_whitespace_mode(value: *const c_char) -> i32 {
    if value.is_null() {
        return -1;
    }
...
pub extern "C" fn kreuzberg_whitespace_mode_to_string(discriminant: i32) -> *const c_char {
    match discriminant {
        0 => b"default\0".as_ptr() as *const c_char,
        1 => b"preserve\0".as_ptr() as *const c_char,
        2 => b"preserve_inner\0".as_ptr() as *const c_char,
        3 => b"collapse\0".as_ptr() as *const c_char,
        _ => ptr::null(),
    }
}
...
#[unsafe(no_mangle)]
pub extern "C" fn kreuzberg_parse_newline_style(value: *const c_char) -> i32 {
    if value.is_null() {
        return -1;
    }
...
pub extern "C" fn kreuzberg_newline_style_to_string(discriminant: i32) -> *const c_char {
    match discriminant {
        0 => b"default\0".as_ptr() as *const c_char,
        1 => b"spaces\0".as_ptr() as *const c_char,
        2 => b"backslash\0".as_ptr() as *const c_char,
        _ => ptr::null(),
    }
}
...
#[unsafe(no_mangle)]
pub extern "C" fn kreuzberg_parse_preprocessing_preset(value: *const c_char) -> i32 {
    if value.is_null() {
        return -1;
    }
...
pub extern "C" fn kreuzberg_preprocessing_preset_to_string(discriminant: i32) -> *const c_char {
    match discriminant {
        ...
        1 => b"conservative\0".as_ptr() as *const c_char,
        2 => b"aggressive\0".as_ptr() as *const c_char,
        _ => ptr::null(),
    }
}
...
mod tests {
    ...
    fn test_heading_style_to_string() {
        unsafe {
            assert_eq!(
                CStr::from_ptr(kreuzberg_heading_style_to_string(0))
                    .to_str()
                    .unwrap(),
                "atx"
            );
            assert_eq!(
                CStr::from_ptr(kreuzberg_heading_style_to_string(1))
                    .to_str()
                    .unwrap(),
                "underlined"
            );
            assert_eq!(
                CStr::from_ptr(kreuzberg_heading_style_to_string(2))
                    .to_str()
                    .unwrap(),
                "atx_closed"
            );
