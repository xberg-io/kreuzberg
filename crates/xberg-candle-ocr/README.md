...
Candle-based VLM OCR engines for Xberg. Pure-Rust transformer OCR via [candle](https://github.com/huggingface/candle).
...
When depending on `xberg`, the equivalent aggregate features are
