...
pub fn python_to_json(obj: &Bound<'_, PyAny>) -> xberg::Result<serde_json::Value> {
    ...
    if obj.is_none() {
        ...
        for (key, value) in dict.iter() {
            let key_str: String = key.extract().map_err(|_| XbergError::Validation {
        ...
        Ok(serde_json::Value::String(
            obj.str()
                .map_err(|_| XbergError::Validation {
