...
// alef:hash:fc43f99e384f2646b882ec6505d7e7e9ee45e90357f29adb1bbcd48a9f88f602
...
#[pyfunction]
#[pyo3(signature = (name))]
pub fn unregister_embedding_backend(name: String) -> PyResult<()> {
...
pub fn list_embedding_backends() -> PyResult<Vec<String>> {
    kreuzberg::plugins::list_embedding_backends().map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))
}
...
pub fn clear_embedding_backends() -> PyResult<()> {
    kreuzberg::plugins::clear_embedding_backends().map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))
}
...
pub fn pdf_page_count(pdf_bytes: Vec<u8>, password: Option<String>) -> PyResult<usize> {
...
pub fn _kreuzberg(m: &Bound<'_, PyModule>) -> PyResult<()> {
    ...
    m.add_function(wrap_pyfunction!(unregister_embedding_backend, m)?)?;
