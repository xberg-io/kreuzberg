...
// alef:hash:4c58c21f23800a51133c80d94e57ef7c6e0b782346c2be439b857514aad50c2b
...
impl DocExtractionResult {
    #[must_use]
    #[pyo3(signature = (content, metadata))]
    #[new]
...
impl DocMetadata {
    #[must_use]
    #[pyo3(signature = (title=None, subject=None, author=None, last_author=None, created=None, modified=None, revision_number=None))]
    #[new]
    pub fn new(
        title: Option<String>,
...
#[pyfunction]
#[pyo3(signature = (port))]
pub fn validate_port(port: u32) -> PyResult<()> {
...
pub fn extract_file<'py>(
    ...
    pyo3_async_runtimes::tokio::future_into_py(py, async move {
        let config_core: kreuzberg::ExtractionConfig = config
            .map(|v| {
                let json =
...
#[pyfunction]
#[pyo3(signature = (html))]
pub fn render_html_str(html: String) -> PyResult<String> {
    kreuzberg::render_html_str(&html).map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))
}

#[allow(clippy::missing_errors_doc)]
#[pyfunction]
#[pyo3(signature = (html))]
pub fn render_markdown_str(html: String) -> PyResult<String> {
    kreuzberg::render_markdown_str(&html).map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))
}

#[allow(clippy::missing_errors_doc)]
#[pyfunction]
#[pyo3(signature = (html))]
pub fn render_djot_str(html: String) -> PyResult<String> {
    kreuzberg::render_djot_str(&html).map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))
}

#[allow(clippy::missing_errors_doc)]
#[pyfunction]
#[pyo3(signature = (html))]
pub fn render_json_str(html: String) -> PyResult<String> {
    kreuzberg::render_json_str(&html).map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))
}

#[allow(clippy::missing_errors_doc)]
#[pyfunction]
#[pyo3(signature = (html))]
pub fn render_plain_str(html: String) -> PyResult<String> {
    kreuzberg::render_plain_str(&html).map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))
}
...
pub fn chunk_text(
    ...
    let page_boundaries_core: Option<Vec<kreuzberg::PageBoundary>> = page_boundaries
        ...
        .transpose()?;
    kreuzberg::chunk_text(&text, &config_core, page_boundaries_core.as_deref())
...
pub fn chunk_semantic(
    ...
    let page_boundaries_core: Option<Vec<kreuzberg::PageBoundary>> = page_boundaries
        ...
        .transpose()?;
    kreuzberg::chunk_semantic(&text, &config_core, page_boundaries_core.as_deref())
        .map(ChunkingResult::from)
        .map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))
}
...
pub fn detect_languages(text: String, config: LanguageDetectionConfig) -> PyResult<Option<Vec<String>>> {
    ...
    let config_core: kreuzberg::LanguageDetectionConfig =
        serde_json::from_str(&config_json).map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))?;
    kreuzberg::detect_languages(&text, &config_core)
        .map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))
}
...
#[pyfunction]
#[pyo3(signature = (html))]
pub fn convert_html_to_markdown(html: String) -> PyResult<String> {
    kreuzberg::convert_html_to_markdown(&html).map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))
}

#[allow(clippy::missing_errors_doc)]
#[pyfunction]
#[pyo3(signature = (content))]
pub fn extract_doc_text(content: Vec<u8>) -> PyResult<DocExtractionResult> {
...
#[pyfunction]
#[pyo3(signature = (data))]
pub fn extract_pptx_from_bytes(data: Vec<u8>) -> PyResult<PptxExtractionResult> {
...
pub fn extract_file_to_toon(path: String, config: ExtractionConfig) -> PyResult<String> {
    let config_json =
        serde_json::to_string(&config).map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))?;
    let config_core: kreuzberg::ExtractionConfig =
        serde_json::from_str(&config_json).map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))?;
    kreuzberg::extract_file_to_toon(std::path::PathBuf::from(path), &config_core)
        .map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))
}
...
#[pyfunction]
#[pyo3(signature = (path, config))]
pub fn extract_file_to_json(path: String, config: ExtractionConfig) -> PyResult<String> {
    let config_json =
        serde_json::to_string(&config).map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))?;
    let config_core: kreuzberg::ExtractionConfig =
        serde_json::from_str(&config_json).map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))?;
    kreuzberg::extract_file_to_json(std::path::PathBuf::from(path), &config_core)
        .map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))
}
...
pub fn _kreuzberg(m: &Bound<'_, PyModule>) -> PyResult<()> {
    ...
    m.add_class::<DocExtractionResult>()?;
    m.add_class::<DocMetadata>()?;
    m.add_class::<Drawing>()?;
    ...
    m.add_function(wrap_pyfunction!(render_html_str, m)?)?;
    m.add_function(wrap_pyfunction!(render_markdown_str, m)?)?;
    m.add_function(wrap_pyfunction!(render_djot_str, m)?)?;
    m.add_function(wrap_pyfunction!(render_json_str, m)?)?;
    m.add_function(wrap_pyfunction!(render_plain_str, m)?)?;
    ...
    m.add_function(wrap_pyfunction!(extract_file_to_toon, m)?)?;
    m.add_function(wrap_pyfunction!(extract_file_to_json, m)?)?;
