...
// alef:hash:b510be2c35cf2acba23a100fdb41d652169ecc0352d2d7ba61323a2669bd76c9
...
impl TreeSitterConfig {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (enabled=Self::default().enabled, process=Self::default().process, cache_dir=None, languages=None, groups=None))]
    #[new]
    pub fn new(
        enabled: bool,
...
impl OcrElement {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (text=Self::default().text, geometry=Self::default().geometry, confidence=Self::default().confidence, level=Self::default().level, page_number=Self::default().page_number, backend_metadata=Self::default().backend_metadata, rotation=None, parent_id=None))]
    #[new]
    pub fn new(
        text: String,
...
impl LayoutRegion {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (class_name=Self::default().class_name, confidence=Self::default().confidence, bounding_box=Self::default().bounding_box, area_fraction=Self::default().area_fraction))]
    #[new]
...
impl KeywordConfig {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (algorithm=Self::default().algorithm, max_keywords=Self::default().max_keywords, min_score=Self::default().min_score, ngram_range=Self::default().ngram_range, language=None))]
    #[new]
    pub fn new(
