...
pub struct ChunkingDecision {
    pub(crate) inner: kreuzberg::heuristics::ChunkingDecision,
}
...
impl ChunkingDecision {
    ...
    fn new(
        ...
        let inner: kreuzberg::heuristics::ChunkingDecision = serde_json::from_str(&json_str)
            .map_err(|e| pyo3::exceptions::PyValueError::new_err(format!("Invalid ChunkingDecision: {e}")))?;
        Ok(Self { inner })
    }
    ...
    fn chunk(&self) -> Option<ChunkPlan> {
        match &self.inner {
            kreuzberg::heuristics::ChunkingDecision::Chunk(data) => Some(data.clone().into()),
            _ => None,
        }
    }
...
impl<'de> serde::Deserialize<'de> for ChunkingDecision {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let inner = kreuzberg::heuristics::ChunkingDecision::deserialize(deserializer)?;
        Ok(Self { inner })
    }
}
...
pub struct NoChunkingReason {
    pub(crate) inner: kreuzberg::heuristics::NoChunkingReason,
}
...
impl NoChunkingReason {
    ...
    fn new(
        ...
        let inner: kreuzberg::heuristics::NoChunkingReason = serde_json::from_str(&json_str)
            .map_err(|e| pyo3::exceptions::PyValueError::new_err(format!("Invalid NoChunkingReason: {e}")))?;
        Ok(Self { inner })
    }
...
impl<'de> serde::Deserialize<'de> for NoChunkingReason {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let inner = kreuzberg::heuristics::NoChunkingReason::deserialize(deserializer)?;
        Ok(Self { inner })
    }
}
...
pub struct ChunkingReason {
    pub(crate) inner: kreuzberg::heuristics::ChunkingReason,
}
...
impl ChunkingReason {
    ...
    fn new(
        ...
        let inner: kreuzberg::heuristics::ChunkingReason = serde_json::from_str(&json_str)
            .map_err(|e| pyo3::exceptions::PyValueError::new_err(format!("Invalid ChunkingReason: {e}")))?;
        Ok(Self { inner })
    }
...
impl<'de> serde::Deserialize<'de> for ChunkingReason {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let inner = kreuzberg::heuristics::ChunkingReason::deserialize(deserializer)?;
        Ok(Self { inner })
    }
}
...
pub fn analyze_with_user_chunks(
    ...
    kreuzberg::heuristics::analyze_with_user_chunks(&user_ranges_core, total_pages, size_bytes, &config_core).into()
}
...
pub fn check_format_limits(
    ...
    kreuzberg::heuristics::check_format_limits(&mime_type, sheet_count, workbook_cells, embedded_count, &config_core)
}
...
pub fn calculate_chunk_plan(page_count: u32, size_bytes: u64, needs_ocr: bool, config: HeuristicsConfig) -> ChunkPlan {
    ...
    kreuzberg::heuristics::calculate_chunk_plan(page_count, size_bytes, needs_ocr, &config_core).into()
}
...
pub fn calculate_plan_from_overrides(
    ...
    kreuzberg::heuristics::calculate_plan_from_overrides(&user_chunks_core, total_pages, size_bytes, &config_core)
        .into()
}
