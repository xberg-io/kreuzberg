...
public class EmbeddingsTest {
    ...
    public void embeddingAsync() throws Exception {
        JsonNode config = MAPPER.readTree("{\"chunking\":{\"max_chars\":500,\"max_overlap\":50,\"embedding\":{\"model\":{\"type\":\"preset\",\"name\":\"balanced\"},\"normalize\":true}}}");
    ...
    public void embeddingFastPreset() throws Exception {
        JsonNode config = MAPPER.readTree("{\"chunking\":{\"max_chars\":500,\"max_overlap\":50,\"embedding\":{\"model\":{\"type\":\"preset\",\"name\":\"fast\"},\"normalize\":true}}}");
        E2EHelpers.skipIfFeatureUnavailable("embeddings");
        if ((System.getProperty("os.arch").equals("amd64") && System.getProperty("os.name").startsWith("Windows"))) {
