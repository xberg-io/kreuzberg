...
// alef:hash:b34859f610fbf87319a8f2319cdba06596acd80fdb1c57a62e719d6c0a2a309e
...
final class ContractTest extends TestCase
{
    ...
    {        $config = \Kreuzberg\ExtractionConfig::from_json(json_encode(["output_format" => "markdown"]));
    ...
    {        $config = \Kreuzberg\ExtractionConfig::from_json(json_encode(["chunking" => ["chunker_type" => "markdown", "max_chars" => 300, "max_overlap" => 50, "prepend_heading_context" => true]]));
    ...
    {        $config = \Kreuzberg\ExtractionConfig::from_json(json_encode(["include_document_structure" => true]));
    ...
    {        $config = \Kreuzberg\ExtractionConfig::from_json(json_encode(["result_format" => "element_based"]));
    ...
    {        $config = \Kreuzberg\ExtractionConfig::from_json(json_encode(["extraction_timeout_secs" => 300]));
    ...
    {        $config = \Kreuzberg\ExtractionConfig::from_json(json_encode(["keywords" => ["algorithm" => "yake", "max_keywords" => 10]]));
        $result = Kreuzberg::extractFileSync("pdf/fake_memo.pdf", null, $config);
    ...
    {        $config = \Kreuzberg\ExtractionConfig::from_json(json_encode(["pages" => ["extract_pages" => true, "insert_page_markers" => true]]));
        $result = Kreuzberg::extractFileSync("pdf/fake_memo.pdf", null, $config);
    ...
    {        $config = \Kreuzberg\ExtractionConfig::from_json(json_encode(["enable_quality_processing" => true]));
        $result = Kreuzberg::extractFileSync("pdf/fake_memo.pdf", null, $config);
    ...
    {        $config = \Kreuzberg\ExtractionConfig::from_json(json_encode(["security_limits" => ["max_archive_size" => 104857600, "max_compression_ratio" => 50, "max_files_in_archive" => 100]]));
    ...
    {        $config = \Kreuzberg\ExtractionConfig::from_json(json_encode(["tree_sitter" => ["groups" => ["web"], "languages" => ["python", "rust"], "process" => ["comments" => false, "diagnostics" => false, "docstrings" => false, "exports" => true, "imports" => true, "structure" => true, "symbols" => false]]]));
