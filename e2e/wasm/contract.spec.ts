...
describe("contract fixtures", () => {
  ...
  it("config_chunking_semantic", async () => {
  ...
  it("config_chunking_semantic_small", async () => {
  ...
  it("config_chunking_semantic_threshold", async () => {
  ...
  it("config_html_styled_custom_css", async () => {
  ...
  it("config_html_styled_default", async () => {
  ...
  it("config_html_styled_no_embed", async () => {
