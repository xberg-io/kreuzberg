...
// alef:hash:c510c6e09002117dce006b2d7156ec07809536bc9064cbdeb0998094390436cd
...
namespace Kreuzberg
{
    ...
    public class EmbeddingsTests
    {
        ...
        public void Test_EmbedTextsDifferentPreset()
        {
            ...
            var result = KreuzbergLib.EmbedTexts(new List<String>() { JsonSerializer.Deserialize<String>("\"Hello world\"", ConfigOptions)!, JsonSerializer.Deserialize<String>("\"Test\"", ConfigOptions)! }, new EmbeddingConfig { Model = "multilingual" });
