...
namespace Xberg
{
    ...
    public class UrlTests
    {
        ...
        public async Task Test_UrlBatchMixedInputs()
        {
            ...
            var Inputs_MockBaseUrl = Environment.GetEnvironmentVariable("MOCK_SERVER_URL") + "/fixtures/url_batch_mixed_inputs";
            ...
            var Inputs = JsonSerializer.Deserialize<List<ExtractInput>>(Inputs_Json, ConfigOptions)!;
            var result = await XbergConverter.ExtractBatchAsync(Inputs, new ExtractionConfig { Url = JsonSerializer.Deserialize<UrlExtractionConfig>("{\"mode\":\"document\"}", ConfigOptions)! });
