...
# alef:hash:e82c179cc20bea6cd20d8fd30337908f81c1745531fdd39ec1eb10a43c9e97d6
...
from kreuzberg import pdf_page_count, render_page, extract_file_sync, ExtractionConfig


def test_pdf_page_count_basic() -> None:
    """Count pages in a small PDF without rendering them."""
    pdf_bytes = "pdf/tiny.pdf"
    result = pdf_page_count(pdf_bytes=pdf_bytes)
