...
# alef:hash:50fc6307f62da56735039af74ce1dd575f8af7bfaaedcb3008398bba71804edd
...
def test_validate_chunking_params_invalid() -> None:
    ...
    overlap = 60
    with pytest.raises(Exception):  # noqa: B017
        validate_chunking_params(max_chars=max_characters, max_overlap=overlap)
...
def test_validate_chunking_params_valid() -> None:
    ...
    max_characters = 500
    overlap = 50
    _ = validate_chunking_params(max_chars=max_characters, max_overlap=overlap)
