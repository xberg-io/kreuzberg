...
# alef:hash:3df16be2deaba979a0a0d1fd9c4ec85b10d7863d23226580561d13f10664406e
...
def test_reduce_tokens_maximum() -> None:
    ...
    config = None
    _ = reduce_tokens(text=text, config=config)
...
def test_reduce_tokens_off() -> None:
    ...
    config = None
    result = reduce_tokens(text=text, config=config)
...
def test_token_reduction_reduce_aggressive() -> None:
    ...
    config = ExtractionConfig(level="aggressive")
    result = reduce_tokens(text=text, config=config)
...
def test_token_reduction_reduce_basic() -> None:
    ...
    config = ExtractionConfig(level="light")
    result = reduce_tokens(text=text, config=config)
...
def test_token_reduction_with_chunking() -> None:
    ...
    config = ExtractionConfig(
        chunking={"max_characters": 500, "overlap": 50},
