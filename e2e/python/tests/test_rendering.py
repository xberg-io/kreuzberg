...
# alef:hash:a40eb469e5c4f956b58a68f74eb39e31472d0531be1e2905e6ba7573f8fca1be
...
def test_djot_to_html_basic() -> None:
    ...
    result = djot_to_html(djot_source=djot)
...
def test_djot_to_html_empty() -> None:
    ...
    djot = ""
    _ = djot_to_html(djot_source=djot)
...
def test_render_djot_basic() -> None:
    ...
    result = render_djot_str(html=doc)
...
def test_render_html_basic() -> None:
    ...
    result = render_html_str(html=doc)
    assert len(result) >= 5  # noqa: S101
...
def test_render_json_basic() -> None:
    ...
    result = render_json_str(html=doc)
    assert len(result) >= 5  # noqa: S101
...
def test_render_markdown_basic() -> None:
    ...
    result = render_markdown_str(html=doc)
    assert len(result) >= 5  # noqa: S101
...
def test_render_plain_basic() -> None:
    ...
    result = render_plain_str(html=doc)
    assert len(result) >= 5  # noqa: S101
