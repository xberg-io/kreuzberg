...
# alef:hash:f3be14954348cad2bf6a80877d898bf7325233b9045f73ddb7e225e9fa2abbb1
...
def test_render_djot_basic() -> None:
    ...
    result = render_djot_str(doc=doc)
...
def test_render_html_basic() -> None:
    ...
    result = render_html_str(doc=doc)
    assert len(result.content) >= 5  # noqa: S101
...
def test_render_json_basic() -> None:
    ...
    result = render_json_str(doc=doc)
    assert len(result.content) >= 5  # noqa: S101
...
def test_render_markdown_basic() -> None:
    ...
    result = render_markdown_str(doc=doc)
    assert len(result.content) >= 5  # noqa: S101
...
def test_render_plain_basic() -> None:
    ...
    result = render_plain_str(doc=doc)
    assert len(result.content) >= 5  # noqa: S101
