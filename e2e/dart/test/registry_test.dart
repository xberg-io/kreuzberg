...
// alef:hash:472e052a0c6dbb870bc0ee9464879c10fdafa27bd1f116a97708ec2f8f4b7025
...
void main() {
  ...
  test('List embedding backends', () async {
    final result = await KreuzbergBridge.extractBytes(mimeType: 'application/octet-stream');
  });
