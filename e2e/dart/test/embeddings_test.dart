...
// alef:hash:a24dedf235a1621e1287cbb0b60568abca5a3c2723e0de135f3d0bb37ae93780
...
void main() {
  ...
  test('embed_texts: multilingual preset', () async {
    final result = await KreuzbergBridge.embedTexts(texts: <String>['Hello world', 'Test'], ExtractionConfig(useCache: true, enableQualityProcessing: true, forceOcr: false, disableOcr: false, resultFormat: ResultFormat.unified, outputFormat: OutputFormat.plain(), includeDocumentStructure: false, useLayoutForMarkdown: false, maxArchiveDepth: 3));
