...
describe("plugin_api", () => {
  ...
  async dispose(): Promise<void> { return undefined; }
		...
		await unregisterDocumentExtractor(_bridge_extractor);
  ...
  async dispose(): Promise<void> { return undefined; }
		...
		await unregisterOcrBackend(_bridge_backend);
  ...
  async dispose(): Promise<void> { return undefined; }
		...
		await unregisterPostProcessor(_bridge_processor);
  ...
  async dispose(): Promise<void> { return undefined; }
		...
		await unregisterRenderer(_bridge_renderer);
  ...
  async dispose(): Promise<void> { return undefined; }
		...
		await unregisterValidator(_bridge_validator);
