...
// Test DOCX
const docxResult = extractFileSync('/Users/naamanhirschfeld/workspace/kreuzberg-dev/kreuzberg/test_documents/docx/fake.docx', undefined, {
...
console.log('keys:', Object.keys(docxResult).filter(k => k.includes('doc')));
