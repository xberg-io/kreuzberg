...
describe("ocr fixtures", () => {
  ...
  it("ocr_paddle_confidence_filter", () => {
    ...
    const config = buildConfig({"ocr":{"backend":"paddle-ocr","language":"en","paddle_ocr_config":{"min_confidence":80.0}},"force_ocr":true});
    let result: ExtractionResult | null = null;
    try {
      result = extractFileSync(documentPath, null, config);
    } catch (error) {
  ...
  it("ocr_paddle_element_hierarchy", () => {
    ...
    const config = buildConfig({"ocr":{"backend":"paddle-ocr","language":"en","element_config":{"include_elements":true,"build_hierarchy":true}},"force_ocr":true});
    let result: ExtractionResult | null = null;
    try {
      result = extractFileSync(documentPath, null, config);
    } catch (error) {
  ...
  it("ocr_paddle_element_levels", () => {
    ...
    const config = buildConfig({"ocr":{"backend":"paddle-ocr","language":"en","element_config":{"include_elements":true,"min_level":"word"}},"force_ocr":true});
    let result: ExtractionResult | null = null;
    try {
      result = extractFileSync(documentPath, null, config);
    } catch (error) {
  ...
  it("ocr_paddle_markdown", () => {
    ...
    const config = buildConfig({"ocr":{"backend":"paddle-ocr","language":"en","paddle_ocr_config":{"output_format":"markdown"}},"force_ocr":true});
    let result: ExtractionResult | null = null;
    try {
      result = extractFileSync(documentPath, null, config);
    } catch (error) {
  ...
  it("ocr_paddle_structured", () => {
    ...
    const config = buildConfig({"ocr":{"backend":"paddle-ocr","language":"en","element_config":{"include_elements":true}},"force_ocr":true});
    let result: ExtractionResult | null = null;
    try {
      result = extractFileSync(documentPath, null, config);
    } catch (error) {
  ...
  it("ocr_paddle_table_detection", () => {
    ...
    if (!existsSync(documentPath)) {
      ...
      console.warn("Notes: Tests table detection capability with PaddleOCR. ONNX Runtime model loading unstable on ARM Linux.");
      return;
    }
    ...
    const config = buildConfig({"output_format":"markdown","ocr":{"backend":"paddle-ocr","language":"en","paddle_ocr_config":{"enable_table_detection":true}},"force_ocr":true});
    let result: ExtractionResult | null = null;
    try {
      result = extractFileSync(documentPath, null, config);
    } catch (error) {
      if (shouldSkipFixture(error, "ocr_paddle_table_detection", ["onnxruntime", "paddle-ocr"], "Tests table detection capability with PaddleOCR. ONNX Runtime model loading unstable on ARM Linux.")) {
        return;
      }
      throw error;
    }
  ...
  it("ocr_tesseract_elements", () => {
    ...
    const config = buildConfig({"ocr":{"backend":"tesseract","language":"eng","element_config":{"include_elements":true}},"force_ocr":true});
    let result: ExtractionResult | null = null;
    try {
      result = extractFileSync(documentPath, null, config);
    } catch (error) {
  ...
  it("ocr_tesseract_elements_min_count", () => {
    ...
    const config = buildConfig({"ocr":{"backend":"tesseract","language":"eng","element_config":{"include_elements":true,"min_level":"line"}},"force_ocr":true});
    let result: ExtractionResult | null = null;
    try {
      result = extractFileSync(documentPath, null, config);
    } catch (error) {
