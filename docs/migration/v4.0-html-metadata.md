...
=== "Before (v3.x)"
    ...
    ExtractionResult result = Xberg.extractFileSync("page.html");
...
=== "Before (v3.x)"
    ...
    func main() {
        result, err := xberg.ExtractFileSync("page.html", nil)
        if err != nil {
...
=== "Before (v3.x)"
    ...
    result = Xberg.extract_file_sync('page.html')
...
- [HTML Metadata Type Reference](../reference/types.md)
...
- Open an issue on [GitHub](https://github.com/xberg-io/xberg/issues)
