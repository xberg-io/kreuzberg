...
var result = await XbergLib.ExtractFileAsync("complex_document.pdf", advancedConfig);
...
var result = await XbergLib.ExtractFileAsync("document.pdf", minimalConfig);
...
var result = await XbergLib.ExtractFileAsync("document.pdf", noHierarchyConfig);
