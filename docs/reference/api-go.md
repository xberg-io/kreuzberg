# Go API Reference <span class="version-badge">v4.8.1</span>
...
curl -LO https://github.com/kreuzberg-dev/kreuzberg/releases/download/v4.8.1/go-ffi-linux-x86_64.tar.gz
...
### BatchExtractFilesWithConfigs <span class="version-badge">v4.8.1</span>
...
### BatchExtractFilesWithConfigsSync <span class="version-badge">v4.8.1</span>
...
### BatchExtractBytesWithConfigs / BatchExtractBytesWithConfigsSync <span class="version-badge">v4.8.1</span>

Batch extract multiple byte arrays with per-file configuration overrides. Async and sync variants follow the same pattern.

---

### FileExtractionConfig <span class="version-badge">v4.8.1</span>
...
- `string`: Version string (for example, "4.8.1")
...
type PdfConfig struct {
	AllowSingleColumnTables *bool       // <span class="version-badge">v4.8.1</span> Allow extraction of single-column tables
...
### ConcurrencyConfig <span class="version-badge">v4.8.1</span>
...
### LayoutDetectionConfig <span class="version-badge">v4.8.1</span>
...
type PaddleOcrConfig struct {
	...
	Language             string   // Language code
	ModelTier            string   // (v4.8.1) Model tier: "mobile" (default, ~21MB total, fast) or "server" (~172MB, best with GPU)
	Padding              *int     // (v4.8.1) Padding in pixels (0-100) around image before detection. Default: 10
