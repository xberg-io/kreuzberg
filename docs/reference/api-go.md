# Go API Reference <span class="version-badge">v4.4.3</span>
...
curl -LO https://github.com/kreuzberg-dev/kreuzberg/releases/download/v4.4.3/go-ffi-linux-x86_64.tar.gz
...
- `string`: Version string (e.g., "4.4.3")
