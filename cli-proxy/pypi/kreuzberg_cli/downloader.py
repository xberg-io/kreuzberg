"""Resolve, download, verify, and run the native kreuzberg binary.
...
BIN_NAME = "kreuzberg"
PKG_NAME = "kreuzberg-cli"
VERSION_ENV = "KREUZBERG_CLI_VERSION"
_USER_AGENT = "kreuzberg-cli-python-proxy"
...
def ensure_binary() -> str:
    ...
    override = os.getenv("KREUZBERG_BINARY")
    if override:
        return override
