...
object Kreuzberg {
     ...
     */
    fun calculateQualityScore(text: String, metadata: String? = null): Double = KreuzbergBridge.nativeCalculateQualityScore(text, metadata?.let { mapper.writeValueAsString(it) } ?: "")
    /**
