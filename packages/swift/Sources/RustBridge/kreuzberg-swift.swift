...
public func blake3_hash_file<GenericIntoRustString: IntoRustString>(_ path: GenericIntoRustString) throws -> RustString {
    try { let val = __swift_bridge__$blake3_hash_file({ let rustString = path.intoRustString(); rustString.isOwned = false; return rustString.ptr }()); if val.is_ok { return RustString(ptr: val.ok_or_err!) } else { throw RustString(ptr: val.ok_or_err!) } }()
}
public func fast_hash(_ data: RustVec<UInt8>) -> UInt64 {
    __swift_bridge__$fast_hash({ let val = data; val.isOwned = false; return val.ptr }())
}
public func validate_cache_key<GenericIntoRustString: IntoRustString>(_ key: GenericIntoRustString) -> Bool {
    __swift_bridge__$validate_cache_key({ let rustString = key.intoRustString(); rustString.isOwned = false; return rustString.ptr }())
}
public func validate_port(_ port: UInt16) throws -> () {
    try { let val = __swift_bridge__$validate_port(port); if val != nil { throw RustString(ptr: val!) } else { return } }()
}
public func validate_host<GenericIntoRustString: IntoRustString>(_ host: GenericIntoRustString) throws -> () {
    try { let val = __swift_bridge__$validate_host({ let rustString = host.intoRustString(); rustString.isOwned = false; return rustString.ptr }()); if val != nil { throw RustString(ptr: val!) } else { return } }()
}
public func validate_cors_origin<GenericIntoRustString: IntoRustString>(_ origin: GenericIntoRustString) throws -> () {
    try { let val = __swift_bridge__$validate_cors_origin({ let rustString = origin.intoRustString(); rustString.isOwned = false; return rustString.ptr }()); if val != nil { throw RustString(ptr: val!) } else { return } }()
}
public func validate_upload_size(_ size: UInt) throws -> () {
    try { let val = __swift_bridge__$validate_upload_size(size); if val != nil { throw RustString(ptr: val!) } else { return } }()
}
public func validate_binarization_method<GenericIntoRustString: IntoRustString>(_ method: GenericIntoRustString) throws -> () {
    try { let val = __swift_bridge__$validate_binarization_method({ let rustString = method.intoRustString(); rustString.isOwned = false; return rustString.ptr }()); if val != nil { throw RustString(ptr: val!) } else { return } }()
}
public func validate_token_reduction_level<GenericIntoRustString: IntoRustString>(_ level: GenericIntoRustString) throws -> () {
    try { let val = __swift_bridge__$validate_token_reduction_level({ let rustString = level.intoRustString(); rustString.isOwned = false; return rustString.ptr }()); if val != nil { throw RustString(ptr: val!) } else { return } }()
}
public func validate_ocr_backend<GenericIntoRustString: IntoRustString>(_ backend: GenericIntoRustString) throws -> () {
    try { let val = __swift_bridge__$validate_ocr_backend({ let rustString = backend.intoRustString(); rustString.isOwned = false; return rustString.ptr }()); if val != nil { throw RustString(ptr: val!) } else { return } }()
}
public func validate_language_code<GenericIntoRustString: IntoRustString>(_ code: GenericIntoRustString) throws -> () {
    try { let val = __swift_bridge__$validate_language_code({ let rustString = code.intoRustString(); rustString.isOwned = false; return rustString.ptr }()); if val != nil { throw RustString(ptr: val!) } else { return } }()
}
public func validate_tesseract_psm(_ psm: Int32) throws -> () {
    try { let val = __swift_bridge__$validate_tesseract_psm(psm); if val != nil { throw RustString(ptr: val!) } else { return } }()
}
public func validate_tesseract_oem(_ oem: Int32) throws -> () {
    try { let val = __swift_bridge__$validate_tesseract_oem(oem); if val != nil { throw RustString(ptr: val!) } else { return } }()
}
public func validate_output_format<GenericIntoRustString: IntoRustString>(_ format: GenericIntoRustString) throws -> () {
    try { let val = __swift_bridge__$validate_output_format({ let rustString = format.intoRustString(); rustString.isOwned = false; return rustString.ptr }()); if val != nil { throw RustString(ptr: val!) } else { return } }()
}
public func validate_confidence(_ confidence: Double) throws -> () {
    try { let val = __swift_bridge__$validate_confidence(confidence); if val != nil { throw RustString(ptr: val!) } else { return } }()
}
public func validate_dpi(_ dpi: Int32) throws -> () {
    try { let val = __swift_bridge__$validate_dpi(dpi); if val != nil { throw RustString(ptr: val!) } else { return } }()
}
public func validate_chunking_params(_ max_chars: UInt, _ max_overlap: UInt) throws -> () {
    try { let val = __swift_bridge__$validate_chunking_params(max_chars, max_overlap); if val != nil { throw RustString(ptr: val!) } else { return } }()
}
public func validate_llm_config_model<GenericIntoRustString: IntoRustString>(_ model: GenericIntoRustString) throws -> () {
    try { let val = __swift_bridge__$validate_llm_config_model({ let rustString = model.intoRustString(); rustString.isOwned = false; return rustString.ptr }()); if val != nil { throw RustString(ptr: val!) } else { return } }()
}
public func extract_bytes<GenericIntoRustString: IntoRustString>(_ content: RustVec<UInt8>, _ mime_type: GenericIntoRustString, _ config: ExtractionConfig) throws -> ExtractionResult {
...
public func extract_file<GenericIntoRustString: IntoRustString>(_ path: GenericIntoRustString, _ mime_type: Optional<GenericIntoRustString>, _ config: ExtractionConfig) throws -> ExtractionResult {
...
public func extract_file_sync<GenericIntoRustString: IntoRustString>(_ path: GenericIntoRustString, _ mime_type: Optional<GenericIntoRustString>, _ config: ExtractionConfig) throws -> ExtractionResult {
    try { let val = __swift_bridge__$extract_file_sync({ let rustString = path.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { if let rustString = optionalStringIntoRustString(mime_type) { rustString.isOwned = false; return rustString.ptr } else { return nil } }(), {config.isOwned = false; return config.ptr;}()); if val.is_ok { return ExtractionResult(ptr: val.ok_or_err!) } else { throw RustString(ptr: val.ok_or_err!) } }()
}
public func extract_bytes_sync<GenericIntoRustString: IntoRustString>(_ content: RustVec<UInt8>, _ mime_type: GenericIntoRustString, _ config: ExtractionConfig) throws -> ExtractionResult {
    try { let val = __swift_bridge__$extract_bytes_sync({ let val = content; val.isOwned = false; return val.ptr }(), { let rustString = mime_type.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), {config.isOwned = false; return config.ptr;}()); if val.is_ok { return ExtractionResult(ptr: val.ok_or_err!) } else { throw RustString(ptr: val.ok_or_err!) } }()
}
public func batch_extract_file_sync<GenericIntoRustString: IntoRustString>(_ items: RustVec<GenericIntoRustString>, _ config: ExtractionConfig) throws -> RustVec<ExtractionResult> {
    try { let val = __swift_bridge__$batch_extract_file_sync({ let val = items; val.isOwned = false; return val.ptr }(), {config.isOwned = false; return config.ptr;}()); if val.is_ok { return RustVec(ptr: val.ok_or_err!) } else { throw RustString(ptr: val.ok_or_err!) } }()
}
public func batch_extract_bytes_sync<GenericIntoRustString: IntoRustString>(_ items: RustVec<GenericIntoRustString>, _ config: ExtractionConfig) throws -> RustVec<ExtractionResult> {
...
public func batch_extract_file<GenericIntoRustString: IntoRustString>(_ items: RustVec<GenericIntoRustString>, _ config: ExtractionConfig) throws -> RustVec<ExtractionResult> {
    try { let val = __swift_bridge__$batch_extract_file({ let val = items; val.isOwned = false; return val.ptr }(), {config.isOwned = false; return config.ptr;}()); if val.is_ok { return RustVec(ptr: val.ok_or_err!) } else { throw RustString(ptr: val.ok_or_err!) } }()
}
public func batch_extract_bytes<GenericIntoRustString: IntoRustString>(_ items: RustVec<GenericIntoRustString>, _ config: ExtractionConfig) throws -> RustVec<ExtractionResult> {
...
public func is_valid_format_field<GenericIntoRustString: IntoRustString>(_ field: GenericIntoRustString) -> Bool {
    __swift_bridge__$is_valid_format_field({ let rustString = field.intoRustString(); rustString.isOwned = false; return rustString.ptr }())
}
public func validate_mime_type<GenericIntoRustString: IntoRustString>(_ mime_type: GenericIntoRustString) throws -> RustString {
    try { let val = __swift_bridge__$validate_mime_type({ let rustString = mime_type.intoRustString(); rustString.isOwned = false; return rustString.ptr }()); if val.is_ok { return RustString(ptr: val.ok_or_err!) } else { throw RustString(ptr: val.ok_or_err!) } }()
}
public func detect_or_validate<GenericIntoRustString: IntoRustString>(_ path: Optional<GenericIntoRustString>, _ mime_type: Optional<GenericIntoRustString>) throws -> RustString {
    try { let val = __swift_bridge__$detect_or_validate({ if let rustString = optionalStringIntoRustString(path) { rustString.isOwned = false; return rustString.ptr } else { return nil } }(), { if let rustString = optionalStringIntoRustString(mime_type) { rustString.isOwned = false; return rustString.ptr } else { return nil } }()); if val.is_ok { return RustString(ptr: val.ok_or_err!) } else { throw RustString(ptr: val.ok_or_err!) } }()
}
...
public func get_extensions_for_mime<GenericIntoRustString: IntoRustString>(_ mime_type: GenericIntoRustString) throws -> RustVec<RustString> {
...
public func clear_processor_cache() throws -> () {
    try { let val = __swift_bridge__$clear_processor_cache(); if val != nil { throw RustString(ptr: val!) } else { return } }()
}
public func transform_extraction_result_to_elements(_ result: ExtractionResult) -> RustVec<Element> {
    RustVec(ptr: __swift_bridge__$transform_extraction_result_to_elements({result.isOwned = false; return result.ptr;}()))
}
public func extract_email_content<GenericIntoRustString: IntoRustString>(_ data: RustVec<UInt8>, _ mime_type: GenericIntoRustString, _ fallback_codepage: Optional<UInt32>) throws -> EmailExtractionResult {
    try { let val = __swift_bridge__$extract_email_content({ let val = data; val.isOwned = false; return val.ptr }(), { let rustString = mime_type.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), fallback_codepage.intoFfiRepr()); if val.is_ok { return EmailExtractionResult(ptr: val.ok_or_err!) } else { throw RustString(ptr: val.ok_or_err!) } }()
}
public func cells_to_text<GenericIntoRustString: IntoRustString>(_ cells: GenericIntoRustString) -> RustString {
    RustString(ptr: __swift_bridge__$cells_to_text({ let rustString = cells.intoRustString(); rustString.isOwned = false; return rustString.ptr }()))
}
public func cells_to_markdown<GenericIntoRustString: IntoRustString>(_ cells: GenericIntoRustString) -> RustString {
    RustString(ptr: __swift_bridge__$cells_to_markdown({ let rustString = cells.intoRustString(); rustString.isOwned = false; return rustString.ptr }()))
}
public func djot_to_html<GenericIntoRustString: IntoRustString>(_ djot_source: GenericIntoRustString) throws -> RustString {
    try { let val = __swift_bridge__$djot_to_html({ let rustString = djot_source.intoRustString(); rustString.isOwned = false; return rustString.ptr }()); if val.is_ok { return RustString(ptr: val.ok_or_err!) } else { throw RustString(ptr: val.ok_or_err!) } }()
}
public func dedup_text<GenericIntoRustString: IntoRustString>(_ texts: RustVec<GenericIntoRustString>) -> RustVec<RustString> {
    RustVec(ptr: __swift_bridge__$dedup_text({ let val = texts; val.isOwned = false; return val.ptr }()))
}
public func normalize_whitespace<GenericIntoRustString: IntoRustString>(_ s: GenericIntoRustString) -> RustString {
    RustString(ptr: __swift_bridge__$normalize_whitespace({ let rustString = s.intoRustString(); rustString.isOwned = false; return rustString.ptr }()))
}
public func register_default_extractors() throws -> () {
    try { let val = __swift_bridge__$register_default_extractors(); if val != nil { throw RustString(ptr: val!) } else { return } }()
}
public func unregister_extractor<GenericIntoRustString: IntoRustString>(_ name: GenericIntoRustString) throws -> () {
    try { let val = __swift_bridge__$unregister_extractor({ let rustString = name.intoRustString(); rustString.isOwned = false; return rustString.ptr }()); if val != nil { throw RustString(ptr: val!) } else { return } }()
}
public func list_extractors() throws -> RustVec<RustString> {
    try { let val = __swift_bridge__$list_extractors(); if val.is_ok { return RustVec(ptr: val.ok_or_err!) } else { throw RustString(ptr: val.ok_or_err!) } }()
}
public func clear_extractors() throws -> () {
    try { let val = __swift_bridge__$clear_extractors(); if val != nil { throw RustString(ptr: val!) } else { return } }()
}
public func unregister_ocr_backend<GenericIntoRustString: IntoRustString>(_ name: GenericIntoRustString) throws -> () {
...
public func unregister_renderer<GenericIntoRustString: IntoRustString>(_ name: GenericIntoRustString) throws -> () {
...
public func sanitize_filename<GenericIntoRustString: IntoRustString>(_ path: GenericIntoRustString) -> RustString {
    RustString(ptr: __swift_bridge__$sanitize_filename({ let rustString = path.intoRustString(); rustString.isOwned = false; return rustString.ptr }()))
}
public func sanitize_path<GenericIntoRustString: IntoRustString>(_ path: GenericIntoRustString) -> RustString {
    RustString(ptr: __swift_bridge__$sanitize_path({ let rustString = path.intoRustString(); rustString.isOwned = false; return rustString.ptr }()))
}
public func is_valid_utf8(_ bytes: RustVec<UInt8>) -> Bool {
    __swift_bridge__$is_valid_utf8({ let val = bytes; val.isOwned = false; return val.ptr }())
}
public func clean_extracted_text<GenericIntoRustString: IntoRustString>(_ text: GenericIntoRustString) -> RustString {
    RustString(ptr: __swift_bridge__$clean_extracted_text({ let rustString = text.intoRustString(); rustString.isOwned = false; return rustString.ptr }()))
}
public func reduce_tokens<GenericIntoRustString: IntoRustString>(_ text: GenericIntoRustString, _ config: TokenReductionConfig, _ language_hint: Optional<GenericIntoRustString>) throws -> RustString {
    try { let val = __swift_bridge__$reduce_tokens({ let rustString = text.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), {config.isOwned = false; return config.ptr;}(), { if let rustString = optionalStringIntoRustString(language_hint) { rustString.isOwned = false; return rustString.ptr } else { return nil } }()); if val.is_ok { return RustString(ptr: val.ok_or_err!) } else { throw RustString(ptr: val.ok_or_err!) } }()
}
public func batch_reduce_tokens<GenericIntoRustString: IntoRustString>(_ texts: RustVec<GenericIntoRustString>, _ config: TokenReductionConfig, _ language_hint: Optional<GenericIntoRustString>) throws -> RustVec<RustString> {
    try { let val = __swift_bridge__$batch_reduce_tokens({ let val = texts; val.isOwned = false; return val.ptr }(), {config.isOwned = false; return config.ptr;}(), { if let rustString = optionalStringIntoRustString(language_hint) { rustString.isOwned = false; return rustString.ptr } else { return nil } }()); if val.is_ok { return RustVec(ptr: val.ok_or_err!) } else { throw RustString(ptr: val.ok_or_err!) } }()
}
...
public func link<GenericIntoRustString: IntoRustString>(_ start: UInt32, _ end: UInt32, _ url: GenericIntoRustString, _ title: Optional<GenericIntoRustString>) -> TextAnnotation {
    TextAnnotation(ptr: __swift_bridge__$link(start, end, { let rustString = url.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { if let rustString = optionalStringIntoRustString(title) { rustString.isOwned = false; return rustString.ptr } else { return nil } }()))
}
...
public func font_size<GenericIntoRustString: IntoRustString>(_ start: UInt32, _ end: UInt32, _ value: GenericIntoRustString) -> TextAnnotation {
    TextAnnotation(ptr: __swift_bridge__$font_size(start, end, { let rustString = value.intoRustString(); rustString.isOwned = false; return rustString.ptr }()))
}
public func color<GenericIntoRustString: IntoRustString>(_ start: UInt32, _ end: UInt32, _ value: GenericIntoRustString) -> TextAnnotation {
    TextAnnotation(ptr: __swift_bridge__$color(start, end, { let rustString = value.intoRustString(); rustString.isOwned = false; return rustString.ptr }()))
}
public func highlight(_ start: UInt32, _ end: UInt32) -> TextAnnotation {
    TextAnnotation(ptr: __swift_bridge__$highlight(start, end))
}
public func classify_uri<GenericIntoRustString: IntoRustString>(_ url: GenericIntoRustString) -> UriKind {
    UriKind(ptr: __swift_bridge__$classify_uri({ let rustString = url.intoRustString(); rustString.isOwned = false; return rustString.ptr }()))
}
public func safe_decode<GenericIntoRustString: IntoRustString>(_ byte_data: RustVec<UInt8>, _ encoding: Optional<GenericIntoRustString>) -> RustString {
    RustString(ptr: __swift_bridge__$safe_decode({ let val = byte_data; val.isOwned = false; return val.ptr }(), { if let rustString = optionalStringIntoRustString(encoding) { rustString.isOwned = false; return rustString.ptr } else { return nil } }()))
}
public func calculate_text_confidence<GenericIntoRustString: IntoRustString>(_ text: GenericIntoRustString) -> Double {
    __swift_bridge__$calculate_text_confidence({ let rustString = text.intoRustString(); rustString.isOwned = false; return rustString.ptr }())
}
public func create_string_buffer_pool(_ pool_size: UInt, _ buffer_capacity: UInt) -> StringBufferPool {
...
public func serve_default() throws -> () {
    try { let val = __swift_bridge__$serve_default(); if val != nil { throw RustString(ptr: val!) } else { return } }()
}
public func chunk_text<GenericIntoRustString: IntoRustString>(_ text: GenericIntoRustString, _ config: ChunkingConfig, _ page_boundaries: Optional<RustVec<PageBoundary>>) throws -> ChunkingResult {
    try { let val = __swift_bridge__$chunk_text({ let rustString = text.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), {config.isOwned = false; return config.ptr;}(), { if let val = page_boundaries { val.isOwned = false; return val.ptr } else { return nil } }()); if val.is_ok { return ChunkingResult(ptr: val.ok_or_err!) } else { throw RustString(ptr: val.ok_or_err!) } }()
}
public func chunk_text_with_heading_source<GenericIntoRustString: IntoRustString>(_ text: GenericIntoRustString, _ config: ChunkingConfig, _ page_boundaries: Optional<RustVec<PageBoundary>>, _ heading_source: Optional<GenericIntoRustString>) throws -> ChunkingResult {
    try { let val = __swift_bridge__$chunk_text_with_heading_source({ let rustString = text.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), {config.isOwned = false; return config.ptr;}(), { if let val = page_boundaries { val.isOwned = false; return val.ptr } else { return nil } }(), { if let rustString = optionalStringIntoRustString(heading_source) { rustString.isOwned = false; return rustString.ptr } else { return nil } }()); if val.is_ok { return ChunkingResult(ptr: val.ok_or_err!) } else { throw RustString(ptr: val.ok_or_err!) } }()
}
public func chunk_texts_batch<GenericIntoRustString: IntoRustString>(_ texts: RustVec<GenericIntoRustString>, _ config: ChunkingConfig) throws -> RustVec<ChunkingResult> {
    try { let val = __swift_bridge__$chunk_texts_batch({ let val = texts; val.isOwned = false; return val.ptr }(), {config.isOwned = false; return config.ptr;}()); if val.is_ok { return RustVec(ptr: val.ok_or_err!) } else { throw RustString(ptr: val.ok_or_err!) } }()
}
public func chunk_semantic<GenericIntoRustString: IntoRustString>(_ text: GenericIntoRustString, _ config: ChunkingConfig, _ page_boundaries: Optional<RustVec<PageBoundary>>) throws -> ChunkingResult {
    try { let val = __swift_bridge__$chunk_semantic({ let rustString = text.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), {config.isOwned = false; return config.ptr;}(), { if let val = page_boundaries { val.isOwned = false; return val.ptr } else { return nil } }()); if val.is_ok { return ChunkingResult(ptr: val.ok_or_err!) } else { throw RustString(ptr: val.ok_or_err!) } }()
}
public func normalize(_ v: RustVec<Float>) -> RustVec<Float> {
    RustVec(ptr: __swift_bridge__$normalize({ let val = v; val.isOwned = false; return val.ptr }()))
}
public func list_presets() -> RustVec<RustString> {
    RustVec(ptr: __swift_bridge__$list_presets())
}
public func warm_model<GenericIntoRustString: IntoRustString>(_ model_type: EmbeddingModelType, _ cache_dir: Optional<GenericIntoRustString>) throws -> () {
    try { let val = __swift_bridge__$warm_model({model_type.isOwned = false; return model_type.ptr;}(), { if let rustString = optionalStringIntoRustString(cache_dir) { rustString.isOwned = false; return rustString.ptr } else { return nil } }()); if val != nil { throw RustString(ptr: val!) } else { return } }()
}
public func download_model<GenericIntoRustString: IntoRustString>(_ model_type: EmbeddingModelType, _ cache_dir: Optional<GenericIntoRustString>) throws -> () {
    try { let val = __swift_bridge__$download_model({model_type.isOwned = false; return model_type.ptr;}(), { if let rustString = optionalStringIntoRustString(cache_dir) { rustString.isOwned = false; return rustString.ptr } else { return nil } }()); if val != nil { throw RustString(ptr: val!) } else { return } }()
}
public func calculate_optimal_dpi(_ page_width: Double, _ page_height: Double, _ target_dpi: Int32, _ max_dimension: Int32, _ min_dpi: Int32, _ max_dpi: Int32) -> Int32 {
    __swift_bridge__$calculate_optimal_dpi(page_width, page_height, target_dpi, max_dimension, min_dpi, max_dpi)
}
public func detect_languages<GenericIntoRustString: IntoRustString>(_ text: GenericIntoRustString, _ config: LanguageDetectionConfig) throws -> RustString {
    try { let val = __swift_bridge__$detect_languages({ let rustString = text.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), {config.isOwned = false; return config.ptr;}()); if val.is_ok { return RustString(ptr: val.ok_or_err!) } else { throw RustString(ptr: val.ok_or_err!) } }()
}
public func extract_keywords<GenericIntoRustString: IntoRustString>(_ text: GenericIntoRustString, _ config: KeywordConfig) throws -> RustVec<Keyword> {
...
public func compute_hash<GenericIntoRustString: IntoRustString>(_ data: GenericIntoRustString) -> RustString {
    RustString(ptr: __swift_bridge__$compute_hash({ let rustString = data.intoRustString(); rustString.isOwned = false; return rustString.ptr }()))
}
public func render_pdf_page_to_png<GenericIntoRustString: IntoRustString>(_ pdf_bytes: RustVec<UInt8>, _ page_index: UInt, _ dpi: Optional<Int32>, _ password: Optional<GenericIntoRustString>) throws -> RustVec<UInt8> {
...
public func extract_text_from_pdf(_ pdf_bytes: RustVec<UInt8>) throws -> RustString {
    try { let val = __swift_bridge__$extract_text_from_pdf({ let val = pdf_bytes; val.isOwned = false; return val.ptr }()); if val.is_ok { return RustString(ptr: val.ok_or_err!) } else { throw RustString(ptr: val.ok_or_err!) } }()
}
public func serialize_to_toon(_ result: ExtractionResult) throws -> RustString {
    try { let val = __swift_bridge__$serialize_to_toon({result.isOwned = false; return result.ptr;}()); if val.is_ok { return RustString(ptr: val.ok_or_err!) } else { throw RustString(ptr: val.ok_or_err!) } }()
}
...
extension ExtractionConfigRef {
    ...
    public func security_limits() -> Optional<RustString> {
        { let val = __swift_bridge__$ExtractionConfig$security_limits(ptr); if val != nil { return RustString(ptr: val!) } else { return nil } }()
    }
...
extension ImageExtractionConfig {
    public convenience init(_ extract_images: Bool, _ target_dpi: Int32, _ max_image_dimension: Int32, _ inject_placeholders: Bool, _ auto_adjust_dpi: Bool, _ min_dpi: Int32, _ max_dpi: Int32, _ max_images_per_page: Optional<UInt32>) {
        self.init(ptr: __swift_bridge__$ImageExtractionConfig$new(extract_images, target_dpi, max_image_dimension, inject_placeholders, auto_adjust_dpi, min_dpi, max_dpi, max_images_per_page.intoFfiRepr()))
    }
}
...
extension StructuredExtractionConfig {
    public convenience init<GenericIntoRustString: IntoRustString>(_ schema: GenericIntoRustString, _ schema_name: GenericIntoRustString, _ schema_description: Optional<GenericIntoRustString>, _ strict: Bool, _ prompt: Optional<GenericIntoRustString>, _ llm: LlmConfig) {
        self.init(ptr: __swift_bridge__$StructuredExtractionConfig$new({ let rustString = schema.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { let rustString = schema_name.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { if let rustString = optionalStringIntoRustString(schema_description) { rustString.isOwned = false; return rustString.ptr } else { return nil } }(), strict, { if let rustString = optionalStringIntoRustString(prompt) { rustString.isOwned = false; return rustString.ptr } else { return nil } }(), {llm.isOwned = false; return llm.ptr;}()))
    }
}
...
extension OcrPipelineStage {
    public convenience init<GenericIntoRustString: IntoRustString>(_ backend: GenericIntoRustString, _ priority: UInt32, _ language: Optional<GenericIntoRustString>, _ tesseract_config: Optional<TesseractConfig>, _ paddle_ocr_config: Optional<GenericIntoRustString>, _ vlm_config: Optional<LlmConfig>) {
        self.init(ptr: __swift_bridge__$OcrPipelineStage$new({ let rustString = backend.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), priority, { if let rustString = optionalStringIntoRustString(language) { rustString.isOwned = false; return rustString.ptr } else { return nil } }(), { if let val = tesseract_config { val.isOwned = false; return val.ptr } else { return nil } }(), { if let rustString = optionalStringIntoRustString(paddle_ocr_config) { rustString.isOwned = false; return rustString.ptr } else { return nil } }(), { if let val = vlm_config { val.isOwned = false; return val.ptr } else { return nil } }()))
    }
}
...
extension OcrPipelineConfig {
    public convenience init(_ stages: RustVec<OcrPipelineStage>, _ quality_thresholds: OcrQualityThresholds) {
        self.init(ptr: __swift_bridge__$OcrPipelineConfig$new({ let val = stages; val.isOwned = false; return val.ptr }(), {quality_thresholds.isOwned = false; return quality_thresholds.ptr;}()))
    }
}
...
extension StructuredDataResult {
    public convenience init<GenericIntoRustString: IntoRustString>(_ content: GenericIntoRustString, _ format: GenericIntoRustString, _ metadata: GenericIntoRustString, _ text_fields: RustVec<GenericIntoRustString>) {
        self.init(ptr: __swift_bridge__$StructuredDataResult$new({ let rustString = content.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { let rustString = format.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { let rustString = metadata.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { let val = text_fields; val.isOwned = false; return val.ptr }()))
    }
}
...
extension ImageOcrResult {
    public convenience init<GenericIntoRustString: IntoRustString>(_ content: GenericIntoRustString, _ boundaries: Optional<RustVec<PageBoundary>>, _ page_contents: Optional<RustVec<PageContent>>) {
        self.init(ptr: __swift_bridge__$ImageOcrResult$new({ let rustString = content.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { if let val = boundaries { val.isOwned = false; return val.ptr } else { return nil } }(), { if let val = page_contents { val.isOwned = false; return val.ptr } else { return nil } }()))
    }
}
...
extension ImageOcrResultRef {
    ...
    public func boundaries() -> Optional<RustVec<PageBoundary>> {
        { let val = __swift_bridge__$ImageOcrResult$boundaries(ptr); if val != nil { return RustVec(ptr: val!) } else { return nil } }()
    }

    public func page_contents() -> Optional<RustVec<PageContent>> {
        { let val = __swift_bridge__$ImageOcrResult$page_contents(ptr); if val != nil { return RustVec(ptr: val!) } else { return nil } }()
    }
}
...
extension HtmlExtractionResult {
    public convenience init<GenericIntoRustString: IntoRustString>(_ markdown: GenericIntoRustString, _ images: RustVec<ExtractedInlineImage>, _ warnings: RustVec<GenericIntoRustString>) {
        self.init(ptr: __swift_bridge__$HtmlExtractionResult$new({ let rustString = markdown.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { let val = images; val.isOwned = false; return val.ptr }(), { let val = warnings; val.isOwned = false; return val.ptr }()))
    }
}
...
extension ExtractedInlineImage {
    public convenience init<GenericIntoRustString: IntoRustString>(_ data: RustVec<UInt8>, _ format: GenericIntoRustString, _ filename: Optional<GenericIntoRustString>, _ description: Optional<GenericIntoRustString>, _ dimensions: Optional<RustVec<UInt32>>, _ attributes: RustVec<GenericIntoRustString>) {
        self.init(ptr: __swift_bridge__$ExtractedInlineImage$new({ let val = data; val.isOwned = false; return val.ptr }(), { let rustString = format.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { if let rustString = optionalStringIntoRustString(filename) { rustString.isOwned = false; return rustString.ptr } else { return nil } }(), { if let rustString = optionalStringIntoRustString(description) { rustString.isOwned = false; return rustString.ptr } else { return nil } }(), { if let val = dimensions { val.isOwned = false; return val.ptr } else { return nil } }(), { let val = attributes; val.isOwned = false; return val.ptr }()))
    }
}
...
extension HeaderFooter {
    public convenience init<GenericIntoRustString: IntoRustString>(_ paragraphs: RustVec<GenericIntoRustString>, _ tables: RustVec<GenericIntoRustString>, _ header_type: GenericIntoRustString) {
        self.init(ptr: __swift_bridge__$HeaderFooter$new({ let val = paragraphs; val.isOwned = false; return val.ptr }(), { let val = tables; val.isOwned = false; return val.ptr }(), { let rustString = header_type.intoRustString(); rustString.isOwned = false; return rustString.ptr }()))
    }
}
...
extension HeaderFooter: Vectorizable {
    ...
    public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: HeaderFooter) {
        __swift_bridge__$Vec_HeaderFooter$push(vecPtr, {value.isOwned = false; return value.ptr;}())
    }
    ...
    public static func vecOfSelfGet(vecPtr: UnsafeMutableRawPointer, index: UInt) -> Optional<HeaderFooterRef> {
    ...
    public static func vecOfSelfGetMut(vecPtr: UnsafeMutableRawPointer, index: UInt) -> Optional<HeaderFooterRefMut> {
    ...
    public static func vecOfSelfAsPtr(vecPtr: UnsafeMutableRawPointer) -> UnsafePointer<HeaderFooterRef> {
...
extension Note {
    public convenience init<GenericIntoRustString: IntoRustString>(_ id: GenericIntoRustString, _ note_type: GenericIntoRustString, _ paragraphs: RustVec<GenericIntoRustString>) {
        self.init(ptr: __swift_bridge__$Note$new({ let rustString = id.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { let rustString = note_type.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { let val = paragraphs; val.isOwned = false; return val.ptr }()))
    }
}
...
extension Note: Vectorizable {
    ...
    public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: Note) {
        __swift_bridge__$Vec_Note$push(vecPtr, {value.isOwned = false; return value.ptr;}())
    }
    ...
    public static func vecOfSelfGet(vecPtr: UnsafeMutableRawPointer, index: UInt) -> Optional<NoteRef> {
    ...
    public static func vecOfSelfGetMut(vecPtr: UnsafeMutableRawPointer, index: UInt) -> Optional<NoteRefMut> {
...
extension StyleDefinition {
    public convenience init<GenericIntoRustString: IntoRustString>(_ id: GenericIntoRustString, _ name: Optional<GenericIntoRustString>, _ style_type: GenericIntoRustString, _ based_on: Optional<GenericIntoRustString>, _ next_style: Optional<GenericIntoRustString>, _ is_default: Bool, _ paragraph_properties: GenericIntoRustString, _ run_properties: GenericIntoRustString) {
        self.init(ptr: __swift_bridge__$StyleDefinition$new({ let rustString = id.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { if let rustString = optionalStringIntoRustString(name) { rustString.isOwned = false; return rustString.ptr } else { return nil } }(), { let rustString = style_type.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { if let rustString = optionalStringIntoRustString(based_on) { rustString.isOwned = false; return rustString.ptr } else { return nil } }(), { if let rustString = optionalStringIntoRustString(next_style) { rustString.isOwned = false; return rustString.ptr } else { return nil } }(), is_default, { let rustString = paragraph_properties.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { let rustString = run_properties.intoRustString(); rustString.isOwned = false; return rustString.ptr }()))
    }
}
...
extension PdfAnnotation {
    public convenience init<GenericIntoRustString: IntoRustString>(_ annotation_type: PdfAnnotationType, _ content: Optional<GenericIntoRustString>, _ page_number: UInt, _ bounding_box: Optional<GenericIntoRustString>) {
        self.init(ptr: __swift_bridge__$PdfAnnotation$new({annotation_type.isOwned = false; return annotation_type.ptr;}(), { if let rustString = optionalStringIntoRustString(content) { rustString.isOwned = false; return rustString.ptr } else { return nil } }(), page_number, { if let rustString = optionalStringIntoRustString(bounding_box) { rustString.isOwned = false; return rustString.ptr } else { return nil } }()))
    }
}
...
extension DjotContent {
    public convenience init<GenericIntoRustString: IntoRustString>(_ plain_text: GenericIntoRustString, _ blocks: RustVec<FormattedBlock>, _ metadata: Metadata, _ tables: RustVec<GenericIntoRustString>, _ images: RustVec<DjotImage>, _ links: RustVec<DjotLink>, _ footnotes: RustVec<Footnote>, _ attributes: RustVec<GenericIntoRustString>) {
        self.init(ptr: __swift_bridge__$DjotContent$new({ let rustString = plain_text.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { let val = blocks; val.isOwned = false; return val.ptr }(), {metadata.isOwned = false; return metadata.ptr;}(), { let val = tables; val.isOwned = false; return val.ptr }(), { let val = images; val.isOwned = false; return val.ptr }(), { let val = links; val.isOwned = false; return val.ptr }(), { let val = footnotes; val.isOwned = false; return val.ptr }(), { let val = attributes; val.isOwned = false; return val.ptr }()))
    }
}
...
extension FormattedBlock {
    public convenience init<GenericIntoRustString: IntoRustString>(_ block_type: BlockType, _ level: Optional<UInt>, _ inline_content: RustVec<InlineElement>, _ attributes: Optional<GenericIntoRustString>, _ language: Optional<GenericIntoRustString>, _ code: Optional<GenericIntoRustString>, _ children: RustVec<FormattedBlock>) {
        self.init(ptr: __swift_bridge__$FormattedBlock$new({block_type.isOwned = false; return block_type.ptr;}(), level.intoFfiRepr(), { let val = inline_content; val.isOwned = false; return val.ptr }(), { if let rustString = optionalStringIntoRustString(attributes) { rustString.isOwned = false; return rustString.ptr } else { return nil } }(), { if let rustString = optionalStringIntoRustString(language) { rustString.isOwned = false; return rustString.ptr } else { return nil } }(), { if let rustString = optionalStringIntoRustString(code) { rustString.isOwned = false; return rustString.ptr } else { return nil } }(), { let val = children; val.isOwned = false; return val.ptr }()))
    }
}
...
extension InlineElement {
    public convenience init<GenericIntoRustString: IntoRustString>(_ element_type: InlineType, _ content: GenericIntoRustString, _ attributes: Optional<GenericIntoRustString>, _ metadata: GenericIntoRustString) {
        self.init(ptr: __swift_bridge__$InlineElement$new({element_type.isOwned = false; return element_type.ptr;}(), { let rustString = content.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { if let rustString = optionalStringIntoRustString(attributes) { rustString.isOwned = false; return rustString.ptr } else { return nil } }(), { let rustString = metadata.intoRustString(); rustString.isOwned = false; return rustString.ptr }()))
    }
}
...
extension DjotImage {
    public convenience init<GenericIntoRustString: IntoRustString>(_ src: GenericIntoRustString, _ alt: GenericIntoRustString, _ title: Optional<GenericIntoRustString>, _ attributes: Optional<GenericIntoRustString>) {
        self.init(ptr: __swift_bridge__$DjotImage$new({ let rustString = src.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { let rustString = alt.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { if let rustString = optionalStringIntoRustString(title) { rustString.isOwned = false; return rustString.ptr } else { return nil } }(), { if let rustString = optionalStringIntoRustString(attributes) { rustString.isOwned = false; return rustString.ptr } else { return nil } }()))
    }
}
...
extension DjotLink {
    public convenience init<GenericIntoRustString: IntoRustString>(_ url: GenericIntoRustString, _ text: GenericIntoRustString, _ title: Optional<GenericIntoRustString>, _ attributes: Optional<GenericIntoRustString>) {
        self.init(ptr: __swift_bridge__$DjotLink$new({ let rustString = url.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { let rustString = text.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { if let rustString = optionalStringIntoRustString(title) { rustString.isOwned = false; return rustString.ptr } else { return nil } }(), { if let rustString = optionalStringIntoRustString(attributes) { rustString.isOwned = false; return rustString.ptr } else { return nil } }()))
    }
}
...
extension Footnote {
    public convenience init<GenericIntoRustString: IntoRustString>(_ label: GenericIntoRustString, _ content: RustVec<FormattedBlock>) {
        self.init(ptr: __swift_bridge__$Footnote$new({ let rustString = label.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { let val = content; val.isOwned = false; return val.ptr }()))
    }
}
...
extension DocumentStructure {
    public convenience init<GenericIntoRustString: IntoRustString>(_ nodes: RustVec<DocumentNode>, _ source_format: Optional<GenericIntoRustString>, _ relationships: RustVec<DocumentRelationship>) {
        self.init(ptr: __swift_bridge__$DocumentStructure$new({ let val = nodes; val.isOwned = false; return val.ptr }(), { if let rustString = optionalStringIntoRustString(source_format) { rustString.isOwned = false; return rustString.ptr } else { return nil } }(), { let val = relationships; val.isOwned = false; return val.ptr }()))
    }
}
...
extension DocumentRelationship {
    public convenience init(_ source: UInt32, _ target: UInt32, _ kind: RelationshipKind) {
        self.init(ptr: __swift_bridge__$DocumentRelationship$new(source, target, {kind.isOwned = false; return kind.ptr;}()))
    }
}
...
extension DocumentNode {
    public convenience init<GenericIntoRustString: IntoRustString>(_ id: GenericIntoRustString, _ content: NodeContent, _ parent: Optional<UInt32>, _ children: RustVec<UInt32>, _ content_layer: ContentLayer, _ page: Optional<UInt32>, _ page_end: Optional<UInt32>, _ bbox: Optional<GenericIntoRustString>, _ annotations: RustVec<TextAnnotation>, _ attributes: GenericIntoRustString) {
        self.init(ptr: __swift_bridge__$DocumentNode$new({ let rustString = id.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), {content.isOwned = false; return content.ptr;}(), parent.intoFfiRepr(), { let val = children; val.isOwned = false; return val.ptr }(), {content_layer.isOwned = false; return content_layer.ptr;}(), page.intoFfiRepr(), page_end.intoFfiRepr(), { if let rustString = optionalStringIntoRustString(bbox) { rustString.isOwned = false; return rustString.ptr } else { return nil } }(), { let val = annotations; val.isOwned = false; return val.ptr }(), { let rustString = attributes.intoRustString(); rustString.isOwned = false; return rustString.ptr }()))
    }
}
...
extension GridCell {
    public convenience init<GenericIntoRustString: IntoRustString>(_ content: GenericIntoRustString, _ row: UInt32, _ col: UInt32, _ row_span: UInt32, _ col_span: UInt32, _ is_header: Bool, _ bbox: Optional<GenericIntoRustString>) {
        self.init(ptr: __swift_bridge__$GridCell$new({ let rustString = content.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), row, col, row_span, col_span, is_header, { if let rustString = optionalStringIntoRustString(bbox) { rustString.isOwned = false; return rustString.ptr } else { return nil } }()))
    }
}
...
extension TextAnnotation {
    public convenience init(_ start: UInt32, _ end: UInt32, _ kind: AnnotationKind) {
        self.init(ptr: __swift_bridge__$TextAnnotation$new(start, end, {kind.isOwned = false; return kind.ptr;}()))
    }
}
...
extension ExtractionResultRef {
    ...
    public func ocr_internal_document() -> Optional<RustString> {
        { let val = __swift_bridge__$ExtractionResult$ocr_internal_document(ptr); if val != nil { return RustString(ptr: val!) } else { return nil } }()
    }
}
...
extension ArchiveEntry {
    public convenience init<GenericIntoRustString: IntoRustString>(_ path: GenericIntoRustString, _ mime_type: GenericIntoRustString, _ result: ExtractionResult) {
        self.init(ptr: __swift_bridge__$ArchiveEntry$new({ let rustString = path.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { let rustString = mime_type.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), {result.isOwned = false; return result.ptr;}()))
    }
}
...
extension ProcessingWarning {
    public convenience init<GenericIntoRustString: IntoRustString>(_ source: GenericIntoRustString, _ message: GenericIntoRustString) {
        self.init(ptr: __swift_bridge__$ProcessingWarning$new({ let rustString = source.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { let rustString = message.intoRustString(); rustString.isOwned = false; return rustString.ptr }()))
    }
}
...
extension Chunk {
    public convenience init<GenericIntoRustString: IntoRustString>(_ content: GenericIntoRustString, _ chunk_type: ChunkType, _ embedding: Optional<RustVec<Float>>, _ metadata: ChunkMetadata) {
        self.init(ptr: __swift_bridge__$Chunk$new({ let rustString = content.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), {chunk_type.isOwned = false; return chunk_type.ptr;}(), { if let val = embedding { val.isOwned = false; return val.ptr } else { return nil } }(), {metadata.isOwned = false; return metadata.ptr;}()))
    }
}
...
extension HeadingContext {
    public convenience init(_ headings: RustVec<HeadingLevel>) {
        self.init(ptr: __swift_bridge__$HeadingContext$new({ let val = headings; val.isOwned = false; return val.ptr }()))
    }
}
...
extension HeadingLevel {
    public convenience init<GenericIntoRustString: IntoRustString>(_ level: UInt8, _ text: GenericIntoRustString) {
        self.init(ptr: __swift_bridge__$HeadingLevel$new(level, { let rustString = text.intoRustString(); rustString.isOwned = false; return rustString.ptr }()))
    }
}
...
extension ChunkMetadata {
    public convenience init(_ byte_start: UInt, _ byte_end: UInt, _ token_count: Optional<UInt>, _ chunk_index: UInt, _ total_chunks: UInt, _ first_page: Optional<UInt>, _ last_page: Optional<UInt>, _ heading_context: Optional<HeadingContext>) {
        self.init(ptr: __swift_bridge__$ChunkMetadata$new(byte_start, byte_end, token_count.intoFfiRepr(), chunk_index, total_chunks, first_page.intoFfiRepr(), last_page.intoFfiRepr(), { if let val = heading_context { val.isOwned = false; return val.ptr } else { return nil } }()))
    }
}
...
extension ElementMetadata {
    public convenience init<GenericIntoRustString: IntoRustString>(_ page_number: Optional<UInt>, _ filename: Optional<GenericIntoRustString>, _ coordinates: Optional<GenericIntoRustString>, _ element_index: Optional<UInt>, _ additional: GenericIntoRustString) {
        self.init(ptr: __swift_bridge__$ElementMetadata$new(page_number.intoFfiRepr(), { if let rustString = optionalStringIntoRustString(filename) { rustString.isOwned = false; return rustString.ptr } else { return nil } }(), { if let rustString = optionalStringIntoRustString(coordinates) { rustString.isOwned = false; return rustString.ptr } else { return nil } }(), element_index.intoFfiRepr(), { let rustString = additional.intoRustString(); rustString.isOwned = false; return rustString.ptr }()))
    }
}
...
extension Element {
    public convenience init<GenericIntoRustString: IntoRustString>(_ element_id: GenericIntoRustString, _ element_type: ElementType, _ text: GenericIntoRustString, _ metadata: ElementMetadata) {
        self.init(ptr: __swift_bridge__$Element$new({ let rustString = element_id.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), {element_type.isOwned = false; return element_type.ptr;}(), { let rustString = text.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), {metadata.isOwned = false; return metadata.ptr;}()))
    }
}
...
extension ExcelWorkbook {
    public convenience init<GenericIntoRustString: IntoRustString>(_ sheets: RustVec<ExcelSheet>, _ metadata: GenericIntoRustString) {
        self.init(ptr: __swift_bridge__$ExcelWorkbook$new({ let val = sheets; val.isOwned = false; return val.ptr }(), { let rustString = metadata.intoRustString(); rustString.isOwned = false; return rustString.ptr }()))
    }
}
...
extension ExcelSheet {
    public convenience init<GenericIntoRustString: IntoRustString>(_ name: GenericIntoRustString, _ markdown: GenericIntoRustString, _ row_count: UInt, _ col_count: UInt, _ cell_count: UInt, _ table_cells: GenericIntoRustString) {
        self.init(ptr: __swift_bridge__$ExcelSheet$new({ let rustString = name.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { let rustString = markdown.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), row_count, col_count, cell_count, { let rustString = table_cells.intoRustString(); rustString.isOwned = false; return rustString.ptr }()))
    }
}
...
extension XmlExtractionResult {
    public convenience init<GenericIntoRustString: IntoRustString>(_ content: GenericIntoRustString, _ element_count: UInt, _ unique_elements: RustVec<GenericIntoRustString>) {
        self.init(ptr: __swift_bridge__$XmlExtractionResult$new({ let rustString = content.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), element_count, { let val = unique_elements; val.isOwned = false; return val.ptr }()))
    }
}
...
extension TextExtractionResult {
    public convenience init<GenericIntoRustString: IntoRustString>(_ content: GenericIntoRustString, _ line_count: UInt, _ word_count: UInt, _ character_count: UInt, _ headers: Optional<RustVec<GenericIntoRustString>>, _ links: Optional<RustVec<GenericIntoRustString>>, _ code_blocks: Optional<RustVec<GenericIntoRustString>>) {
        self.init(ptr: __swift_bridge__$TextExtractionResult$new({ let rustString = content.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), line_count, word_count, character_count, { if let val = headers { val.isOwned = false; return val.ptr } else { return nil } }(), { if let val = links { val.isOwned = false; return val.ptr } else { return nil } }(), { if let val = code_blocks { val.isOwned = false; return val.ptr } else { return nil } }()))
    }
}
...
extension PptxExtractionResult {
    public convenience init<GenericIntoRustString: IntoRustString>(_ content: GenericIntoRustString, _ metadata: PptxMetadata, _ slide_count: UInt, _ image_count: UInt, _ table_count: UInt, _ images: RustVec<ExtractedImage>, _ page_structure: Optional<PageStructure>, _ page_contents: Optional<RustVec<PageContent>>, _ document: Optional<DocumentStructure>, _ hyperlinks: RustVec<GenericIntoRustString>, _ office_metadata: GenericIntoRustString) {
        self.init(ptr: __swift_bridge__$PptxExtractionResult$new({ let rustString = content.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), {metadata.isOwned = false; return metadata.ptr;}(), slide_count, image_count, table_count, { let val = images; val.isOwned = false; return val.ptr }(), { if let val = page_structure { val.isOwned = false; return val.ptr } else { return nil } }(), { if let val = page_contents { val.isOwned = false; return val.ptr } else { return nil } }(), { if let val = document { val.isOwned = false; return val.ptr } else { return nil } }(), { let val = hyperlinks; val.isOwned = false; return val.ptr }(), { let rustString = office_metadata.intoRustString(); rustString.isOwned = false; return rustString.ptr }()))
    }
}
...
extension EmailExtractionResult {
    public convenience init<GenericIntoRustString: IntoRustString>(_ subject: Optional<GenericIntoRustString>, _ from_email: Optional<GenericIntoRustString>, _ to_emails: RustVec<GenericIntoRustString>, _ cc_emails: RustVec<GenericIntoRustString>, _ bcc_emails: RustVec<GenericIntoRustString>, _ date: Optional<GenericIntoRustString>, _ message_id: Optional<GenericIntoRustString>, _ plain_text: Optional<GenericIntoRustString>, _ html_content: Optional<GenericIntoRustString>, _ cleaned_text: GenericIntoRustString, _ attachments: RustVec<EmailAttachment>, _ metadata: GenericIntoRustString) {
        self.init(ptr: __swift_bridge__$EmailExtractionResult$new({ if let rustString = optionalStringIntoRustString(subject) { rustString.isOwned = false; return rustString.ptr } else { return nil } }(), { if let rustString = optionalStringIntoRustString(from_email) { rustString.isOwned = false; return rustString.ptr } else { return nil } }(), { let val = to_emails; val.isOwned = false; return val.ptr }(), { let val = cc_emails; val.isOwned = false; return val.ptr }(), { let val = bcc_emails; val.isOwned = false; return val.ptr }(), { if let rustString = optionalStringIntoRustString(date) { rustString.isOwned = false; return rustString.ptr } else { return nil } }(), { if let rustString = optionalStringIntoRustString(message_id) { rustString.isOwned = false; return rustString.ptr } else { return nil } }(), { if let rustString = optionalStringIntoRustString(plain_text) { rustString.isOwned = false; return rustString.ptr } else { return nil } }(), { if let rustString = optionalStringIntoRustString(html_content) { rustString.isOwned = false; return rustString.ptr } else { return nil } }(), { let rustString = cleaned_text.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { let val = attachments; val.isOwned = false; return val.ptr }(), { let rustString = metadata.intoRustString(); rustString.isOwned = false; return rustString.ptr }()))
    }
}
...
extension EmailAttachment {
    public convenience init<GenericIntoRustString: IntoRustString>(_ name: Optional<GenericIntoRustString>, _ filename: Optional<GenericIntoRustString>, _ mime_type: Optional<GenericIntoRustString>, _ size: Optional<UInt>, _ is_image: Bool, _ data: Optional<RustVec<UInt8>>) {
        self.init(ptr: __swift_bridge__$EmailAttachment$new({ if let rustString = optionalStringIntoRustString(name) { rustString.isOwned = false; return rustString.ptr } else { return nil } }(), { if let rustString = optionalStringIntoRustString(filename) { rustString.isOwned = false; return rustString.ptr } else { return nil } }(), { if let rustString = optionalStringIntoRustString(mime_type) { rustString.isOwned = false; return rustString.ptr } else { return nil } }(), size.intoFfiRepr(), is_image, { if let val = data { val.isOwned = false; return val.ptr } else { return nil } }()))
    }
}
...
extension OcrExtractionResultRef {
    ...
    public func internal_document() -> Optional<RustString> {
        { let val = __swift_bridge__$OcrExtractionResult$internal_document(ptr); if val != nil { return RustString(ptr: val!) } else { return nil } }()
    }
}
...
extension OcrTable {
    public convenience init<GenericIntoRustString: IntoRustString>(_ cells: GenericIntoRustString, _ markdown: GenericIntoRustString, _ page_number: UInt, _ bounding_box: Optional<OcrTableBoundingBox>) {
        self.init(ptr: __swift_bridge__$OcrTable$new({ let rustString = cells.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { let rustString = markdown.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), page_number, { if let val = bounding_box { val.isOwned = false; return val.ptr } else { return nil } }()))
    }
}
...
extension ImagePreprocessingMetadata {
    public convenience init<GenericIntoRustString: IntoRustString>(_ original_dimensions: RustVec<UInt>, _ original_dpi: RustVec<Double>, _ target_dpi: Int32, _ scale_factor: Double, _ auto_adjusted: Bool, _ final_dpi: Int32, _ new_dimensions: Optional<RustVec<UInt>>, _ resample_method: GenericIntoRustString, _ dimension_clamped: Bool, _ calculated_dpi: Optional<Int32>, _ skipped_resize: Bool, _ resize_error: Optional<GenericIntoRustString>) {
        self.init(ptr: __swift_bridge__$ImagePreprocessingMetadata$new({ let val = original_dimensions; val.isOwned = false; return val.ptr }(), { let val = original_dpi; val.isOwned = false; return val.ptr }(), target_dpi, scale_factor, auto_adjusted, final_dpi, { if let val = new_dimensions { val.isOwned = false; return val.ptr } else { return nil } }(), { let rustString = resample_method.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), dimension_clamped, calculated_dpi.intoFfiRepr(), skipped_resize, { if let rustString = optionalStringIntoRustString(resize_error) { rustString.isOwned = false; return rustString.ptr } else { return nil } }()))
    }
}
...
extension ExcelMetadata {
    public convenience init<GenericIntoRustString: IntoRustString>(_ sheet_count: UInt, _ sheet_names: RustVec<GenericIntoRustString>) {
        self.init(ptr: __swift_bridge__$ExcelMetadata$new(sheet_count, { let val = sheet_names; val.isOwned = false; return val.ptr }()))
    }
}
...
extension HeaderMetadata {
    public convenience init<GenericIntoRustString: IntoRustString>(_ level: UInt8, _ text: GenericIntoRustString, _ id: Optional<GenericIntoRustString>, _ depth: UInt, _ html_offset: UInt) {
        self.init(ptr: __swift_bridge__$HeaderMetadata$new(level, { let rustString = text.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { if let rustString = optionalStringIntoRustString(id) { rustString.isOwned = false; return rustString.ptr } else { return nil } }(), depth, html_offset))
    }
}
...
extension LinkMetadata {
    public convenience init<GenericIntoRustString: IntoRustString>(_ href: GenericIntoRustString, _ text: GenericIntoRustString, _ title: Optional<GenericIntoRustString>, _ link_type: LinkType, _ rel: RustVec<GenericIntoRustString>, _ attributes: RustVec<GenericIntoRustString>) {
        self.init(ptr: __swift_bridge__$LinkMetadata$new({ let rustString = href.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { let rustString = text.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { if let rustString = optionalStringIntoRustString(title) { rustString.isOwned = false; return rustString.ptr } else { return nil } }(), {link_type.isOwned = false; return link_type.ptr;}(), { let val = rel; val.isOwned = false; return val.ptr }(), { let val = attributes; val.isOwned = false; return val.ptr }()))
    }
}
...
extension ImageMetadataType {
    public convenience init<GenericIntoRustString: IntoRustString>(_ src: GenericIntoRustString, _ alt: Optional<GenericIntoRustString>, _ title: Optional<GenericIntoRustString>, _ dimensions: Optional<RustVec<UInt32>>, _ image_type: ImageType, _ attributes: RustVec<GenericIntoRustString>) {
        self.init(ptr: __swift_bridge__$ImageMetadataType$new({ let rustString = src.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { if let rustString = optionalStringIntoRustString(alt) { rustString.isOwned = false; return rustString.ptr } else { return nil } }(), { if let rustString = optionalStringIntoRustString(title) { rustString.isOwned = false; return rustString.ptr } else { return nil } }(), { if let val = dimensions { val.isOwned = false; return val.ptr } else { return nil } }(), {image_type.isOwned = false; return image_type.ptr;}(), { let val = attributes; val.isOwned = false; return val.ptr }()))
    }
}
...
extension StructuredData {
    public convenience init<GenericIntoRustString: IntoRustString>(_ data_type: StructuredDataType, _ raw_json: GenericIntoRustString, _ schema_type: Optional<GenericIntoRustString>) {
        self.init(ptr: __swift_bridge__$StructuredData$new({data_type.isOwned = false; return data_type.ptr;}(), { let rustString = raw_json.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { if let rustString = optionalStringIntoRustString(schema_type) { rustString.isOwned = false; return rustString.ptr } else { return nil } }()))
    }
}
...
extension ErrorMetadata {
    public convenience init<GenericIntoRustString: IntoRustString>(_ error_type: GenericIntoRustString, _ message: GenericIntoRustString) {
        self.init(ptr: __swift_bridge__$ErrorMetadata$new({ let rustString = error_type.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { let rustString = message.intoRustString(); rustString.isOwned = false; return rustString.ptr }()))
    }
}
...
extension YearRange {
    public convenience init(_ min: Optional<UInt32>, _ max: Optional<UInt32>, _ years: RustVec<UInt32>) {
        self.init(ptr: __swift_bridge__$YearRange$new(min.intoFfiRepr(), max.intoFfiRepr(), { let val = years; val.isOwned = false; return val.ptr }()))
    }
}
...
extension DbfFieldInfo {
    public convenience init<GenericIntoRustString: IntoRustString>(_ name: GenericIntoRustString, _ field_type: GenericIntoRustString) {
        self.init(ptr: __swift_bridge__$DbfFieldInfo$new({ let rustString = name.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { let rustString = field_type.intoRustString(); rustString.isOwned = false; return rustString.ptr }()))
    }
}
...
extension ContributorRole {
    public convenience init<GenericIntoRustString: IntoRustString>(_ name: GenericIntoRustString, _ role: Optional<GenericIntoRustString>) {
        self.init(ptr: __swift_bridge__$ContributorRole$new({ let rustString = name.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { if let rustString = optionalStringIntoRustString(role) { rustString.isOwned = false; return rustString.ptr } else { return nil } }()))
    }
}
...
extension PageStructure {
    public convenience init(_ total_count: UInt, _ unit_type: PageUnitType, _ boundaries: Optional<RustVec<PageBoundary>>, _ pages: Optional<RustVec<PageInfo>>) {
        self.init(ptr: __swift_bridge__$PageStructure$new(total_count, {unit_type.isOwned = false; return unit_type.ptr;}(), { if let val = boundaries { val.isOwned = false; return val.ptr } else { return nil } }(), { if let val = pages { val.isOwned = false; return val.ptr } else { return nil } }()))
    }
}
...
extension PageInfo {
    public convenience init<GenericIntoRustString: IntoRustString>(_ number: UInt, _ title: Optional<GenericIntoRustString>, _ dimensions: Optional<RustVec<Double>>, _ image_count: Optional<UInt>, _ table_count: Optional<UInt>, _ hidden: Optional<Bool>, _ is_blank: Optional<Bool>) {
        self.init(ptr: __swift_bridge__$PageInfo$new(number, { if let rustString = optionalStringIntoRustString(title) { rustString.isOwned = false; return rustString.ptr } else { return nil } }(), { if let val = dimensions { val.isOwned = false; return val.ptr } else { return nil } }(), image_count.intoFfiRepr(), table_count.intoFfiRepr(), hidden.intoFfiRepr(), is_blank.intoFfiRepr()))
    }
}
...
extension PageContent {
    public convenience init<GenericIntoRustString: IntoRustString>(_ page_number: UInt, _ content: GenericIntoRustString, _ tables: RustVec<GenericIntoRustString>, _ images: RustVec<ExtractedImage>, _ hierarchy: Optional<PageHierarchy>, _ is_blank: Optional<Bool>, _ layout_regions: Optional<RustVec<LayoutRegion>>) {
        self.init(ptr: __swift_bridge__$PageContent$new(page_number, { let rustString = content.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { let val = tables; val.isOwned = false; return val.ptr }(), { let val = images; val.isOwned = false; return val.ptr }(), { if let val = hierarchy { val.isOwned = false; return val.ptr } else { return nil } }(), is_blank.intoFfiRepr(), { if let val = layout_regions { val.isOwned = false; return val.ptr } else { return nil } }()))
    }
}
...
extension PageHierarchy {
    public convenience init(_ block_count: UInt, _ blocks: RustVec<HierarchicalBlock>) {
        self.init(ptr: __swift_bridge__$PageHierarchy$new(block_count, { let val = blocks; val.isOwned = false; return val.ptr }()))
    }
}
...
extension HierarchicalBlock {
    public convenience init<GenericIntoRustString: IntoRustString>(_ text: GenericIntoRustString, _ font_size: Float, _ level: GenericIntoRustString, _ bbox: Optional<RustVec<Float>>) {
        self.init(ptr: __swift_bridge__$HierarchicalBlock$new({ let rustString = text.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), font_size, { let rustString = level.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { if let val = bbox { val.isOwned = false; return val.ptr } else { return nil } }()))
    }
}
...
extension Uri {
    public convenience init<GenericIntoRustString: IntoRustString>(_ url: GenericIntoRustString, _ label: Optional<GenericIntoRustString>, _ page: Optional<UInt32>, _ kind: UriKind) {
        self.init(ptr: __swift_bridge__$Uri$new({ let rustString = url.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { if let rustString = optionalStringIntoRustString(label) { rustString.isOwned = false; return rustString.ptr } else { return nil } }(), page.intoFfiRepr(), {kind.isOwned = false; return kind.ptr;}()))
    }
}
...
extension HealthResponse {
    public convenience init<GenericIntoRustString: IntoRustString>(_ status: GenericIntoRustString, _ version: GenericIntoRustString, _ plugins: Optional<GenericIntoRustString>) {
        self.init(ptr: __swift_bridge__$HealthResponse$new({ let rustString = status.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { let rustString = version.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { if let rustString = optionalStringIntoRustString(plugins) { rustString.isOwned = false; return rustString.ptr } else { return nil } }()))
    }
}
...
extension HealthResponseRef {
    ...
    public func plugins() -> Optional<RustString> {
        { let val = __swift_bridge__$HealthResponse$plugins(ptr); if val != nil { return RustString(ptr: val!) } else { return nil } }()
    }
}
extension HealthResponse: Vectorizable {
    ...
    public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: HealthResponse) {
        __swift_bridge__$Vec_HealthResponse$push(vecPtr, {value.isOwned = false; return value.ptr;}())
    }
    ...
    public static func vecOfSelfGet(vecPtr: UnsafeMutableRawPointer, index: UInt) -> Optional<HealthResponseRef> {
    ...
    public static func vecOfSelfGetMut(vecPtr: UnsafeMutableRawPointer, index: UInt) -> Optional<HealthResponseRefMut> {
    ...
    public static func vecOfSelfAsPtr(vecPtr: UnsafeMutableRawPointer) -> UnsafePointer<HealthResponseRef> {
        UnsafePointer<HealthResponseRef>(OpaquePointer(__swift_bridge__$Vec_HealthResponse$as_ptr(vecPtr)))
    }
...
extension InfoResponse {
    public convenience init<GenericIntoRustString: IntoRustString>(_ version: GenericIntoRustString, _ rust_backend: Bool) {
        self.init(ptr: __swift_bridge__$InfoResponse$new({ let rustString = version.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), rust_backend))
    }
}
...
extension ApiState {
    public convenience init<GenericIntoRustString: IntoRustString>(_ default_config: ExtractionConfig, _ extraction_service: GenericIntoRustString) {
        self.init(ptr: __swift_bridge__$ApiState$new({default_config.isOwned = false; return default_config.ptr;}(), { let rustString = extraction_service.intoRustString(); rustString.isOwned = false; return rustString.ptr }()))
    }
}
...
extension ApiState: Vectorizable {
    ...
    public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: ApiState) {
        __swift_bridge__$Vec_ApiState$push(vecPtr, {value.isOwned = false; return value.ptr;}())
    }
    ...
    public static func vecOfSelfGet(vecPtr: UnsafeMutableRawPointer, index: UInt) -> Optional<ApiStateRef> {
    ...
    public static func vecOfSelfGetMut(vecPtr: UnsafeMutableRawPointer, index: UInt) -> Optional<ApiStateRefMut> {
...
extension CacheStatsResponse {
    public convenience init<GenericIntoRustString: IntoRustString>(_ directory: GenericIntoRustString, _ total_files: UInt, _ total_size_mb: Double, _ available_space_mb: Double, _ oldest_file_age_days: Double, _ newest_file_age_days: Double) {
        self.init(ptr: __swift_bridge__$CacheStatsResponse$new({ let rustString = directory.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), total_files, total_size_mb, available_space_mb, oldest_file_age_days, newest_file_age_days))
    }
}
...
extension CacheStatsResponse: Vectorizable {
    ...
    public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: CacheStatsResponse) {
        __swift_bridge__$Vec_CacheStatsResponse$push(vecPtr, {value.isOwned = false; return value.ptr;}())
    }
    ...
    public static func vecOfSelfGet(vecPtr: UnsafeMutableRawPointer, index: UInt) -> Optional<CacheStatsResponseRef> {
    ...
    public static func vecOfSelfGetMut(vecPtr: UnsafeMutableRawPointer, index: UInt) -> Optional<CacheStatsResponseRefMut> {
    ...
    public static func vecOfSelfAsPtr(vecPtr: UnsafeMutableRawPointer) -> UnsafePointer<CacheStatsResponseRef> {
        UnsafePointer<CacheStatsResponseRef>(OpaquePointer(__swift_bridge__$Vec_CacheStatsResponse$as_ptr(vecPtr)))
    }
...
extension CacheClearResponse {
    public convenience init<GenericIntoRustString: IntoRustString>(_ directory: GenericIntoRustString, _ removed_files: UInt, _ freed_mb: Double) {
        self.init(ptr: __swift_bridge__$CacheClearResponse$new({ let rustString = directory.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), removed_files, freed_mb))
    }
}
...
extension CacheClearResponse: Vectorizable {
    ...
    public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: CacheClearResponse) {
        __swift_bridge__$Vec_CacheClearResponse$push(vecPtr, {value.isOwned = false; return value.ptr;}())
    }
    ...
    public static func vecOfSelfGet(vecPtr: UnsafeMutableRawPointer, index: UInt) -> Optional<CacheClearResponseRef> {
    ...
    public static func vecOfSelfGetMut(vecPtr: UnsafeMutableRawPointer, index: UInt) -> Optional<CacheClearResponseRefMut> {
    ...
    public static func vecOfSelfAsPtr(vecPtr: UnsafeMutableRawPointer) -> UnsafePointer<CacheClearResponseRef> {
        UnsafePointer<CacheClearResponseRef>(OpaquePointer(__swift_bridge__$Vec_CacheClearResponse$as_ptr(vecPtr)))
    }
...
extension EmbedRequest {
    public convenience init<GenericIntoRustString: IntoRustString>(_ texts: RustVec<GenericIntoRustString>, _ config: Optional<EmbeddingConfig>) {
        self.init(ptr: __swift_bridge__$EmbedRequest$new({ let val = texts; val.isOwned = false; return val.ptr }(), { if let val = config { val.isOwned = false; return val.ptr } else { return nil } }()))
    }
}
...
extension EmbedResponse {
    public convenience init<GenericIntoRustString: IntoRustString>(_ embeddings: GenericIntoRustString, _ model: GenericIntoRustString, _ dimensions: UInt, _ count: UInt) {
        self.init(ptr: __swift_bridge__$EmbedResponse$new({ let rustString = embeddings.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { let rustString = model.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), dimensions, count))
    }
}
...
extension ChunkRequest {
    public convenience init<GenericIntoRustString: IntoRustString>(_ text: GenericIntoRustString, _ config: Optional<GenericIntoRustString>, _ chunker_type: GenericIntoRustString) {
        self.init(ptr: __swift_bridge__$ChunkRequest$new({ let rustString = text.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { if let rustString = optionalStringIntoRustString(config) { rustString.isOwned = false; return rustString.ptr } else { return nil } }(), { let rustString = chunker_type.intoRustString(); rustString.isOwned = false; return rustString.ptr }()))
    }
}
...
extension ChunkResponse {
    public convenience init<GenericIntoRustString: IntoRustString>(_ chunks: RustVec<GenericIntoRustString>, _ chunk_count: UInt, _ config: GenericIntoRustString, _ input_size_bytes: UInt, _ chunker_type: GenericIntoRustString) {
        self.init(ptr: __swift_bridge__$ChunkResponse$new({ let val = chunks; val.isOwned = false; return val.ptr }(), chunk_count, { let rustString = config.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), input_size_bytes, { let rustString = chunker_type.intoRustString(); rustString.isOwned = false; return rustString.ptr }()))
    }
}
...
extension VersionResponse {
    public convenience init<GenericIntoRustString: IntoRustString>(_ version: GenericIntoRustString) {
        self.init(ptr: __swift_bridge__$VersionResponse$new({ let rustString = version.intoRustString(); rustString.isOwned = false; return rustString.ptr }()))
    }
}
...
extension VersionResponse: Vectorizable {
    ...
    public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: VersionResponse) {
        __swift_bridge__$Vec_VersionResponse$push(vecPtr, {value.isOwned = false; return value.ptr;}())
    }
    ...
    public static func vecOfSelfGet(vecPtr: UnsafeMutableRawPointer, index: UInt) -> Optional<VersionResponseRef> {
    ...
    public static func vecOfSelfGetMut(vecPtr: UnsafeMutableRawPointer, index: UInt) -> Optional<VersionResponseRefMut> {
    ...
    public static func vecOfSelfAsPtr(vecPtr: UnsafeMutableRawPointer) -> UnsafePointer<VersionResponseRef> {
        UnsafePointer<VersionResponseRef>(OpaquePointer(__swift_bridge__$Vec_VersionResponse$as_ptr(vecPtr)))
    }
...
extension DetectResponse {
    public convenience init<GenericIntoRustString: IntoRustString>(_ mime_type: GenericIntoRustString, _ filename: Optional<GenericIntoRustString>) {
        self.init(ptr: __swift_bridge__$DetectResponse$new({ let rustString = mime_type.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { if let rustString = optionalStringIntoRustString(filename) { rustString.isOwned = false; return rustString.ptr } else { return nil } }()))
    }
}
...
extension ManifestEntryResponse {
    public convenience init<GenericIntoRustString: IntoRustString>(_ relative_path: GenericIntoRustString, _ sha256: GenericIntoRustString, _ size_bytes: UInt64, _ source_url: GenericIntoRustString) {
        self.init(ptr: __swift_bridge__$ManifestEntryResponse$new({ let rustString = relative_path.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { let rustString = sha256.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), size_bytes, { let rustString = source_url.intoRustString(); rustString.isOwned = false; return rustString.ptr }()))
    }
}
...
extension ManifestResponse {
    public convenience init<GenericIntoRustString: IntoRustString>(_ kreuzberg_version: GenericIntoRustString, _ total_size_bytes: UInt64, _ model_count: UInt, _ models: RustVec<ManifestEntryResponse>) {
        self.init(ptr: __swift_bridge__$ManifestResponse$new({ let rustString = kreuzberg_version.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), total_size_bytes, model_count, { let val = models; val.isOwned = false; return val.ptr }()))
    }
}
...
extension WarmRequest {
    public convenience init<GenericIntoRustString: IntoRustString>(_ all_embeddings: Bool, _ embedding_model: Optional<GenericIntoRustString>) {
        self.init(ptr: __swift_bridge__$WarmRequest$new(all_embeddings, { if let rustString = optionalStringIntoRustString(embedding_model) { rustString.isOwned = false; return rustString.ptr } else { return nil } }()))
    }
}
...
extension WarmRequestRef {
    ...
    public func embedding_model() -> Optional<RustString> {
        { let val = __swift_bridge__$WarmRequest$embedding_model(ptr); if val != nil { return RustString(ptr: val!) } else { return nil } }()
    }
}
extension WarmRequest: Vectorizable {
    ...
    public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: WarmRequest) {
        __swift_bridge__$Vec_WarmRequest$push(vecPtr, {value.isOwned = false; return value.ptr;}())
    }
    ...
    public static func vecOfSelfGet(vecPtr: UnsafeMutableRawPointer, index: UInt) -> Optional<WarmRequestRef> {
    ...
    public static func vecOfSelfGetMut(vecPtr: UnsafeMutableRawPointer, index: UInt) -> Optional<WarmRequestRefMut> {
    ...
    public static func vecOfSelfAsPtr(vecPtr: UnsafeMutableRawPointer) -> UnsafePointer<WarmRequestRef> {
...
extension WarmResponse {
    public convenience init<GenericIntoRustString: IntoRustString>(_ cache_dir: GenericIntoRustString, _ downloaded: RustVec<GenericIntoRustString>, _ already_cached: RustVec<GenericIntoRustString>) {
        self.init(ptr: __swift_bridge__$WarmResponse$new({ let rustString = cache_dir.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { let val = downloaded; val.isOwned = false; return val.ptr }(), { let val = already_cached; val.isOwned = false; return val.ptr }()))
    }
}
...
extension StructuredExtractionResponse {
    public convenience init<GenericIntoRustString: IntoRustString>(_ structured_output: GenericIntoRustString, _ content: GenericIntoRustString, _ mime_type: GenericIntoRustString) {
        self.init(ptr: __swift_bridge__$StructuredExtractionResponse$new({ let rustString = structured_output.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { let rustString = content.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { let rustString = mime_type.intoRustString(); rustString.isOwned = false; return rustString.ptr }()))
    }
}
...
extension OpenWebDocumentResponse {
    public convenience init<GenericIntoRustString: IntoRustString>(_ page_content: GenericIntoRustString, _ metadata: GenericIntoRustString) {
        self.init(ptr: __swift_bridge__$OpenWebDocumentResponse$new({ let rustString = page_content.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { let rustString = metadata.intoRustString(); rustString.isOwned = false; return rustString.ptr }()))
    }
}
...
extension DoclingCompatResponse {
    public convenience init<GenericIntoRustString: IntoRustString>(_ document: GenericIntoRustString, _ status: GenericIntoRustString) {
        self.init(ptr: __swift_bridge__$DoclingCompatResponse$new({ let rustString = document.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { let rustString = status.intoRustString(); rustString.isOwned = false; return rustString.ptr }()))
    }
}
...
extension ExtractFileParams {
    public convenience init<GenericIntoRustString: IntoRustString>(_ path: GenericIntoRustString, _ mime_type: Optional<GenericIntoRustString>, _ config: Optional<GenericIntoRustString>, _ pdf_password: Optional<GenericIntoRustString>, _ response_format: Optional<GenericIntoRustString>) {
        self.init(ptr: __swift_bridge__$ExtractFileParams$new({ let rustString = path.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { if let rustString = optionalStringIntoRustString(mime_type) { rustString.isOwned = false; return rustString.ptr } else { return nil } }(), { if let rustString = optionalStringIntoRustString(config) { rustString.isOwned = false; return rustString.ptr } else { return nil } }(), { if let rustString = optionalStringIntoRustString(pdf_password) { rustString.isOwned = false; return rustString.ptr } else { return nil } }(), { if let rustString = optionalStringIntoRustString(response_format) { rustString.isOwned = false; return rustString.ptr } else { return nil } }()))
    }
}
...
extension ExtractFileParamsRef {
    ...
    public func mime_type() -> Optional<RustString> {
        { let val = __swift_bridge__$ExtractFileParams$mime_type(ptr); if val != nil { return RustString(ptr: val!) } else { return nil } }()
    }

    public func config() -> Optional<RustString> {
        { let val = __swift_bridge__$ExtractFileParams$config(ptr); if val != nil { return RustString(ptr: val!) } else { return nil } }()
    }

    public func pdf_password() -> Optional<RustString> {
        { let val = __swift_bridge__$ExtractFileParams$pdf_password(ptr); if val != nil { return RustString(ptr: val!) } else { return nil } }()
    }

    public func response_format() -> Optional<RustString> {
        { let val = __swift_bridge__$ExtractFileParams$response_format(ptr); if val != nil { return RustString(ptr: val!) } else { return nil } }()
    }
}
extension ExtractFileParams: Vectorizable {
    ...
    public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: ExtractFileParams) {
        __swift_bridge__$Vec_ExtractFileParams$push(vecPtr, {value.isOwned = false; return value.ptr;}())
    }
    ...
    public static func vecOfSelfGet(vecPtr: UnsafeMutableRawPointer, index: UInt) -> Optional<ExtractFileParamsRef> {
    ...
    public static func vecOfSelfGetMut(vecPtr: UnsafeMutableRawPointer, index: UInt) -> Optional<ExtractFileParamsRefMut> {
    ...
    public static func vecOfSelfAsPtr(vecPtr: UnsafeMutableRawPointer) -> UnsafePointer<ExtractFileParamsRef> {
        UnsafePointer<ExtractFileParamsRef>(OpaquePointer(__swift_bridge__$Vec_ExtractFileParams$as_ptr(vecPtr)))
    }
...
extension ExtractBytesParams {
    public convenience init<GenericIntoRustString: IntoRustString>(_ data: GenericIntoRustString, _ mime_type: Optional<GenericIntoRustString>, _ config: Optional<GenericIntoRustString>, _ pdf_password: Optional<GenericIntoRustString>, _ response_format: Optional<GenericIntoRustString>) {
        self.init(ptr: __swift_bridge__$ExtractBytesParams$new({ let rustString = data.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { if let rustString = optionalStringIntoRustString(mime_type) { rustString.isOwned = false; return rustString.ptr } else { return nil } }(), { if let rustString = optionalStringIntoRustString(config) { rustString.isOwned = false; return rustString.ptr } else { return nil } }(), { if let rustString = optionalStringIntoRustString(pdf_password) { rustString.isOwned = false; return rustString.ptr } else { return nil } }(), { if let rustString = optionalStringIntoRustString(response_format) { rustString.isOwned = false; return rustString.ptr } else { return nil } }()))
    }
}
...
extension ExtractBytesParamsRef {
    ...
    public func mime_type() -> Optional<RustString> {
        { let val = __swift_bridge__$ExtractBytesParams$mime_type(ptr); if val != nil { return RustString(ptr: val!) } else { return nil } }()
    }

    public func config() -> Optional<RustString> {
        { let val = __swift_bridge__$ExtractBytesParams$config(ptr); if val != nil { return RustString(ptr: val!) } else { return nil } }()
    }

    public func pdf_password() -> Optional<RustString> {
        { let val = __swift_bridge__$ExtractBytesParams$pdf_password(ptr); if val != nil { return RustString(ptr: val!) } else { return nil } }()
    }

    public func response_format() -> Optional<RustString> {
        { let val = __swift_bridge__$ExtractBytesParams$response_format(ptr); if val != nil { return RustString(ptr: val!) } else { return nil } }()
    }
}
extension ExtractBytesParams: Vectorizable {
    ...
    public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: ExtractBytesParams) {
        __swift_bridge__$Vec_ExtractBytesParams$push(vecPtr, {value.isOwned = false; return value.ptr;}())
    }
    ...
    public static func vecOfSelfGet(vecPtr: UnsafeMutableRawPointer, index: UInt) -> Optional<ExtractBytesParamsRef> {
    ...
    public static func vecOfSelfGetMut(vecPtr: UnsafeMutableRawPointer, index: UInt) -> Optional<ExtractBytesParamsRefMut> {
    ...
    public static func vecOfSelfAsPtr(vecPtr: UnsafeMutableRawPointer) -> UnsafePointer<ExtractBytesParamsRef> {
        UnsafePointer<ExtractBytesParamsRef>(OpaquePointer(__swift_bridge__$Vec_ExtractBytesParams$as_ptr(vecPtr)))
    }
...
extension BatchExtractFilesParams {
    public convenience init<GenericIntoRustString: IntoRustString>(_ paths: RustVec<GenericIntoRustString>, _ config: Optional<GenericIntoRustString>, _ pdf_password: Optional<GenericIntoRustString>, _ file_configs: GenericIntoRustString, _ response_format: Optional<GenericIntoRustString>) {
        self.init(ptr: __swift_bridge__$BatchExtractFilesParams$new({ let val = paths; val.isOwned = false; return val.ptr }(), { if let rustString = optionalStringIntoRustString(config) { rustString.isOwned = false; return rustString.ptr } else { return nil } }(), { if let rustString = optionalStringIntoRustString(pdf_password) { rustString.isOwned = false; return rustString.ptr } else { return nil } }(), { let rustString = file_configs.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { if let rustString = optionalStringIntoRustString(response_format) { rustString.isOwned = false; return rustString.ptr } else { return nil } }()))
    }
}
...
extension BatchExtractFilesParamsRef {
    ...
    public func config() -> Optional<RustString> {
        { let val = __swift_bridge__$BatchExtractFilesParams$config(ptr); if val != nil { return RustString(ptr: val!) } else { return nil } }()
    }

    public func pdf_password() -> Optional<RustString> {
        { let val = __swift_bridge__$BatchExtractFilesParams$pdf_password(ptr); if val != nil { return RustString(ptr: val!) } else { return nil } }()
    }
    ...
    public func response_format() -> Optional<RustString> {
        { let val = __swift_bridge__$BatchExtractFilesParams$response_format(ptr); if val != nil { return RustString(ptr: val!) } else { return nil } }()
    }
}
extension BatchExtractFilesParams: Vectorizable {
    ...
    public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: BatchExtractFilesParams) {
        __swift_bridge__$Vec_BatchExtractFilesParams$push(vecPtr, {value.isOwned = false; return value.ptr;}())
    }
    ...
    public static func vecOfSelfGet(vecPtr: UnsafeMutableRawPointer, index: UInt) -> Optional<BatchExtractFilesParamsRef> {
    ...
    public static func vecOfSelfGetMut(vecPtr: UnsafeMutableRawPointer, index: UInt) -> Optional<BatchExtractFilesParamsRefMut> {
    ...
    public static func vecOfSelfAsPtr(vecPtr: UnsafeMutableRawPointer) -> UnsafePointer<BatchExtractFilesParamsRef> {
        UnsafePointer<BatchExtractFilesParamsRef>(OpaquePointer(__swift_bridge__$Vec_BatchExtractFilesParams$as_ptr(vecPtr)))
    }
...
extension DetectMimeTypeParams {
    public convenience init<GenericIntoRustString: IntoRustString>(_ path: GenericIntoRustString, _ use_content: Bool) {
        self.init(ptr: __swift_bridge__$DetectMimeTypeParams$new({ let rustString = path.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), use_content))
    }
}
...
extension CacheWarmParams {
    public convenience init<GenericIntoRustString: IntoRustString>(_ all_embeddings: Bool, _ embedding_model: Optional<GenericIntoRustString>) {
        self.init(ptr: __swift_bridge__$CacheWarmParams$new(all_embeddings, { if let rustString = optionalStringIntoRustString(embedding_model) { rustString.isOwned = false; return rustString.ptr } else { return nil } }()))
    }
}
...
extension EmbedTextParams {
    public convenience init<GenericIntoRustString: IntoRustString>(_ texts: RustVec<GenericIntoRustString>, _ preset: Optional<GenericIntoRustString>, _ model: Optional<GenericIntoRustString>, _ api_key: Optional<GenericIntoRustString>, _ embedding_plugin: Optional<GenericIntoRustString>) {
        self.init(ptr: __swift_bridge__$EmbedTextParams$new({ let val = texts; val.isOwned = false; return val.ptr }(), { if let rustString = optionalStringIntoRustString(preset) { rustString.isOwned = false; return rustString.ptr } else { return nil } }(), { if let rustString = optionalStringIntoRustString(model) { rustString.isOwned = false; return rustString.ptr } else { return nil } }(), { if let rustString = optionalStringIntoRustString(api_key) { rustString.isOwned = false; return rustString.ptr } else { return nil } }(), { if let rustString = optionalStringIntoRustString(embedding_plugin) { rustString.isOwned = false; return rustString.ptr } else { return nil } }()))
    }
}
...
extension ExtractStructuredParams {
    public convenience init<GenericIntoRustString: IntoRustString>(_ path: GenericIntoRustString, _ schema: GenericIntoRustString, _ model: GenericIntoRustString, _ schema_name: GenericIntoRustString, _ schema_description: Optional<GenericIntoRustString>, _ prompt: Optional<GenericIntoRustString>, _ api_key: Optional<GenericIntoRustString>, _ strict: Bool) {
        self.init(ptr: __swift_bridge__$ExtractStructuredParams$new({ let rustString = path.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { let rustString = schema.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { let rustString = model.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { let rustString = schema_name.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { if let rustString = optionalStringIntoRustString(schema_description) { rustString.isOwned = false; return rustString.ptr } else { return nil } }(), { if let rustString = optionalStringIntoRustString(prompt) { rustString.isOwned = false; return rustString.ptr } else { return nil } }(), { if let rustString = optionalStringIntoRustString(api_key) { rustString.isOwned = false; return rustString.ptr } else { return nil } }(), strict))
    }
}
...
extension ChunkTextParams {
    public convenience init<GenericIntoRustString: IntoRustString>(_ text: GenericIntoRustString, _ max_characters: Optional<UInt>, _ overlap: Optional<UInt>, _ chunker_type: Optional<GenericIntoRustString>, _ topic_threshold: Optional<Float>) {
        self.init(ptr: __swift_bridge__$ChunkTextParams$new({ let rustString = text.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), max_characters.intoFfiRepr(), overlap.intoFfiRepr(), { if let rustString = optionalStringIntoRustString(chunker_type) { rustString.isOwned = false; return rustString.ptr } else { return nil } }(), topic_threshold.intoFfiRepr()))
    }
}
...
extension ChunkingResult {
    public convenience init(_ chunks: RustVec<Chunk>, _ chunk_count: UInt) {
        self.init(ptr: __swift_bridge__$ChunkingResult$new({ let val = chunks; val.isOwned = false; return val.ptr }(), chunk_count))
    }
}
...
extension MergedChunk {
    public convenience init<GenericIntoRustString: IntoRustString>(_ text: GenericIntoRustString, _ byte_start: UInt, _ byte_end: UInt) {
        self.init(ptr: __swift_bridge__$MergedChunk$new({ let rustString = text.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), byte_start, byte_end))
    }
}
...
extension Keyword {
    public convenience init<GenericIntoRustString: IntoRustString>(_ text: GenericIntoRustString, _ score: Float, _ algorithm: KeywordAlgorithm, _ positions: Optional<RustVec<UInt>>) {
        self.init(ptr: __swift_bridge__$Keyword$new({ let rustString = text.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), score, {algorithm.isOwned = false; return algorithm.ptr;}(), { if let val = positions { val.isOwned = false; return val.ptr } else { return nil } }()))
    }
}
...
extension RecognizedTable {
    public convenience init<GenericIntoRustString: IntoRustString>(_ detection_bbox: BBox, _ cells: GenericIntoRustString, _ markdown: GenericIntoRustString) {
        self.init(ptr: __swift_bridge__$RecognizedTable$new({detection_bbox.isOwned = false; return detection_bbox.ptr;}(), { let rustString = cells.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { let rustString = markdown.intoRustString(); rustString.isOwned = false; return rustString.ptr }()))
    }
}
...
extension ModelPaths {
    public convenience init<GenericIntoRustString: IntoRustString>(_ det_model: GenericIntoRustString, _ cls_model: GenericIntoRustString, _ rec_model: GenericIntoRustString, _ dict_file: GenericIntoRustString) {
        self.init(ptr: __swift_bridge__$ModelPaths$new({ let rustString = det_model.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { let rustString = cls_model.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { let rustString = rec_model.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { let rustString = dict_file.intoRustString(); rustString.isOwned = false; return rustString.ptr }()))
    }
}
...
extension LayoutDetection {
    public convenience init(_ class_name: LayoutClass, _ confidence: Float, _ bbox: BBox) {
        self.init(ptr: __swift_bridge__$LayoutDetection$new({class_name.isOwned = false; return class_name.ptr;}(), confidence, {bbox.isOwned = false; return bbox.ptr;}()))
    }
}
...
extension DetectionResult {
    public convenience init(_ page_width: UInt32, _ page_height: UInt32, _ detections: RustVec<LayoutDetection>) {
        self.init(ptr: __swift_bridge__$DetectionResult$new(page_width, page_height, { let val = detections; val.isOwned = false; return val.ptr }()))
    }
}
...
extension EmbeddedFile {
    public convenience init<GenericIntoRustString: IntoRustString>(_ name: GenericIntoRustString, _ data: RustVec<UInt8>, _ mime_type: Optional<GenericIntoRustString>) {
        self.init(ptr: __swift_bridge__$EmbeddedFile$new({ let rustString = name.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { let val = data; val.isOwned = false; return val.ptr }(), { if let rustString = optionalStringIntoRustString(mime_type) { rustString.isOwned = false; return rustString.ptr } else { return nil } }()))
    }
}
...
extension PdfImage {
    public convenience init<GenericIntoRustString: IntoRustString>(_ page_number: UInt, _ image_index: UInt, _ width: Int64, _ height: Int64, _ color_space: Optional<GenericIntoRustString>, _ bits_per_component: Optional<Int64>, _ filters: RustVec<GenericIntoRustString>, _ data: RustVec<UInt8>, _ decoded_format: GenericIntoRustString) {
        self.init(ptr: __swift_bridge__$PdfImage$new(page_number, image_index, width, height, { if let rustString = optionalStringIntoRustString(color_space) { rustString.isOwned = false; return rustString.ptr } else { return nil } }(), bits_per_component.intoFfiRepr(), { let val = filters; val.isOwned = false; return val.ptr }(), { let val = data; val.isOwned = false; return val.ptr }(), { let rustString = decoded_format.intoRustString(); rustString.isOwned = false; return rustString.ptr }()))
    }
}
...
extension PdfImageRef {
    ...
    public func color_space() -> Optional<RustString> {
        { let val = __swift_bridge__$PdfImage$color_space(ptr); if val != nil { return RustString(ptr: val!) } else { return nil } }()
    }

    public func bits_per_component() -> Optional<Int64> {
...
extension PdfImage: Vectorizable {
    ...
    public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: PdfImage) {
        __swift_bridge__$Vec_PdfImage$push(vecPtr, {value.isOwned = false; return value.ptr;}())
    }
    ...
    public static func vecOfSelfGet(vecPtr: UnsafeMutableRawPointer, index: UInt) -> Optional<PdfImageRef> {
    ...
    public static func vecOfSelfGetMut(vecPtr: UnsafeMutableRawPointer, index: UInt) -> Optional<PdfImageRefMut> {
...
extension PageLayoutResult {
    public convenience init<GenericIntoRustString: IntoRustString>(_ page_index: UInt, _ regions: RustVec<GenericIntoRustString>, _ page_width_pts: Float, _ page_height_pts: Float, _ render_width_px: UInt32, _ render_height_px: UInt32) {
        self.init(ptr: __swift_bridge__$PageLayoutResult$new(page_index, { let val = regions; val.isOwned = false; return val.ptr }(), page_width_pts, page_height_pts, render_width_px, render_height_px))
    }
}
...
extension PageLayoutResult: Vectorizable {
    ...
    public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: PageLayoutResult) {
        __swift_bridge__$Vec_PageLayoutResult$push(vecPtr, {value.isOwned = false; return value.ptr;}())
    }
    ...
    public static func vecOfSelfGet(vecPtr: UnsafeMutableRawPointer, index: UInt) -> Optional<PageLayoutResultRef> {
    ...
    public static func vecOfSelfGetMut(vecPtr: UnsafeMutableRawPointer, index: UInt) -> Optional<PageLayoutResultRefMut> {
    ...
    public static func vecOfSelfAsPtr(vecPtr: UnsafeMutableRawPointer) -> UnsafePointer<PageLayoutResultRef> {
        UnsafePointer<PageLayoutResultRef>(OpaquePointer(__swift_bridge__$Vec_PageLayoutResult$as_ptr(vecPtr)))
    }
...
extension PageTiming {
    public convenience init(_ render_ms: Double, _ preprocess_ms: Double, _ onnx_ms: Double, _ inference_ms: Double, _ postprocess_ms: Double, _ mapping_ms: Double) {
        self.init(ptr: __swift_bridge__$PageTiming$new(render_ms, preprocess_ms, onnx_ms, inference_ms, postprocess_ms, mapping_ms))
    }
}
...
extension PageTiming: Vectorizable {
    ...
    public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: PageTiming) {
        __swift_bridge__$Vec_PageTiming$push(vecPtr, {value.isOwned = false; return value.ptr;}())
    }
    ...
    public static func vecOfSelfGet(vecPtr: UnsafeMutableRawPointer, index: UInt) -> Optional<PageTimingRef> {
    ...
    public static func vecOfSelfGetMut(vecPtr: UnsafeMutableRawPointer, index: UInt) -> Optional<PageTimingRefMut> {
...
extension CommonPdfMetadataRef {
    ...
    public func authors() -> Optional<RustVec<RustString>> {
        { let val = __swift_bridge__$CommonPdfMetadata$authors(ptr); if val != nil { return RustVec(ptr: val!) } else { return nil } }()
    }

    public func keywords() -> Optional<RustVec<RustString>> {
        { let val = __swift_bridge__$CommonPdfMetadata$keywords(ptr); if val != nil { return RustVec(ptr: val!) } else { return nil } }()
    }
...
extension PdfUnifiedExtractionResult: Vectorizable {
    ...
    public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: PdfUnifiedExtractionResult) {
        __swift_bridge__$Vec_PdfUnifiedExtractionResult$push(vecPtr, {value.isOwned = false; return value.ptr;}())
    }
    ...
    public static func vecOfSelfGet(vecPtr: UnsafeMutableRawPointer, index: UInt) -> Optional<PdfUnifiedExtractionResultRef> {
    ...
    public static func vecOfSelfGetMut(vecPtr: UnsafeMutableRawPointer, index: UInt) -> Optional<PdfUnifiedExtractionResultRefMut> {
    ...
    public static func vecOfSelfAsPtr(vecPtr: UnsafeMutableRawPointer) -> UnsafePointer<PdfUnifiedExtractionResultRef> {
        UnsafePointer<PdfUnifiedExtractionResultRef>(OpaquePointer(__swift_bridge__$Vec_PdfUnifiedExtractionResult$as_ptr(vecPtr)))
    }
...
extension PdfBackend: Vectorizable {
    ...
    public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: PdfBackend) {
        __swift_bridge__$Vec_PdfBackend$push(vecPtr, {value.isOwned = false; return value.ptr;}())
    }
    ...
    public static func vecOfSelfGet(vecPtr: UnsafeMutableRawPointer, index: UInt) -> Optional<PdfBackendRef> {
    ...
    public static func vecOfSelfGetMut(vecPtr: UnsafeMutableRawPointer, index: UInt) -> Optional<PdfBackendRefMut> {
