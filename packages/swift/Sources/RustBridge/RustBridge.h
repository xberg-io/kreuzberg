...
void* __swift_bridge__$SupportedFormat$new(void* extension, void* mime_type);
void* __swift_bridge__$SupportedFormat$extension(void* self);
...
void* __swift_bridge__$subscript(uint32_t start, uint32_t end);
