...
// alef:hash:d10d765014800962d96f7bf0221bc068dcfba7729ecf1c94bb999aa5c4f818a6
...
public static class KreuzbergLib
{
    ...
    public static string RenderHtmlStr(string html)
    {
        ArgumentNullException.ThrowIfNull(html);
        var nativeResult = NativeMethods.RenderHtmlStr(
            html
        );
        if (nativeResult == IntPtr.Zero)
        {
    ...
    /// </summary>
    /// <param name="html"></param>
    public static string RenderMarkdownStr(string html)
    {
        ArgumentNullException.ThrowIfNull(html);
        var nativeResult = NativeMethods.RenderMarkdownStr(
            html
        );
        if (nativeResult == IntPtr.Zero)
        {
    ...
    /// </summary>
    /// <param name="html"></param>
    public static string RenderDjotStr(string html)
    {
        ArgumentNullException.ThrowIfNull(html);
        var nativeResult = NativeMethods.RenderDjotStr(
            html
        );
        if (nativeResult == IntPtr.Zero)
        {
    ...
    /// </summary>
    /// <param name="html"></param>
    public static string RenderJsonStr(string html)
    {
        ArgumentNullException.ThrowIfNull(html);
        var nativeResult = NativeMethods.RenderJsonStr(
            html
        );
        if (nativeResult == IntPtr.Zero)
        {
    ...
    /// </summary>
    /// <param name="html"></param>
    public static string RenderPlainStr(string html)
    {
        ArgumentNullException.ThrowIfNull(html);
        var nativeResult = NativeMethods.RenderPlainStr(
            html
        );
        if (nativeResult == IntPtr.Zero)
        {
    ...
    public static string DetectImageFormat(byte[] data)
    {
        ArgumentNullException.ThrowIfNull(data);
        var dataHandle = GCHandle.Alloc(data, GCHandleType.Pinned);
        var nativeResult = NativeMethods.DetectImageFormat(
            dataHandle.AddrOfPinnedObject()
        );
        if (nativeResult == IntPtr.Zero)
        {
    ...
    {
        ArgumentNullException.ThrowIfNull(text);
        var nativeResult = NativeMethods.EscapeHtmlEntities(
            text
        );
        if (nativeResult == IntPtr.Zero)
        {
    ...
    {
        ArgumentNullException.ThrowIfNull(text);
        var nativeResult = NativeMethods.FixMojibake(
            text
        );
        if (nativeResult == IntPtr.Zero)
        {
    ...
    {
        ArgumentNullException.ThrowIfNull(html);
        var nativeResult = NativeMethods.ConvertHtmlToMarkdown(
            html
        );
        if (nativeResult == IntPtr.Zero)
        {
    ...
    public static DocExtractionResult ExtractDocText(byte[] content)
    {
        ArgumentNullException.ThrowIfNull(content);
        var contentHandle = GCHandle.Alloc(content, GCHandleType.Pinned);
        var nativeResult = NativeMethods.ExtractDocText(
            contentHandle.AddrOfPinnedObject()
        );
        if (nativeResult == IntPtr.Zero)
        {
        ...
        var jsonPtr = NativeMethods.DocExtractionResultToJson(nativeResult);
        var json = Marshal.PtrToStringUTF8(jsonPtr);
        NativeMethods.FreeString(jsonPtr);
        NativeMethods.DocExtractionResultFree(nativeResult);
    ...
    /// </summary>
    /// <param name="data"></param>
    public static PptxExtractionResult ExtractPptxFromBytes(byte[] data)
    {
        ArgumentNullException.ThrowIfNull(data);
        var dataHandle = GCHandle.Alloc(data, GCHandleType.Pinned);
        var nativeResult = NativeMethods.ExtractPptxFromBytes(
            dataHandle.AddrOfPinnedObject()
        );
        if (nativeResult == IntPtr.Zero)
        {
        ...
        var jsonPtr = NativeMethods.PptxExtractionResultToJson(nativeResult);
        var json = Marshal.PtrToStringUTF8(jsonPtr);
        NativeMethods.FreeString(jsonPtr);
        NativeMethods.PptxExtractionResultFree(nativeResult);
    ...
    /// <param name="path"></param>
    /// <param name="config"></param>
    public static string ExtractFileToToon(string path, ExtractionConfig config)
    {
        ArgumentNullException.ThrowIfNull(config);
        var configJson = JsonSerializer.Serialize(config, JsonOptions);
        var configHandle = NativeMethods.ExtractionConfigFromJson(configJson);
        var nativeResult = NativeMethods.ExtractFileToToon(
            path,
            configHandle
        );
        if (nativeResult == IntPtr.Zero)
    ...
    /// <param name="path"></param>
    /// <param name="config"></param>
    public static string ExtractFileToJson(string path, ExtractionConfig config)
    {
        ArgumentNullException.ThrowIfNull(config);
        var configJson = JsonSerializer.Serialize(config, JsonOptions);
        var configHandle = NativeMethods.ExtractionConfigFromJson(configJson);
        var nativeResult = NativeMethods.ExtractFileToJson(
            path,
            configHandle
        );
        if (nativeResult == IntPtr.Zero)
    ...
    public static TesseractConfig OcrTesseractConfigDefault()
    {
        var nativeResult = NativeMethods.OcrTesseractConfigDefault();
        var jsonPtr = NativeMethods.TesseractConfigToJson(nativeResult);
        var json = Marshal.PtrToStringUTF8(jsonPtr);
        NativeMethods.FreeString(jsonPtr);
        NativeMethods.TesseractConfigFree(nativeResult);
    ...
    public static TesseractConfig OcrTesseractConfigFrom(TesseractConfig config)
    {
        ArgumentNullException.ThrowIfNull(config);
        var configJson = JsonSerializer.Serialize(config, JsonOptions);
        var configHandle = NativeMethods.TesseractConfigFromJson(configJson);
        var nativeResult = NativeMethods.OcrTesseractConfigFrom(
            configHandle
        );
        var jsonPtr = NativeMethods.TesseractConfigToJson(nativeResult);
        var json = Marshal.PtrToStringUTF8(jsonPtr);
        ...
        NativeMethods.TesseractConfigFree(nativeResult);
        var returnValue = JsonSerializer.Deserialize<TesseractConfig>(json ?? "null", JsonOptions)!;
        NativeMethods.TesseractConfigFree(configHandle);
        return returnValue;
    }
