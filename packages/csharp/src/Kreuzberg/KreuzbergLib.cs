...
// alef:hash:77bdd1cf37be545c9c76b8ae91e56e5816de977941de88c72b3e46c01b7f3b8f
...
public static class KreuzbergLib
{
    ...
    /// <param name="mimeType"></param>
    /// <param name="config"></param>
    public static ExtractionResult ExtractFileSyncFfi(string path, string mimeType, ExtractionConfig config)
    {
        ArgumentNullException.ThrowIfNull(path);
        ArgumentNullException.ThrowIfNull(mimeType);
        ArgumentNullException.ThrowIfNull(config);
        var configJson = JsonSerializer.Serialize(config, JsonOptions);
        var configHandle = NativeMethods.ExtractionConfigFromJson(configJson);
        var result = NativeMethods.ExtractFileSyncFfi(
            path,
            mimeType,
            configHandle
        );
    ...
    /// <param name="mimeType"></param>
    /// <param name="config"></param>
    public static async Task<ExtractionResult> ExtractFileFfi(string path, string mimeType, ExtractionConfig config)
    {
        ArgumentNullException.ThrowIfNull(path);
        ArgumentNullException.ThrowIfNull(mimeType);
        ArgumentNullException.ThrowIfNull(config);
        ...
        return await Task.Run(() =>
        {
            var result = NativeMethods.ExtractFileFfi(
                path,
                mimeType,
                configHandle
            );
