...
public sealed class _OcrBackendBridgeAdapter : IOcrBackend
{
    ...
    {
        return _impl.BackendType();
    }

    /// <summary></summary>
    public List<string> SupportedLanguages()
    {
        return _impl.SupportedLanguages();
    }

    /// <summary></summary>
    public bool SupportsTableDetection()
    {
        return _impl.SupportsTableDetection();
    }

    /// <summary></summary>
    public bool SupportsDocumentProcessing()
    {
        return _impl.SupportsDocumentProcessing();
    }
...
public sealed class _DocumentExtractorBridgeAdapter : IDocumentExtractor
{
    ...
    {
        return _impl.SupportedMimeTypes();
    }
