...
// alef:hash:d0cc89be50ee066955909040c9e6380e05a851e1cb2e82cb24187690054444a2
...
internal static partial class NativeMethods
{
    ...
    [DllImport(LibName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "kreuzberg_extract_file_sync_ffi")]
    internal static extern IntPtr ExtractFileSyncFfi(
        [MarshalAs(UnmanagedType.LPStr)] string path,
        [MarshalAs(UnmanagedType.LPStr)] string mimeType,
        IntPtr config
    );

    [DllImport(LibName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "kreuzberg_extract_file_ffi")]
    internal static extern IntPtr ExtractFileFfi(
        [MarshalAs(UnmanagedType.LPStr)] string path,
        [MarshalAs(UnmanagedType.LPStr)] string mimeType,
        IntPtr config
    );
