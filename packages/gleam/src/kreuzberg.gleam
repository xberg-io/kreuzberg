...
pub type DocExtractionResult {
  DocExtractionResult(content: String, metadata: DocMetadata)
}
...
@external(erlang, "Elixir.Kreuzberg.Native", "render_html_str")
pub fn render_html_str(html: String) -> Result(String, KreuzbergError)
...
///
/// Returns an error if the HTML cannot be parsed.
@external(erlang, "Elixir.Kreuzberg.Native", "render_markdown_str")
pub fn render_markdown_str(html: String) -> Result(String, KreuzbergError)
...
///
/// Returns an error if the HTML cannot be parsed.
@external(erlang, "Elixir.Kreuzberg.Native", "render_djot_str")
pub fn render_djot_str(html: String) -> Result(String, KreuzbergError)
...
///
/// Returns an error if the HTML cannot be parsed.
@external(erlang, "Elixir.Kreuzberg.Native", "render_json_str")
pub fn render_json_str(html: String) -> Result(String, KreuzbergError)
...
///
/// Returns an error if the HTML cannot be parsed.
@external(erlang, "Elixir.Kreuzberg.Native", "render_plain_str")
pub fn render_plain_str(html: String) -> Result(String, KreuzbergError)
...
@external(erlang, "Elixir.Kreuzberg.Native", "detect_image_format")
pub fn detect_image_format(data: BitArray) -> String
...
@external(erlang, "Elixir.Kreuzberg.Native", "generate_cache_key")
pub fn generate_cache_key(parts: List(List(String))) -> String

/// Escape HTML special characters in a string.
///
/// Converts `&`, `<`, `>`, `"`, and `'` to their HTML entity equivalents.
@external(erlang, "Elixir.Kreuzberg.Native", "escape_html_entities")
...
@external(erlang, "Elixir.Kreuzberg.Native", "fix_mojibake")
pub fn fix_mojibake(text: String) -> String

/// Convert HTML to Markdown.
///
/// Converts an HTML string to Markdown using default conversion options.
@external(erlang, "Elixir.Kreuzberg.Native", "convert_html_to_markdown")
pub fn convert_html_to_markdown(html: String) -> Result(String, KreuzbergError)

/// Extract text from a DOC (Word 97-2003) file.
///
/// Takes the raw bytes of a `.doc` file and returns the extracted text and metadata.
@external(erlang, "Elixir.Kreuzberg.Native", "extract_doc_text")
pub fn extract_doc_text(
  content: BitArray,
) -> Result(DocExtractionResult, KreuzbergError)
...
@external(erlang, "Elixir.Kreuzberg.Native", "extract_pptx_from_bytes")
pub fn extract_pptx_from_bytes(
  data: BitArray,
) -> Result(PptxExtractionResult, KreuzbergError)
...
@external(erlang, "Elixir.Kreuzberg.Native", "extract_file_to_toon")
pub fn extract_file_to_toon(
  path: String,
  config: ExtractionConfig,
) -> Result(String, KreuzbergError)

/// Convenience: extract a file and serialize the result to pretty-printed JSON.
@external(erlang, "Elixir.Kreuzberg.Native", "extract_file_to_json")
pub fn extract_file_to_json(
  path: String,
  config: ExtractionConfig,
) -> Result(String, KreuzbergError)
