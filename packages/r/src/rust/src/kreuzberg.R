...
# alef:hash:df549a33c0fa5761dabb1b4b8e8509cb30a1f291500e4ab1852b4740c600ddf0
...
#' @export
unregister_embedding_backend <- function(name) {
  .Call("kreuzberg_unregister_embedding_backend", name)
}

#' List the names of all registered embedding backends.
#' @export
list_embedding_backends <- function() {
  .Call("kreuzberg_list_embedding_backends")
}

#' Shutdown and remove every registered embedding backend.
#' @export
clear_embedding_backends <- function() {
  .Call("kreuzberg_clear_embedding_backends")
}
...
#' ```
#' @export
pdf_page_count <- function(pdf_bytes, password = NULL) {
  .Call("kreuzberg_pdf_page_count", pdf_bytes, password)
}
