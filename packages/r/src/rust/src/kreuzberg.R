...
# alef:hash:026340799f62a4a79e8dbf783e5b78674050dffd4bd336ddc7d941f82c5a48d6
...
#' @export
extract_file_sync_ffi <- function(path, mime_type, config) {
  .Call("kreuzberg_extract_file_sync_ffi", path, mime_type, config)
}

#' FFI-friendly variant of `extract_file` (async) with concrete, non-generic parameter types.
#' @export
extract_file_ffi <- function(path, mime_type, config) {
  .Call("kreuzberg_extract_file_ffi", path, mime_type, config)
}
