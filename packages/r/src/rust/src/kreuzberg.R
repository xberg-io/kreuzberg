...
# alef:hash:b2279153d289332e6c2e8e08a884959b5634675f47506977dba5f650f69f2e13
...
#' ```
#' @export
render_html_str <- function(html) {
  .Call("kreuzberg_render_html_str", html)
}
...
#' ```
#' @export
render_markdown_str <- function(html) {
  .Call("kreuzberg_render_markdown_str", html)
}
...
#' ```
#' @export
render_djot_str <- function(html) {
  .Call("kreuzberg_render_djot_str", html)
}
...
#' ```
#' @export
render_json_str <- function(html) {
  .Call("kreuzberg_render_json_str", html)
}
...
#' ```
#' @export
render_plain_str <- function(html) {
  .Call("kreuzberg_render_plain_str", html)
}
...
#' @export
convert_html_to_markdown <- function(html) {
  .Call("kreuzberg_convert_html_to_markdown", html)
}
...
#' @export
extract_pptx_from_bytes <- function(data) {
  .Call("kreuzberg_extract_pptx_from_bytes", data)
}
...
#' @export
extract_file_to_toon <- function(path, config) {
  .Call("kreuzberg_extract_file_to_toon", path, config)
}

#' Convenience: extract a file and serialize the result to pretty-printed JSON.
#' @export
extract_file_to_json <- function(path, config) {
  .Call("kreuzberg_extract_file_to_json", path, config)
}
