...
impl ConfidenceWeights {
    ...
    pub fn from_json(json: String) -> extendr_api::Result<ConfidenceWeights> {
        let core: kreuzberg::heuristics::ConfidenceWeights =
            serde_json::from_str(&json).map_err(|e| extendr_api::Error::Other(e.to_string()))?;
        Ok(core.into())
    }
}
...
impl HeuristicsConfig {
    ...
    pub fn from_json(json: String) -> extendr_api::Result<HeuristicsConfig> {
        let core: kreuzberg::heuristics::HeuristicsConfig =
            serde_json::from_str(&json).map_err(|e| extendr_api::Error::Other(e.to_string()))?;
        Ok(core.into())
    }
}
...
impl StructuredThresholds {
    ...
    pub fn from_json(json: String) -> extendr_api::Result<StructuredThresholds> {
        let core: kreuzberg::heuristics::StructuredThresholds =
            serde_json::from_str(&json).map_err(|e| extendr_api::Error::Other(e.to_string()))?;
        Ok(core.into())
    }
}
...
pub fn analyze_document(
    ...
    match (|| -> Result<String> {
        ...
        let result = kreuzberg::heuristics::analyze_document(&metadata_core, &config_core, document_bytes.as_deref())
            .map_err(|e| {
            extendr_api::Error::Other(
                e.to_string()
                    .replace(":", "_")
...
pub fn analyze_with_user_chunks(
    ...
    match (|| -> Result<String> {
        ...
        let config_core: kreuzberg::HeuristicsConfig = config.clone().into();
        let result = kreuzberg::heuristics::analyze_with_user_chunks(
            user_ranges_core,
            total_pages as u32,
            size_bytes as u64,
            &config_core,
...
pub fn choose_call_mode(input: &StructuredInput, t: &StructuredThresholds) -> String {
    ...
    let result = kreuzberg::heuristics::choose_call_mode(&input_core, &t_core);
...
pub fn calculate_chunk_plan(page_count: i32, size_bytes: f64, needs_ocr: bool, config: &HeuristicsConfig) -> String {
    let config_core: kreuzberg::HeuristicsConfig = config.clone().into();
    let result =
        kreuzberg::heuristics::calculate_chunk_plan(page_count as u32, size_bytes as u64, needs_ocr, &config_core);
...
pub fn calculate_plan_from_overrides(
    ...
    match (|| -> Result<String> {
        ...
        let config_core: kreuzberg::HeuristicsConfig = config.clone().into();
        let result = kreuzberg::heuristics::calculate_plan_from_overrides(
            user_chunks_core,
            total_pages as u32,
            size_bytes as u64,
            &config_core,
