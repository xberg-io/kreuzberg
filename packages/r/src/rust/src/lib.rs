...
// alef:hash:d4e85e0eef65e591bbf0bef1fe5bc428ff599c05e7d44212b6e519df5efa16b3
...
impl ArchiveArchiveMetadata {
    ...
    pub fn new(format: String, file_list: Vec<ArchiveEntry>, file_count: f64, total_size: f64) -> Self {
        Self { format, file_list, file_count, total_size }
    }
}
...
impl ArchiveArchiveEntry {
    ...
    pub fn new(path: String, size: f64, is_dir: bool) -> Self {
...
pub fn new_extractionresult(
    ...
    extracted_keywords: Vec<Keyword> = c(),
...
pub fn new_metadata(
    ...
    additional: HashMap<String, String> = null
) -> Metadata {
    Metadata {
        title,
        subject,
...
impl OcrTesseractConfig {
    ...
    pub fn new(
        ...
        Self { language: language.unwrap_or_else(|| "eng".to_string()), psm: psm.unwrap_or(3), output_format: output_format.unwrap_or_else(|| "markdown".to_string()), oem: oem.unwrap_or(3), min_confidence: min_confidence.unwrap_or(0.0), preprocessing: preprocessing, enable_table_detection: enable_table_detection.unwrap_or(true), table_min_confidence: table_min_confidence.unwrap_or(0.0), table_column_threshold: table_column_threshold.unwrap_or(50), table_row_threshold_ratio: table_row_threshold_ratio.unwrap_or(0.5), use_cache: use_cache.unwrap_or(true), classify_use_pre_adapted_templates: classify_use_pre_adapted_templates.unwrap_or(true), language_model_ngram_on: language_model_ngram_on.unwrap_or(false), tessedit_dont_blkrej_good_wds: tessedit_dont_blkrej_good_wds.unwrap_or(true), tessedit_dont_rowrej_good_wds: tessedit_dont_rowrej_good_wds.unwrap_or(true), tessedit_enable_dict_correction: tessedit_enable_dict_correction.unwrap_or(true), tessedit_char_whitelist: tessedit_char_whitelist.unwrap_or_else(|| "".to_string()), tessedit_char_blacklist: tessedit_char_blacklist.unwrap_or_else(|| "".to_string()), tessedit_use_primary_params_model: tessedit_use_primary_params_model.unwrap_or(true), textord_space_size_is_variable: textord_space_size_is_variable.unwrap_or(true), thresholding_method: thresholding_method.unwrap_or(false), auto_rotate: auto_rotate.unwrap_or(false) }
    }

    #[allow(clippy::should_implement_trait)]
    pub fn default() -> TesseractConfig {
        kreuzberg::ocr::TesseractConfig::default().into()
    }

    #[allow(clippy::should_implement_trait)]
    pub fn from(config: TesseractConfig) -> TesseractConfig {
        let config_core: kreuzberg::TesseractConfig = config.into();
    let _ = config;
        Default::default()
    }
}
...
#[allow(clippy::missing_errors_doc)]
#[extendr]
pub fn render_html_str(html: String) -> Result<String> {
    kreuzberg::render_html_str(&html).map_err(|e| e.to_string())
}

#[allow(clippy::missing_errors_doc)]
#[extendr]
pub fn render_markdown_str(html: String) -> Result<String> {
    kreuzberg::render_markdown_str(&html).map_err(|e| e.to_string())
}

#[allow(clippy::missing_errors_doc)]
#[extendr]
pub fn render_djot_str(html: String) -> Result<String> {
    kreuzberg::render_djot_str(&html).map_err(|e| e.to_string())
}

#[allow(clippy::missing_errors_doc)]
#[extendr]
pub fn render_json_str(html: String) -> Result<String> {
    kreuzberg::render_json_str(&html).map_err(|e| e.to_string())
}

#[allow(clippy::missing_errors_doc)]
#[extendr]
pub fn render_plain_str(html: String) -> Result<String> {
    kreuzberg::render_plain_str(&html).map_err(|e| e.to_string())
}
...
pub fn chunk_text(text: String, config: ChunkingConfig, page_boundaries: Option<Vec<PageBoundary>>) -> Result<ChunkingResult> {
    ...
    kreuzberg::chunk_text(&text, &config_core, page_boundaries_core.as_deref()).map(ChunkingResult::from).map_err(|e| e.to_string())
}
...
pub fn chunk_semantic(text: String, config: ChunkingConfig, page_boundaries: Option<Vec<PageBoundary>>) -> Result<ChunkingResult> {
    ...
    kreuzberg::chunk_semantic(&text, &config_core, page_boundaries_core.as_deref()).map(ChunkingResult::from).map_err(|e| e.to_string())
}
...
pub fn detect_languages(text: String, config: LanguageDetectionConfig) -> Result<Option<Vec<String>>> {
    ...
    kreuzberg::detect_languages(&text, &config_core).map_err(|e| e.to_string())
}
...
#[allow(clippy::missing_errors_doc)]
#[extendr]
pub fn convert_html_to_markdown(html: String) -> Result<String> {
    kreuzberg::convert_html_to_markdown(&html).map_err(|e| e.to_string())
}

#[allow(clippy::missing_errors_doc)]
#[extendr]
pub fn extract_doc_text(content: Vec<u8>) -> Result<DocExtractionResult> {
    kreuzberg::extract_doc_text(&content).map(Into::into).map_err(|e| e.to_string())
}

#[allow(clippy::missing_errors_doc)]
#[extendr]
pub fn extract_pptx_from_bytes(data: Vec<u8>) -> Result<PptxExtractionResult> {
    kreuzberg::extract_pptx_from_bytes(&data).map(Into::into).map_err(|e| e.to_string())
}
...
#[allow(clippy::missing_errors_doc)]
#[extendr]
pub fn extract_file_to_toon(path: String, config: ExtractionConfig) -> Result<String> {
    let config_json = serde_json::to_string(&config).map_err(|e| e.to_string())?;
    let config_core: kreuzberg::ExtractionConfig = serde_json::from_str(&config_json).map_err(|e| e.to_string())?;
    kreuzberg::extract_file_to_toon(std::path::PathBuf::from(path), &config_core).map_err(|e| e.to_string())
}

#[allow(clippy::missing_errors_doc)]
#[extendr]
pub fn extract_file_to_json(path: String, config: ExtractionConfig) -> Result<String> {
    let config_json = serde_json::to_string(&config).map_err(|e| e.to_string())?;
    let config_core: kreuzberg::ExtractionConfig = serde_json::from_str(&config_json).map_err(|e| e.to_string())?;
    kreuzberg::extract_file_to_json(std::path::PathBuf::from(path), &config_core).map_err(|e| e.to_string())
}
...
extendr_module! {
    ...
    fn extract_file_to_toon;
    fn extract_file_to_json;
}
