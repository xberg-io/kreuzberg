...
// alef:hash:b5b676d4a8e554d31d51705fa1e79a3e03a27c864423bcbc317f25d0b337fc77
...
pub fn extract_file(
    ...
    config: Nullable<&ExtractionConfig>,
) -> Result<ExtractionResult> {
    let config_core: kreuzberg::ExtractionConfig = config.into_option().expect("'config' is required").clone().into();
    let rt = tokio::runtime::Runtime::new()?;
    rt.block_on(async {
