...
// alef:hash:ae454e75d3f03ade95cafa1d3bbb8e0664b0dc3a03df94b8543b7017140f32cc
...
public record PaddleOcrConfig(String language, @JsonProperty("cache_dir") java.nio.file.@Nullable Path cacheDir,
        @JsonProperty("use_angle_cls") boolean useAngleCls, @JsonProperty("enable_table_detection") boolean enableTableDetection,
        @JsonProperty("det_db_thresh") float detDbThresh, @JsonProperty("det_db_box_thresh") float detDbBoxThresh,
        @JsonProperty("det_db_unclip_ratio") float detDbUnclipRatio, @JsonProperty("det_limit_side_len") int detLimitSideLen,
        @JsonProperty("rec_batch_num") int recBatchNum, int padding, @JsonProperty("drop_score") float dropScore,
