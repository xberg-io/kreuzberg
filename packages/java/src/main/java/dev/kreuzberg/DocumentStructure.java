...
// alef:hash:b2a248fa9e547b2dc0c78a1d653c54b12b1331fea24349dcd2f00296fb840f19
...
public record DocumentStructure(
    ...
    @JsonInclude(JsonInclude.Include.NON_NULL) @JsonProperty("nodeTypes") List<String> nodeTypes
) {
