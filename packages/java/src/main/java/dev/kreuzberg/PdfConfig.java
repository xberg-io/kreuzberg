...
// alef:hash:1d340e847faff0227c0580bacf7d1136ddfec130fb2c1613af98eefd3c87b3de
...
public record PdfConfig(@JsonProperty("extract_images") boolean extractImages, @JsonProperty("extract_tables") boolean extractTables,
        @Nullable List<String> passwords, @JsonProperty("extract_metadata") boolean extractMetadata, @Nullable HierarchyConfig hierarchy,
