...
// alef:hash:b89baab4a72f8b7959236f5d7850ed945823daa37665c620a27ec9e1196934e2
...
public record TesseractConfig(String language, int psm, @JsonProperty("output_format") String outputFormat, int oem,
        ...
        @JsonProperty("table_min_confidence") double tableMinConfidence, @JsonProperty("table_column_threshold") int tableColumnThreshold,
        @JsonProperty("table_row_threshold_ratio") double tableRowThresholdRatio, @JsonProperty("use_cache") boolean useCache,
