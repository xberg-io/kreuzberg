...
// alef:hash:a302725a17b88f0d0f283415941d314835c9ee0245f72f68978bae3fc24ee7fd
...
public record OcrElement(String text, OcrBoundingGeometry geometry, OcrConfidence confidence, OcrElementLevel level,
        @Nullable OcrRotation rotation, @JsonProperty("page_number") long pageNumber, @Nullable @JsonProperty("parent_id") String parentId,
