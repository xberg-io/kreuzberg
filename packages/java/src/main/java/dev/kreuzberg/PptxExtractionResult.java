...
// alef:hash:d0df6e1cde44db735486154cb38b9fb6963df41a897faa8eabc6cf2a36336948
...
public record PptxExtractionResult(String content, PptxMetadata metadata, @JsonProperty("slide_count") long slideCount,
        @JsonProperty("image_count") long imageCount, @JsonProperty("table_count") long tableCount, List<ExtractedImage> images,
        ...
        List<String> hyperlinks, @JsonProperty("office_metadata") Map<String, String> officeMetadata) {
