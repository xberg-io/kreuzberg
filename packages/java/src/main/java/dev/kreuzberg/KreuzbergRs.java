...
// alef:hash:7651d73fe2bbb3de510e7cefb69e93c850388ab9fe134393d5c17acc1f7fa8e9
...
public final class KreuzbergRs {
    ...
    public static byte[] renderPdfPageToPng(final byte[] pdfBytes, final long pageIndex, final Integer dpi, final String password)
        ...
        try (var arena = Arena.ofShared()) {
            ...
            int rc = (int) NativeLib.KREUZBERG_RENDER_PDF_PAGE_TO_PNG.invoke(cpdfBytes, cpdfBytesLen, pageIndex, cdpi, cpassword,
