...
// alef:hash:8e43e957409f68f34f93e750f7705b14e3a2545041a910cf950096a317d54eb0
...
public final class KreuzbergRs {
    ...
    private static final com.fasterxml.jackson.databind.ObjectMapper MAPPER = createObjectMapper();    private static <T> java.util.List<T> readJsonList(MemorySegment resultPtr, com.fasterxml.jackson.core.type.TypeReference<java.util.List<T>> typeRef) throws KreuzbergRsException {
        if (resultPtr.equals(MemorySegment.NULL)) {
