...
// alef:hash:ee41bba5261f056c9bb9ac66a8d54f8c843647695e297844a676df6517c6885f
...
public record SecurityLimits(@JsonProperty("max_archive_size") long maxArchiveSize,
        @JsonProperty("max_compression_ratio") long maxCompressionRatio, @JsonProperty("max_files_in_archive") long maxFilesInArchive,
        @JsonProperty("max_nesting_depth") long maxNestingDepth, @JsonProperty("max_entity_length") long maxEntityLength,
        @JsonProperty("max_content_size") long maxContentSize, @JsonProperty("max_iterations") long maxIterations,
        @JsonProperty("max_xml_depth") long maxXmlDepth, @JsonProperty("max_table_cells") long maxTableCells) {
