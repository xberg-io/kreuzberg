...
// alef:hash:a05540fac82f2a874aea91861252a6a4e7d31aacdf000bd80225bc0edfe7c6f8
...
public record ExtractionResult(String content, @JsonProperty("mime_type") String mimeType, Metadata metadata,
        @Nullable @JsonProperty("extraction_method") ExtractionMethod extractionMethod, List<Table> tables,
        ...
        @JsonProperty("processing_warnings") List<ProcessingWarning> processingWarnings, @Nullable List<PdfAnnotation> annotations,
        @Nullable List<ArchiveEntry> children, @Nullable List<Uri> uris,
        @Nullable @JsonProperty("structured_output") Object structuredOutput,
        @Nullable @JsonProperty("code_intelligence") String codeIntelligence, @Nullable @JsonProperty("llm_usage") List<LlmUsage> llmUsage,
