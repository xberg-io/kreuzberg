...
// alef:hash:ec5815f67def9b84cccb7aa39f783e78d1df6602b4d63013b901cc18076b5857
...
public final class Kreuzberg {
    ...
    public static ExtractionResult extractFileSyncFfi(final String path, final String mimeType, final ExtractionConfig config) throws KreuzbergRsException {
        ...
        java.util.Objects.requireNonNull(mimeType, "mimeType must not be null");
        java.util.Objects.requireNonNull(config, "config must not be null");
        return KreuzbergRs.extractFileSyncFfi(path, mimeType, config);
    }
    ...
    public static ExtractionResult extractFileFfi(final String path, final String mimeType, final ExtractionConfig config) throws KreuzbergRsException {
        ...
        java.util.Objects.requireNonNull(mimeType, "mimeType must not be null");
        java.util.Objects.requireNonNull(config, "config must not be null");
        return KreuzbergRs.extractFileFfi(path, mimeType, config);
    }
