...
go get github.com/xberg-io/kreuzberg/v5@v5.0.0-rc.36
```
...
curl -LO https://github.com/xberg-io/kreuzberg/releases/download/v5.0.0-rc.36/go-ffi-linux-x86_64.tar.gz
