...
class KreuzbergBridge {
  ...
  static Future<double> calculateQualityScore(String text, {Map<String, String>? metadata}) async {
    return await rust_bridge.calculateQualityScore(text: text, metadata: metadata);
  }
