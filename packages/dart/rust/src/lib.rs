...
pub struct MetaSchema {
    pub(crate) inner: kreuzberg::presets::loader::MetaSchema,
}

impl From<kreuzberg::presets::loader::MetaSchema> for MetaSchema {
    fn from(inner: kreuzberg::presets::loader::MetaSchema) -> Self {
        Self { inner }
    }
}

impl From<MetaSchema> for kreuzberg::presets::loader::MetaSchema {
...
impl Registry {
    ...
    pub fn global() -> Registry {
        (|v| Registry::from(v))(kreuzberg::Registry::global())
    }
    #[frb]
    pub fn get(&self, id: String) -> Option<Preset> {
        (|v: Option<_>| v.map(Preset::from))(self.inner.get(&id))
    }
    #[frb]
    pub fn summaries(&self) -> Vec<PresetSummary> {
        (|v| v.into_iter().map(PresetSummary::from).collect())(self.inner.summaries())
    }
    #[frb]
    pub fn len(&self) -> i64 {
        (|v| v as i64)(self.inner.len())
    }
    #[frb]
    ...
    pub fn sample_bytes(&self, preset_id: String, name: String) -> Option<Vec<u8>> {
        self.inner.sample_bytes(&preset_id, &name)
    }
    #[frb]
...
impl From<kreuzberg::heuristics::DocumentMetadata> for DocumentMetadata {
    fn from(v: kreuzberg::heuristics::DocumentMetadata) -> Self {
        DocumentMetadata {
            mime_type: v.mime_type.into(),
...
impl From<kreuzberg::heuristics::UserChunkConfig> for UserChunkConfig {
    fn from(v: kreuzberg::heuristics::UserChunkConfig) -> Self {
        UserChunkConfig {
            page_ranges: v
                .page_ranges
...
impl From<kreuzberg::heuristics::ConfidenceSignals> for ConfidenceSignals {
    fn from(v: kreuzberg::heuristics::ConfidenceSignals) -> Self {
        ConfidenceSignals {
...
impl From<kreuzberg::heuristics::ConfidenceWeights> for ConfidenceWeights {
    fn from(v: kreuzberg::heuristics::ConfidenceWeights) -> Self {
        ConfidenceWeights {
            text_coverage: v.text_coverage as _,
...
impl From<kreuzberg::heuristics::HeuristicsConfig> for HeuristicsConfig {
    fn from(v: kreuzberg::heuristics::HeuristicsConfig) -> Self {
        HeuristicsConfig {
...
impl From<kreuzberg::heuristics::ChunkPlan> for ChunkPlan {
    fn from(v: kreuzberg::heuristics::ChunkPlan) -> Self {
        ChunkPlan {
            total_chunks: v.total_chunks as _,
...
impl From<kreuzberg::heuristics::ChunkInfo> for ChunkInfo {
    fn from(v: kreuzberg::heuristics::ChunkInfo) -> Self {
        ChunkInfo {
            index: v.index as _,
...
impl From<kreuzberg::heuristics::PageRange> for PageRange {
    fn from(v: kreuzberg::heuristics::PageRange) -> Self {
        PageRange {
            start: v.start as _,
            end: v.end as _,
        }
...
impl From<kreuzberg::heuristics::StructuredInput> for StructuredInput {
    fn from(v: kreuzberg::heuristics::StructuredInput) -> Self {
        StructuredInput {
            mime_type: v.mime_type.into(),
            page_count: v.page_count as _,
            text_coverage: v.text_coverage as _,
...
impl From<kreuzberg::heuristics::StructuredThresholds> for StructuredThresholds {
    fn from(v: kreuzberg::heuristics::StructuredThresholds) -> Self {
...
impl From<kreuzberg::heuristics::ChunkingDecision> for ChunkingDecision {
    fn from(v: kreuzberg::heuristics::ChunkingDecision) -> Self {
        match v {
            kreuzberg::heuristics::ChunkingDecision::NoChunking { reason } => ChunkingDecision::NoChunking {
                reason: NoChunkingReason::from(reason),
            },
            kreuzberg::heuristics::ChunkingDecision::Chunk(f0) => ChunkingDecision::Chunk {
                field0: ChunkPlan::from(f0),
            },
            kreuzberg::heuristics::ChunkingDecision::UseOverrides { user_chunks } => ChunkingDecision::UseOverrides {
...
impl From<kreuzberg::heuristics::NoChunkingReason> for NoChunkingReason {
    fn from(v: kreuzberg::heuristics::NoChunkingReason) -> Self {
        match v {
            ...
            kreuzberg::heuristics::NoChunkingReason::FewPages { page_count, threshold } => NoChunkingReason::FewPages {
            ...
            kreuzberg::heuristics::NoChunkingReason::FormatNotChunkable { mime_type } => {
                NoChunkingReason::FormatNotChunkable { mime_type }
            }
            kreuzberg::heuristics::NoChunkingReason::ChunkingDisabled => NoChunkingReason::ChunkingDisabled,
            kreuzberg::heuristics::NoChunkingReason::FastTextExtraction => NoChunkingReason::FastTextExtraction,
        }
    }
}

impl From<kreuzberg::heuristics::ChunkingReason> for ChunkingReason {
    fn from(v: kreuzberg::heuristics::ChunkingReason) -> Self {
        match v {
            ...
            kreuzberg::heuristics::ChunkingReason::ManyPages { page_count, threshold } => ChunkingReason::ManyPages {
                page_count: page_count as _,
                threshold: threshold as _,
            },
...
impl From<kreuzberg::heuristics::StructuredCallMode> for StructuredCallMode {
    fn from(v: kreuzberg::heuristics::StructuredCallMode) -> Self {
        match v {
            kreuzberg::heuristics::StructuredCallMode::Skip => StructuredCallMode::Skip,
            kreuzberg::heuristics::StructuredCallMode::TextOnly => StructuredCallMode::TextOnly,
            kreuzberg::heuristics::StructuredCallMode::VisionOnly => StructuredCallMode::VisionOnly,
            kreuzberg::heuristics::StructuredCallMode::TextPlusVision => StructuredCallMode::TextPlusVision,
...
impl From<DocumentMetadata> for kreuzberg::heuristics::DocumentMetadata {
    fn from(v: DocumentMetadata) -> Self {
        kreuzberg::heuristics::DocumentMetadata {
            mime_type: v.mime_type.into(),
            size_bytes: v.size_bytes as _,
            page_count: v.page_count.map(|x| x as _),
            force_ocr: v.force_ocr as _,
...
impl From<UserChunkConfig> for kreuzberg::heuristics::UserChunkConfig {
    fn from(v: UserChunkConfig) -> Self {
        kreuzberg::heuristics::UserChunkConfig {
...
impl From<ConfidenceSignals> for kreuzberg::heuristics::ConfidenceSignals {
    fn from(v: ConfidenceSignals) -> Self {
        kreuzberg::heuristics::ConfidenceSignals {
            text_coverage: v.text_coverage as _,
            ocr_aggregate: v.ocr_aggregate.map(|x| x as _),
...
impl From<ConfidenceWeights> for kreuzberg::heuristics::ConfidenceWeights {
    fn from(v: ConfidenceWeights) -> Self {
        kreuzberg::heuristics::ConfidenceWeights {
            text_coverage: v.text_coverage as _,
            ocr_aggregate: v.ocr_aggregate as _,
            schema_compliance: v.schema_compliance as _,
        }
...
impl From<HeuristicsConfig> for kreuzberg::heuristics::HeuristicsConfig {
    fn from(v: HeuristicsConfig) -> Self {
        kreuzberg::heuristics::HeuristicsConfig {
            enable_pdf_text_heuristics: v.enable_pdf_text_heuristics as _,
            text_layer_threshold: v.text_layer_threshold as _,
            file_size_threshold_bytes: v.file_size_threshold_bytes as _,
            page_count_threshold: v.page_count_threshold as _,
...
impl From<PageRange> for kreuzberg::heuristics::PageRange {
    fn from(v: PageRange) -> Self {
        kreuzberg::heuristics::PageRange {
            start: v.start as _,
            end: v.end as _,
        }
    }
...
impl From<StructuredInput> for kreuzberg::heuristics::StructuredInput {
    fn from(v: StructuredInput) -> Self {
        kreuzberg::heuristics::StructuredInput {
            mime_type: v.mime_type.into(),
            page_count: v.page_count as _,
            text_coverage: v.text_coverage as _,
            avg_chars_per_page: v.avg_chars_per_page as _,
...
pub fn analyze_document(
    ...
    kreuzberg::heuristics::analyze_document(
        &kreuzberg::heuristics::DocumentMetadata::from(metadata),
        &kreuzberg::heuristics::HeuristicsConfig::from(config),
        &document_bytes,
    )
...
pub fn analyze_with_user_chunks(
    ...
    ChunkingDecision::from(kreuzberg::heuristics::analyze_with_user_chunks(
        user_ranges
            .into_iter()
            .map(kreuzberg::heuristics::PageRange::from)
            .collect::<Vec<_>>(),
        total_pages as u32,
        size_bytes as u64,
        &kreuzberg::heuristics::HeuristicsConfig::from(config),
...
pub fn score_confidence(signals: ConfidenceSignals, weights: ConfidenceWeights) -> ExtractionConfidence {
    ExtractionConfidence::from(kreuzberg::heuristics::score_confidence(
        kreuzberg::heuristics::ConfidenceSignals::from(signals),
        kreuzberg::heuristics::ConfidenceWeights::from(weights),
    ))
}
...
pub fn choose_call_mode(input: StructuredInput, t: StructuredThresholds) -> StructuredCallMode {
    StructuredCallMode::from(kreuzberg::heuristics::choose_call_mode(
        &kreuzberg::heuristics::StructuredInput::from(input),
        unsafe { std::mem::transmute::<&StructuredThresholds, &kreuzberg::heuristics::StructuredThresholds>(&t) },
    ))
}
...
pub fn calculate_chunk_plan(page_count: i64, size_bytes: i64, needs_ocr: bool, config: HeuristicsConfig) -> ChunkPlan {
    ChunkPlan::from(kreuzberg::heuristics::calculate_chunk_plan(
        page_count as u32,
        size_bytes as u64,
        needs_ocr,
        &kreuzberg::heuristics::HeuristicsConfig::from(config),
...
pub fn calculate_plan_from_overrides(
    ...
    ChunkPlan::from(kreuzberg::heuristics::calculate_plan_from_overrides(
        user_chunks
            .into_iter()
            .map(kreuzberg::heuristics::PageRange::from)
            .collect::<Vec<_>>(),
...
pub fn resolve(
    ...
    kreuzberg::resolve(&kreuzberg::Preset::from(preset), custom_schema, &context)
