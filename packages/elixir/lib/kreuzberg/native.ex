...
# alef:hash:10d3426a91e3197bdd2e96d8b5e2eeb431d8141c208665c0e644a0c1beae7021
...
defmodule Kreuzberg.Native do
  ...
  def render_html_str(_html), do: :erlang.nif_error(:nif_not_loaded)
  def render_markdown_str(_html), do: :erlang.nif_error(:nif_not_loaded)
  def render_djot_str(_html), do: :erlang.nif_error(:nif_not_loaded)
  def render_json_str(_html), do: :erlang.nif_error(:nif_not_loaded)
  def render_plain_str(_html), do: :erlang.nif_error(:nif_not_loaded)
  ...
  def convert_html_to_markdown(_html), do: :erlang.nif_error(:nif_not_loaded)
  def extract_doc_text(_content), do: :erlang.nif_error(:nif_not_loaded)
  def extract_pptx_from_bytes(_data), do: :erlang.nif_error(:nif_not_loaded)
  ...
  def extract_file_to_toon(_path, _config), do: :erlang.nif_error(:nif_not_loaded)
  def extract_file_to_json(_path, _config), do: :erlang.nif_error(:nif_not_loaded)
  ...
  def ocrtesseractconfig_default, do: :erlang.nif_error(:nif_not_loaded)
