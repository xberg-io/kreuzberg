...
# alef:hash:a21c1451bc67a1e560a5cd0511506ebd6e2682589da92a64ae910331ba3de7f8
...
defmodule Kreuzberg.Native do
  ...
  def extract_file_sync_ffi(_path, _mime_type, _config), do: :erlang.nif_error(:nif_not_loaded)
  def extract_file_ffi_async(_path, _mime_type, _config), do: :erlang.nif_error(:nif_not_loaded)
