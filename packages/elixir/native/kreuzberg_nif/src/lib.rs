...
// alef:hash:6b1273cd8136e935e7ad2adcfff165f04f896032039f7574f538ddbe3508a6e6
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize, rustler::NifStruct)]
#[module = "Kreuzberg.ArchiveArchiveMetadata"]
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize, rustler::NifStruct)]
#[module = "Kreuzberg.ArchiveArchiveEntry"]
...
pub fn render_html_str(html: String) -> Result<String, String> {
    let result = kreuzberg::render_html_str(&html).map_err(|e| e.to_string())?;
    Ok(result)
}
...
pub fn render_markdown_str(html: String) -> Result<String, String> {
    let result = kreuzberg::render_markdown_str(&html).map_err(|e| e.to_string())?;
    Ok(result)
}
...
pub fn render_djot_str(html: String) -> Result<String, String> {
    let result = kreuzberg::render_djot_str(&html).map_err(|e| e.to_string())?;
    Ok(result)
}
...
pub fn render_json_str(html: String) -> Result<String, String> {
    let result = kreuzberg::render_json_str(&html).map_err(|e| e.to_string())?;
    Ok(result)
}
...
pub fn render_plain_str(html: String) -> Result<String, String> {
    let result = kreuzberg::render_plain_str(&html).map_err(|e| e.to_string())?;
    Ok(result)
}
...
/// ```
#[rustler::nif]
pub fn detect_languages(text: String, config: Option<String>) -> Result<Option<Vec<String>>, String> {
    let config_core: Option<kreuzberg::LanguageDetectionConfig> = config
        .map(|s| serde_json::from_str::<kreuzberg::LanguageDetectionConfig>(&s))
        .transpose()
        .map_err(|e| e.to_string())?;
    let result = kreuzberg::detect_languages(&text, config_core.as_ref().unwrap_or(&Default::default()))
        .map_err(|e| e.to_string())?;
    Ok(result)
}
...
pub fn convert_html_to_markdown(html: String) -> Result<String, String> {
    let result = kreuzberg::convert_html_to_markdown(&html).map_err(|e| e.to_string())?;
    Ok(result)
}
...
pub fn extract_doc_text(content: Vec<u8>) -> Result<DocExtractionResult, String> {
    let result = kreuzberg::extract_doc_text(&content).map_err(|e| e.to_string())?;
    Ok(result.into())
}
...
pub fn extract_pptx_from_bytes(data: Vec<u8>) -> Result<PptxExtractionResult, String> {
    let result = kreuzberg::extract_pptx_from_bytes(&data).map_err(|e| e.to_string())?;
    Ok(result.into())
}
...
#[rustler::nif]
pub fn extract_file_to_toon(path: String, config: Option<String>) -> Result<String, String> {
    let config_core: Option<kreuzberg::ExtractionConfig> = config
        .map(|s| serde_json::from_str::<kreuzberg::ExtractionConfig>(&s))
        .transpose()
        .map_err(|e| e.to_string())?;
    let result = kreuzberg::extract_file_to_toon(
        std::path::PathBuf::from(path),
        config_core.as_ref().unwrap_or(&Default::default()),
    )
    .map_err(|e| e.to_string())?;
...
#[rustler::nif]
pub fn extract_file_to_json(path: String, config: Option<String>) -> Result<String, String> {
    let config_core: Option<kreuzberg::ExtractionConfig> = config
        .map(|s| serde_json::from_str::<kreuzberg::ExtractionConfig>(&s))
        .transpose()
        .map_err(|e| e.to_string())?;
    let result = kreuzberg::extract_file_to_json(
        std::path::PathBuf::from(path),
        config_core.as_ref().unwrap_or(&Default::default()),
    )
    .map_err(|e| e.to_string())?;
...
#[rustler::nif]
pub fn ocrtesseractconfig_default() -> TesseractConfig {
    kreuzberg::OcrTesseractConfig::default().into()
}
