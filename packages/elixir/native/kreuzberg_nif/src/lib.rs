...
pub struct MetaSchema {
    inner: Arc<kreuzberg::presets::loader::MetaSchema>,
}
...
pub fn analyze_document(
    ...
    let config_core: Option<kreuzberg::heuristics::HeuristicsConfig> = config
        .map(|s| serde_json::from_str::<kreuzberg::heuristics::HeuristicsConfig>(&s))
        .transpose()
        .map_err(|e| e.to_string())?;
    let result = kreuzberg::heuristics::analyze_document(
        &metadata.clone().into(),
        config_core.as_ref().unwrap_or(&Default::default()),
...
pub fn analyze_with_user_chunks(
    ...
    let user_ranges_core: Vec<kreuzberg::heuristics::PageRange> = user_ranges
        .and_then(|s| serde_json::from_str::<Vec<kreuzberg::heuristics::PageRange>>(&s).ok())
        .unwrap_or_default();
    let config_core: Option<kreuzberg::heuristics::HeuristicsConfig> =
        config.and_then(|s| serde_json::from_str::<kreuzberg::heuristics::HeuristicsConfig>(&s).ok());
    kreuzberg::heuristics::analyze_with_user_chunks(
        &user_ranges_core,
        total_pages,
        size_bytes,
        config_core.as_ref().unwrap_or(&Default::default()),
...
pub fn score_confidence(signals: ConfidenceSignals, weights: Option<String>) -> ExtractionConfidence {
    let weights_core: Option<kreuzberg::heuristics::ConfidenceWeights> =
        weights.and_then(|s| serde_json::from_str::<kreuzberg::heuristics::ConfidenceWeights>(&s).ok());
    kreuzberg::heuristics::score_confidence(signals.into(), weights_core.unwrap_or_default()).into()
}
...
pub fn check_format_limits(
    ...
    let config_core: Option<kreuzberg::heuristics::HeuristicsConfig> =
        config.and_then(|s| serde_json::from_str::<kreuzberg::heuristics::HeuristicsConfig>(&s).ok());
    kreuzberg::heuristics::check_format_limits(
        &mime_type,
        sheet_count,
        workbook_cells,
        embedded_count,
...
pub fn choose_call_mode(input: StructuredInput, t: Option<String>) -> StructuredCallMode {
    let t_core: Option<kreuzberg::heuristics::StructuredThresholds> =
        t.and_then(|s| serde_json::from_str::<kreuzberg::heuristics::StructuredThresholds>(&s).ok());
    kreuzberg::heuristics::choose_call_mode(&input.clone().into(), t_core.as_ref().unwrap_or(&Default::default()))
        .into()
}
...
pub fn calculate_chunk_plan(page_count: u32, size_bytes: u64, needs_ocr: bool, config: Option<String>) -> ChunkPlan {
    let config_core: Option<kreuzberg::heuristics::HeuristicsConfig> =
        config.and_then(|s| serde_json::from_str::<kreuzberg::heuristics::HeuristicsConfig>(&s).ok());
    kreuzberg::heuristics::calculate_chunk_plan(
        page_count,
        size_bytes,
        needs_ocr,
        config_core.as_ref().unwrap_or(&Default::default()),
...
pub fn calculate_plan_from_overrides(
    ...
    let user_chunks_core: Vec<kreuzberg::heuristics::PageRange> = user_chunks
        .and_then(|s| serde_json::from_str::<Vec<kreuzberg::heuristics::PageRange>>(&s).ok())
        .unwrap_or_default();
    let config_core: Option<kreuzberg::heuristics::HeuristicsConfig> =
        config.and_then(|s| serde_json::from_str::<kreuzberg::heuristics::HeuristicsConfig>(&s).ok());
    kreuzberg::heuristics::calculate_plan_from_overrides(
        &user_chunks_core,
        total_pages,
        size_bytes,
        config_core.as_ref().unwrap_or(&Default::default()),
...
pub fn confidencesignals_from_extraction_result(
    ...
    kreuzberg::heuristics::ConfidenceSignals::from_extraction_result(
        result_core.as_ref().unwrap_or(&Default::default()),
...
pub fn confidenceweights_is_normalized(obj: ConfidenceWeights) -> bool {
    kreuzberg::heuristics::ConfidenceWeights::from(obj).is_normalized()
}
...
pub fn heuristicsconfig_validate(obj: HeuristicsConfig) -> Result<(), String> {
    let result = kreuzberg::heuristics::HeuristicsConfig::from(obj)
        .validate()
        .map_err(|e| e.to_string())?;
    Ok(result)
}
...
#[rustler::nif]
pub fn heuristicsconfig_test_config() -> HeuristicsConfig {
...
pub fn chunkplan_total_pages(obj: ChunkPlan) -> u32 {
    kreuzberg::heuristics::ChunkPlan::from(obj).total_pages()
}

/// Get the number of pages in this range.
#[rustler::nif]
pub fn pagerange_page_count(obj: PageRange) -> u32 {
    kreuzberg::heuristics::PageRange::from(obj).page_count()
}
...
pub fn metaschema_compile(meta_schema_json: String) -> Result<ResourceArc<MetaSchema>, String> {
    let result = kreuzberg::presets::loader::MetaSchema::compile(&meta_schema_json).map_err(|e| e.to_string())?;
...
impl From<kreuzberg::heuristics::DocumentMetadata> for DocumentMetadata {
    fn from(val: kreuzberg::heuristics::DocumentMetadata) -> Self {
        Self {
            mime_type: val.mime_type.to_string(),
            size_bytes: val.size_bytes,
            page_count: val.page_count,
...
impl From<kreuzberg::heuristics::UserChunkConfig> for UserChunkConfig {
    fn from(val: kreuzberg::heuristics::UserChunkConfig) -> Self {
        Self {
            page_ranges: val.page_ranges.map(|v| v.into_iter().map(Into::into).collect()),
            pages_per_chunk: val.pages_per_chunk,
            force_chunking: val.force_chunking,
...
impl From<kreuzberg::heuristics::ConfidenceSignals> for ConfidenceSignals {
    fn from(val: kreuzberg::heuristics::ConfidenceSignals) -> Self {
        Self {
            text_coverage: val.text_coverage,
            ocr_aggregate: val.ocr_aggregate,
            schema_compliance: val.schema_compliance.into(),
...
impl From<kreuzberg::heuristics::ConfidenceWeights> for ConfidenceWeights {
    fn from(val: kreuzberg::heuristics::ConfidenceWeights) -> Self {
        Self {
            text_coverage: val.text_coverage,
            ocr_aggregate: val.ocr_aggregate,
            schema_compliance: val.schema_compliance,
...
impl From<kreuzberg::heuristics::HeuristicsConfig> for HeuristicsConfig {
    fn from(val: kreuzberg::heuristics::HeuristicsConfig) -> Self {
        Self {
            enable_pdf_text_heuristics: val.enable_pdf_text_heuristics,
            text_layer_threshold: val.text_layer_threshold,
            file_size_threshold_bytes: val.file_size_threshold_bytes,
...
impl From<kreuzberg::heuristics::ChunkPlan> for ChunkPlan {
    fn from(val: kreuzberg::heuristics::ChunkPlan) -> Self {
        Self {
            total_chunks: val.total_chunks,
            chunks: val.chunks.into_iter().map(Into::into).collect(),
            total_estimated_time_ms: val.total_estimated_time_ms,
...
impl From<kreuzberg::heuristics::ChunkInfo> for ChunkInfo {
    fn from(val: kreuzberg::heuristics::ChunkInfo) -> Self {
        Self {
            index: val.index,
            pages: val.pages.into(),
            estimated_time_ms: val.estimated_time_ms,
...
impl From<kreuzberg::heuristics::PageRange> for PageRange {
    fn from(val: kreuzberg::heuristics::PageRange) -> Self {
        Self {
            start: val.start,
            end: val.end,
        }
...
impl From<kreuzberg::heuristics::StructuredInput> for StructuredInput {
    fn from(val: kreuzberg::heuristics::StructuredInput) -> Self {
        Self {
            mime_type: val.mime_type.to_string(),
            page_count: val.page_count,
            text_coverage: val.text_coverage,
...
impl From<kreuzberg::heuristics::StructuredThresholds> for StructuredThresholds {
    fn from(val: kreuzberg::heuristics::StructuredThresholds) -> Self {
        Self {
            scan_max_coverage: val.scan_max_coverage,
            digital_min_coverage: val.digital_min_coverage,
            docx_text_min_density: val.docx_text_min_density,
...
impl From<ChunkingDecision> for kreuzberg::heuristics::ChunkingDecision {
...
impl From<kreuzberg::heuristics::ChunkingDecision> for ChunkingDecision {
    fn from(val: kreuzberg::heuristics::ChunkingDecision) -> Self {
        match val {
            kreuzberg::heuristics::ChunkingDecision::NoChunking { reason } => {
                Self::NoChunking { reason: reason.into() }
            }
            kreuzberg::heuristics::ChunkingDecision::Chunk(_0) => Self::Chunk { _0: _0.into() },
            kreuzberg::heuristics::ChunkingDecision::UseOverrides { user_chunks } => Self::UseOverrides {
                user_chunks: user_chunks.into_iter().map(Into::into).collect(),
            },
        }
    }
...
impl From<NoChunkingReason> for kreuzberg::heuristics::NoChunkingReason {
...
impl From<kreuzberg::heuristics::NoChunkingReason> for NoChunkingReason {
    fn from(val: kreuzberg::heuristics::NoChunkingReason) -> Self {
        match val {
            kreuzberg::heuristics::NoChunkingReason::SmallFile {
                size_bytes,
                threshold_bytes,
            } => Self::SmallFile {
                size_bytes,
            ...
            kreuzberg::heuristics::NoChunkingReason::FewPages { page_count, threshold } => {
                Self::FewPages { page_count, threshold }
            }
            kreuzberg::heuristics::NoChunkingReason::TextLayerDetected {
                text_coverage,
                avg_chars_per_page,
            } => Self::TextLayerDetected {
                text_coverage,
            ...
            kreuzberg::heuristics::NoChunkingReason::FormatNotChunkable { mime_type } => Self::FormatNotChunkable {
                mime_type: mime_type.to_string(),
            },
            kreuzberg::heuristics::NoChunkingReason::ChunkingDisabled => Self::ChunkingDisabled,
            kreuzberg::heuristics::NoChunkingReason::FastTextExtraction => Self::FastTextExtraction,
        }
    }
}

impl From<ChunkingReason> for kreuzberg::heuristics::ChunkingReason {
...
impl From<kreuzberg::heuristics::ChunkingReason> for ChunkingReason {
    fn from(val: kreuzberg::heuristics::ChunkingReason) -> Self {
        match val {
            kreuzberg::heuristics::ChunkingReason::LargeFile {
                size_bytes,
                threshold_bytes,
            } => Self::LargeFile {
                size_bytes,
            ...
            kreuzberg::heuristics::ChunkingReason::ManyPages { page_count, threshold } => {
                Self::ManyPages { page_count, threshold }
            }
            kreuzberg::heuristics::ChunkingReason::OcrRequired { page_count, force_ocr } => {
                Self::OcrRequired { page_count, force_ocr }
            }
            kreuzberg::heuristics::ChunkingReason::LargeAndManyPages { size_bytes, page_count } => {
                Self::LargeAndManyPages { size_bytes, page_count }
            }
        }
    }
...
impl From<StructuredCallMode> for kreuzberg::heuristics::StructuredCallMode {
...
impl From<kreuzberg::heuristics::StructuredCallMode> for StructuredCallMode {
    fn from(val: kreuzberg::heuristics::StructuredCallMode) -> Self {
        match val {
            kreuzberg::heuristics::StructuredCallMode::Skip => Self::Skip,
            kreuzberg::heuristics::StructuredCallMode::TextOnly => Self::TextOnly,
            kreuzberg::heuristics::StructuredCallMode::VisionOnly => Self::VisionOnly,
            kreuzberg::heuristics::StructuredCallMode::TextPlusVision => Self::TextPlusVision,
            kreuzberg::heuristics::StructuredCallMode::TextOnlyWithVisionFallback => Self::TextOnlyWithVisionFallback,
        }
    }
}
...
pub fn chunk_info_from_json(json: String) -> Result<ChunkInfo, String> {
    serde_json::from_str::<kreuzberg::heuristics::ChunkInfo>(&json)
        .map(ChunkInfo::from)
        .map_err(|e| e.to_string())
}
...
pub fn page_range_from_json(json: String) -> Result<PageRange, String> {
    serde_json::from_str::<kreuzberg::heuristics::PageRange>(&json)
        .map(PageRange::from)
        .map_err(|e| e.to_string())
}
