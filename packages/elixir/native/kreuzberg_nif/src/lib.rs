...
// alef:hash:675858d4661a90a8ae49e6555d44dc01f71fd40f3cda5715bb18fc5bc5c61911
...
pub fn unregister_embedding_backend(name: String) -> Result<(), String> {
    let result = kreuzberg::plugins::unregister_embedding_backend(&name).map_err(|e| e.to_string())?;
    Ok(result)
}
...
pub fn list_embedding_backends() -> Result<Vec<String>, String> {
    let result = kreuzberg::plugins::list_embedding_backends().map_err(|e| e.to_string())?;
    Ok(result)
}
...
pub fn clear_embedding_backends() -> Result<(), String> {
    let result = kreuzberg::plugins::clear_embedding_backends().map_err(|e| e.to_string())?;
    Ok(result)
}
