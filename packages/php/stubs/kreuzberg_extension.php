...
// alef:hash:eb53157eeff56a0c0cc2a580f093c9641c5debd5f9d027306f73fe75fb9337f3
...
namespace Kreuzberg {
    ...
    class ArchiveArchiveMetadata
    {
        ...
        /**
         * @param array<ArchiveEntry> $file_list
         */
        public function __construct(
            string $format,
            array $file_list,
    ...
    class KreuzbergApi
    {
        ...
        public static function extractPptxFromBytes(string $data): \Kreuzberg\PptxExtractionResult
        {
            throw new \RuntimeException('Not implemented.');
        }
        ...
        public static function extractFileToToon(string $path, \Kreuzberg\ExtractionConfig $config): string
        {
            throw new \RuntimeException('Not implemented.');
        }
        public static function extractFileToJson(string $path, \Kreuzberg\ExtractionConfig $config): string
        {
            throw new \RuntimeException('Not implemented.');
        }
    }
