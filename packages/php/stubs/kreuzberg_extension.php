...
// alef:hash:70bc4481b91db888b6f5d02b69149261976f2a5e589d5a4e8c793842b63ed646
...
class KreuzbergApi
{
    ...
    public static function extractFileSyncFfi(string $path, string $mime_type, \Kreuzberg\ExtractionConfig $config): \Kreuzberg\ExtractionResult { }
    public static function extractFileFfiAsync(string $path, string $mime_type, \Kreuzberg\ExtractionConfig $config): \Kreuzberg\ExtractionResult { }
