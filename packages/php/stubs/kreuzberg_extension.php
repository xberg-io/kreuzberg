...
// alef:hash:03819a9baa45323ce7f04ef266723b8c244bab6bd912403ac8729dfa17731fed
...
namespace Kreuzberg {
    ...
    class KreuzbergApi
    {
        ...
        public static function extractFile(string $path, ?string $mime_type = null, \Kreuzberg\ExtractionConfig $config): \Kreuzberg\ExtractionResult
        {
            throw new \RuntimeException('Not implemented.');
        }
