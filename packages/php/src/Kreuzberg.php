...
string $image_bytes, string $_format_hint): array
    {
...
string $name, string $cache_dir): string
    {
...
string $text, string $language, int $max_tokens): ?string
    {
...
string $image_bytes, string $image_mime, RegionKind $region_kind, LlmConfig $llm_config, string $custom_prompt): string
    {
...
string $pdf_bytes, int $page_index, int $dpi, string $password): string
    {
