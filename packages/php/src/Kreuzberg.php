...
// alef:hash:6f2818ef69d708ad46cb56ba15c8f904ed9f62d551de3cf72eebb9270a2251dd
...
final class Kreuzberg
{
     ...
     */
    public static function extractBytesAsync(string $content, string $mime_type, ExtractionConfig $config): ExtractionResult
    {
     ...
     * @throws \Kreuzberg\KreuzbergException
     */
    public static function batchExtractFilesAsync(array $items, ExtractionConfig $config): array
    {
     ...
     * @throws \Kreuzberg\KreuzbergException
     */
    public static function batchExtractBytesAsync(array $items, ExtractionConfig $config): array
    {
     ...
     * @throws \Kreuzberg\KreuzbergException
     */
    public static function embedTextsAsyncAsync(array $texts, EmbeddingConfig $config): array
    {
