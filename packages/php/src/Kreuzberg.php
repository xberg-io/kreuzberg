...
// alef:hash:f9b8c5232320d5d48de0365350e9dccd58854ae970f3eb3ab92a8883db4eef34
...
final class Kreuzberg
{
     ...
     * @throws \Kreuzberg\KreuzbergException
     */
    public static function extractFileSyncFfi(string $path, string $mime_type, ExtractionConfig $config): ExtractionResult
    {
        return \Kreuzberg\KreuzbergApi::extractFileSyncFfi($path, $mime_type, $config); // delegate to native extension class
    }
     ...
     * @throws \Kreuzberg\KreuzbergException
     */
    public static function extractFileFfi(string $path, string $mime_type, ExtractionConfig $config): ExtractionResult
    {
        return \Kreuzberg\KreuzbergApi::extractFileFfiAsync($path, $mime_type, $config); // delegate to native extension class
    }
