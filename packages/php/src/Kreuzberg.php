...
// alef:hash:8baefe7d369f3d18d91f9e99312745568a390e158bafec9aadbfa386565cd855
...
final class Kreuzberg
{
     ...
     * @throws \Kreuzberg\KreuzbergException
     */
    public static function renderHtmlStr(string $html): string
    {
        return \Kreuzberg\KreuzbergApi::renderHtmlStr($html); // delegate to native extension class
    }
     ...
     * @throws \Kreuzberg\KreuzbergException
     */
    public static function renderMarkdownStr(string $html): string
    {
        return \Kreuzberg\KreuzbergApi::renderMarkdownStr($html); // delegate to native extension class
    }
     ...
     * @throws \Kreuzberg\KreuzbergException
     */
    public static function renderDjotStr(string $html): string
    {
        return \Kreuzberg\KreuzbergApi::renderDjotStr($html); // delegate to native extension class
    }
     ...
     * @throws \Kreuzberg\KreuzbergException
     */
    public static function renderJsonStr(string $html): string
    {
        return \Kreuzberg\KreuzbergApi::renderJsonStr($html); // delegate to native extension class
    }
     ...
     * @throws \Kreuzberg\KreuzbergException
     */
    public static function renderPlainStr(string $html): string
    {
        return \Kreuzberg\KreuzbergApi::renderPlainStr($html); // delegate to native extension class
    }
     ...
     *
     * @param array<array<string>> $parts
     * @return string
     */
    ...
    {
        return \Kreuzberg\KreuzbergApi::convertHtmlToMarkdown($html); // delegate to native extension class
    }
     ...
     * @throws \Kreuzberg\KreuzbergException
     */
    public static function extractPptxFromBytes(string $data): PptxExtractionResult
    {
        return \Kreuzberg\KreuzbergApi::extractPptxFromBytes($data); // delegate to native extension class
    }
     ...
     * @throws \Kreuzberg\KreuzbergException
     */
    public static function extractFileToToon(string $path, ExtractionConfig $config): string
    {
        return \Kreuzberg\KreuzbergApi::extractFileToToon($path, $config); // delegate to native extension class
    }
     ...
     * @throws \Kreuzberg\KreuzbergException
     */
    public static function extractFileToJson(string $path, ExtractionConfig $config): string
    {
        return \Kreuzberg\KreuzbergApi::extractFileToJson($path, $config); // delegate to native extension class
    }
