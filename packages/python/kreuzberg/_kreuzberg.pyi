...
# alef:hash:ed9c2f8d4604563899d05ae10034a8ab7d9860ca82b2f98156a826f033e679d6
...
class ArchiveArchiveEntry:
    ...
    size: int
    is_dir: bool
    def __init__(self, path: str, size: int, is_dir: bool) -> None: ...
...
class DocExtractionResult:
    ...
    def __init__(self, content: str, metadata: DocMetadata) -> None: ...
...
class OcrTesseractConfig:
    ...
    def default() -> TesseractConfig: ...
    @staticmethod
    def from_(config: TesseractConfig) -> TesseractConfig: ...
