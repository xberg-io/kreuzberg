...
# alef:hash:9bbd373e7b161b33fdad751ada0ac2bebda1c624e6e48473dbbe9e4828823e94
...
from ._kreuzberg import TesseractConfig, HierarchyConfig, DocumentStructure, PageBoundary, PageConfig, HtmlOutputConfig, ChunkingResult, AccelerationConfig, ContentFilterConfig, SupportedFormat, ImageExtractionConfig, KeywordConfig, PdfConfig, ExtractionResult, TokenReductionConfig, OcrConfig, EmbeddingConfig, ImagePreprocessingConfig, Keyword, LayoutDetectionConfig, TreeSitterConfig, ExtractionConfig, Metadata, ByteBufferPool, RakeParams, LlmConfig, StringBufferPool, TextAnnotation, OcrElementConfig, PostProcessorConfig, Element, OcrQualityThresholds, ChunkingConfig, EmailConfig, YakeParams, EmailExtractionResult, LanguageDetectionConfig, TreeSitterProcessConfig
...
def chunk_text_with_heading_source(text: str, config: ChunkingConfig, page_boundaries: list[PageBoundary] | None = None, heading_source: str | None = None) -> ChunkingResult:
...
def chunk_semantic(text: str, config: ChunkingConfig, page_boundaries: list[PageBoundary] | None = None) -> ChunkingResult:
