...
// alef:hash:7922d2f17d316ccfc9b43884c28656626ae9dd941a3f3949089b2ae3a1fb6184
...
fn unregister_embedding_backend(name: String) -> Result<(), Error> {
    let result = kreuzberg::plugins::unregister_embedding_backend(&name).map_err(|e| {
        magnus::Error::new(
            unsafe { Ruby::get_unchecked() }.exception_runtime_error(),
            e.to_string(),
        )
...
fn list_embedding_backends() -> Result<Vec<String>, Error> {
    let result = kreuzberg::plugins::list_embedding_backends().map_err(|e| {
        magnus::Error::new(
            unsafe { Ruby::get_unchecked() }.exception_runtime_error(),
            e.to_string(),
        )
...
fn clear_embedding_backends() -> Result<(), Error> {
    let result = kreuzberg::plugins::clear_embedding_backends().map_err(|e| {
        magnus::Error::new(
            unsafe { Ruby::get_unchecked() }.exception_runtime_error(),
            e.to_string(),
        )
...
fn pdf_page_count(pdf_bytes: Vec<u8>, password: Option<String>) -> Result<usize, Error> {
    let result = kreuzberg::pdf::rendering::pdf_page_count(&pdf_bytes, password.as_deref()).map_err(|e| {
        magnus::Error::new(
            unsafe { Ruby::get_unchecked() }.exception_runtime_error(),
            e.to_string(),
        )
...
fn init(ruby: &Ruby) -> Result<(), Error> {
    ...
    module.define_module_function("pdf_page_count", function!(pdf_page_count, 2))?;
