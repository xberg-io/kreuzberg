...
// alef:hash:27bd4229b569b2249373e9f3194c4a520289c28fe2e07e1f9874515e55661225
...
fn extract_file_sync_ffi(path: String, mime_type: String, config: String) -> Result<ExtractionResult, Error> {
    let config: ExtractionConfig = {
        let core: kreuzberg::ExtractionConfig = serde_json::from_str(&config)
            .map_err(|e| magnus::Error::new(unsafe { Ruby::get_unchecked() }.exception_type_error(), e.to_string()))?;
        core.into()
    ...
    Err(magnus::Error::new(
        unsafe { Ruby::get_unchecked() }.exception_runtime_error(),
        "Not implemented: extract_file_sync_ffi",
    ))
}

fn extract_file_ffi(path: String, mime_type: String, config: String) -> Result<ExtractionResult, Error> {
    let config: ExtractionConfig = {
        let core: kreuzberg::ExtractionConfig = serde_json::from_str(&config)
            .map_err(|e| magnus::Error::new(unsafe { Ruby::get_unchecked() }.exception_type_error(), e.to_string()))?;
        core.into()
    ...
    Err(magnus::Error::new(
        unsafe { Ruby::get_unchecked() }.exception_runtime_error(),
        "Not implemented: extract_file_ffi",
    ))
}

fn extract_file_ffi_async(path: String, mime_type: String, config: String) -> Result<ExtractionResult, Error> {
    let config: ExtractionConfig = {
        let core: kreuzberg::ExtractionConfig = serde_json::from_str(&config)
            .map_err(|e| magnus::Error::new(unsafe { Ruby::get_unchecked() }.exception_type_error(), e.to_string()))?;
        core.into()
    ...
    Err(magnus::Error::new(
        unsafe { Ruby::get_unchecked() }.exception_runtime_error(),
        "Not implemented: extract_file_ffi_async",
    ))
}
...
fn init(ruby: &Ruby) -> Result<(), Error> {
    ...
    module.define_module_function("extract_file_sync_ffi", function!(extract_file_sync_ffi, 3))?;
    module.define_module_function("extract_file_ffi", function!(extract_file_ffi, 3))?;
    module.define_module_function("extract_file_ffi_async", function!(extract_file_ffi_async, 3))?;
