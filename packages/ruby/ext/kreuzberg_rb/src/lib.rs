...
// alef:hash:8c65349573fbd185fb2e525ed93188129dba297eb295e80595e6801e5e69aa40
...
fn reduce_tokens(text: String, config: magnus::Value, language_hint: Option<String>) -> Result<String, Error> {
...
fn warm_model(model_type: magnus::Value, cache_dir: Option<String>) -> Result<(), Error> {
...
fn download_model(model_type: magnus::Value, cache_dir: Option<String>) -> Result<(), Error> {
    let model_type_core: kreuzberg::EmbeddingModelType = {
        let s: String = model_type.funcall("to_json", ())?;
        serde_json::from_str(&s).map_err(|e| {
            magnus::Error::new(
...
fn embed_texts(texts: Vec<String>, config: Option<magnus::Value>) -> Result<Vec<Vec<f32>>, Error> {
