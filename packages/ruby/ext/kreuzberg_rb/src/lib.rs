...
// alef:hash:87cef9ada7e43f14164d746368ed53e753bb95776b20dea54f14ee1e0de164dc
...
#[derive(Clone, Debug, Default, serde::Serialize, serde::Deserialize)]
#[magnus::wrap(class = "Kreuzberg::ArchiveArchiveMetadata")]
...
unsafe impl IntoValueFromNative for ArchiveArchiveMetadata {}

impl magnus::TryConvert for ArchiveArchiveMetadata {
    fn try_convert(val: magnus::Value) -> Result<Self, magnus::Error> {
        let r: &ArchiveArchiveMetadata = magnus::TryConvert::try_convert(val)?;
        Ok(r.clone())
    }
}
unsafe impl TryConvertOwned for ArchiveArchiveMetadata {}

impl ArchiveArchiveMetadata {
    fn new(format: String, file_list: Vec<ArchiveEntry>, file_count: usize, total_size: u64) -> Self {
        Self {
            format,
            file_list,
            file_count,
    ...
    fn file_list(&self) -> Vec<ArchiveEntry> {
...
#[derive(Clone, Debug, Default, serde::Serialize, serde::Deserialize)]
#[magnus::wrap(class = "Kreuzberg::ArchiveArchiveEntry")]
...
unsafe impl IntoValueFromNative for ArchiveArchiveEntry {}

impl magnus::TryConvert for ArchiveArchiveEntry {
    fn try_convert(val: magnus::Value) -> Result<Self, magnus::Error> {
        let r: &ArchiveArchiveEntry = magnus::TryConvert::try_convert(val)?;
        Ok(r.clone())
    }
}
unsafe impl TryConvertOwned for ArchiveArchiveEntry {}

impl ArchiveArchiveEntry {
    fn new(path: String, size: u64, is_dir: bool) -> Self {
...
impl DocExtractionResult {
    fn new(content: String, metadata: DocMetadata) -> Self {
...
#[derive(Clone, Debug, serde::Serialize, serde::Deserialize)]
#[magnus::wrap(class = "Kreuzberg::OcrTesseractConfig")]
#[serde(default)]
...
unsafe impl IntoValueFromNative for OcrTesseractConfig {}

impl magnus::TryConvert for OcrTesseractConfig {
    fn try_convert(val: magnus::Value) -> Result<Self, magnus::Error> {
        let r: &OcrTesseractConfig = magnus::TryConvert::try_convert(val)?;
        Ok(r.clone())
    }
}
unsafe impl TryConvertOwned for OcrTesseractConfig {}

impl Default for OcrTesseractConfig {
    fn default() -> Self {
        Self {
            language: Default::default(),
            psm: Default::default(),
...
fn validate_port(port: u32) -> Result<(), Error> {
...
fn extract_file(args: &[magnus::Value]) -> Result<ExtractionResult, Error> {
    ...
    let (path,) = _scan.required;
    let (mime_type, config) = _scan.optional;
...
fn batch_extract_file_sync(items: Vec<String>, config: magnus::Value) -> Result<Vec<ExtractionResult>, Error> {
...
fn batch_extract_bytes_sync(items: Vec<String>, config: magnus::Value) -> Result<Vec<ExtractionResult>, Error> {
    let items_core: Vec<_> = items
        .into_iter()
        .map(|s| {
            serde_json::from_str::<_>(&s).map_err(|e| {
...
fn batch_extract_file(items: Vec<String>, config: magnus::Value) -> Result<Vec<ExtractionResult>, Error> {
    let items_core: Vec<_> = items
        .into_iter()
        .map(|s| {
            serde_json::from_str::<_>(&s).map_err(|e| {
...
fn batch_extract_file_async(items: Vec<String>, config: magnus::Value) -> Result<Vec<ExtractionResult>, Error> {
    let items_core: Vec<_> = items
        .into_iter()
        .map(|s| {
            serde_json::from_str::<_>(&s).map_err(|e| {
...
fn batch_extract_bytes(items: Vec<String>, config: magnus::Value) -> Result<Vec<ExtractionResult>, Error> {
    let items_core: Vec<_> = items
        .into_iter()
        .map(|s| {
            serde_json::from_str::<_>(&s).map_err(|e| {
...
fn batch_extract_bytes_async(items: Vec<String>, config: magnus::Value) -> Result<Vec<ExtractionResult>, Error> {
    let items_core: Vec<_> = items
        .into_iter()
        .map(|s| {
            serde_json::from_str::<_>(&s).map_err(|e| {
...
fn detect_or_validate(args: &[magnus::Value]) -> Result<String, Error> {
    let _scan = magnus::scan_args::scan_args::<(), (Option<String>, Option<String>), (), (), (), ()>(args)?;
    let (path, mime_type) = _scan.optional;
...
fn extract_email_content(args: &[magnus::Value]) -> Result<EmailExtractionResult, Error> {
    let _scan = magnus::scan_args::scan_args::<(Vec<u8>, String), (Option<u32>,), (), (), (), ()>(args)?;
    let (data, mime_type) = _scan.required;
    let (fallback_codepage,) = _scan.optional;
...
fn render_html_str(html: String) -> Result<String, Error> {
    let result = kreuzberg::render_html_str(&html).map_err(|e| {
        magnus::Error::new(
            unsafe { Ruby::get_unchecked() }.exception_runtime_error(),
            e.to_string(),
        )
...
fn render_markdown_str(html: String) -> Result<String, Error> {
    let result = kreuzberg::render_markdown_str(&html).map_err(|e| {
        magnus::Error::new(
            unsafe { Ruby::get_unchecked() }.exception_runtime_error(),
            e.to_string(),
        )
...
fn render_djot_str(html: String) -> Result<String, Error> {
    let result = kreuzberg::render_djot_str(&html).map_err(|e| {
        magnus::Error::new(
            unsafe { Ruby::get_unchecked() }.exception_runtime_error(),
            e.to_string(),
        )
...
fn render_json_str(html: String) -> Result<String, Error> {
    let result = kreuzberg::render_json_str(&html).map_err(|e| {
        magnus::Error::new(
            unsafe { Ruby::get_unchecked() }.exception_runtime_error(),
            e.to_string(),
        )
...
fn render_plain_str(html: String) -> Result<String, Error> {
    let result = kreuzberg::render_plain_str(&html).map_err(|e| {
        magnus::Error::new(
            unsafe { Ruby::get_unchecked() }.exception_runtime_error(),
            e.to_string(),
        )
...
fn reduce_tokens(args: &[magnus::Value]) -> Result<String, Error> {
    let _scan = magnus::scan_args::scan_args::<(String, magnus::Value), (Option<String>,), (), (), (), ()>(args)?;
    let (text, config) = _scan.required;
    let (language_hint,) = _scan.optional;
...
fn link(args: &[magnus::Value]) -> Result<TextAnnotation, Error> {
    let _scan = magnus::scan_args::scan_args::<(u32, u32, String), (Option<String>,), (), (), (), ()>(args)?;
    let (start, end, url) = _scan.required;
    let (title,) = _scan.optional;
    Ok(kreuzberg::builder::link(start, end, &url, title.as_deref()).into())
}
...
fn safe_decode(args: &[magnus::Value]) -> Result<String, Error> {
    let _scan = magnus::scan_args::scan_args::<(Vec<u8>,), (Option<String>,), (), (), (), ()>(args)?;
    let (byte_data,) = _scan.required;
    let (encoding,) = _scan.optional;
    Ok(kreuzberg::utils::safe_decode(&byte_data, encoding.as_deref()))
}
...
fn normalize_whitespace(s: String) -> String {
    String::from("[unimplemented: normalize_whitespace]")
}
...
fn warm_model(args: &[magnus::Value]) -> Result<(), Error> {
    let _scan = magnus::scan_args::scan_args::<(magnus::Value,), (Option<String>,), (), (), (), ()>(args)?;
    let (model_type,) = _scan.required;
    let (cache_dir,) = _scan.optional;
    let model_type_core: kreuzberg::EmbeddingModelType = {
        let s: String = model_type.funcall("to_json", ())?;
        serde_json::from_str(&s).map_err(|e| {
            magnus::Error::new(
                unsafe { Ruby::get_unchecked() }.exception_runtime_error(),
                e.to_string(),
...
fn download_model(args: &[magnus::Value]) -> Result<(), Error> {
    let _scan = magnus::scan_args::scan_args::<(magnus::Value,), (Option<String>,), (), (), (), ()>(args)?;
    let (model_type,) = _scan.required;
    let (cache_dir,) = _scan.optional;
    let model_type_core: kreuzberg::EmbeddingModelType = {
...
fn detect_languages(text: String, config: magnus::Value) -> Result<Option<Vec<String>>, Error> {
    ...
    let result = kreuzberg::detect_languages(&text, &config_core).map_err(|e| {
        magnus::Error::new(
            unsafe { Ruby::get_unchecked() }.exception_runtime_error(),
            e.to_string(),
        )
...
fn extract_keywords(text: String, config: magnus::Value) -> Result<Vec<Keyword>, Error> {
...
fn render_pdf_page_to_png(args: &[magnus::Value]) -> Result<Vec<u8>, Error> {
    let _scan = magnus::scan_args::scan_args::<(Vec<u8>, usize), (Option<i32>, Option<String>), (), (), (), ()>(args)?;
    let (pdf_bytes, page_index) = _scan.required;
    let (dpi, password) = _scan.optional;
...
fn detect_image_format(data: Vec<u8>) -> String {
    kreuzberg::detect_image_format(data)
}

fn embed_texts(args: &[magnus::Value]) -> Result<Vec<Vec<f32>>, Error> {
    let _scan = magnus::scan_args::scan_args::<(Vec<String>,), (Option<magnus::Value>,), (), (), (), ()>(args)?;
    let (texts,) = _scan.required;
    let (config,) = _scan.optional;
...
fn generate_cache_key(parts: Vec<Vec<String>>) -> String {
    kreuzberg::generate_cache_key(parts)
}

fn escape_html_entities(text: String) -> String {
    kreuzberg::escape_html_entities(&text)
}

fn fix_mojibake(text: String) -> String {
    kreuzberg::fix_mojibake(&text)
}

fn convert_html_to_markdown(html: String) -> Result<String, Error> {
    let result = kreuzberg::convert_html_to_markdown(&html).map_err(|e| {
        magnus::Error::new(
            unsafe { Ruby::get_unchecked() }.exception_runtime_error(),
            e.to_string(),
        )
...
fn extract_doc_text(content: Vec<u8>) -> Result<DocExtractionResult, Error> {
    let result = kreuzberg::extract_doc_text(&content).map_err(|e| {
        magnus::Error::new(
            unsafe { Ruby::get_unchecked() }.exception_runtime_error(),
            e.to_string(),
        )
...
fn extract_pptx_from_bytes(data: Vec<u8>) -> Result<PptxExtractionResult, Error> {
    let result = kreuzberg::extract_pptx_from_bytes(&data).map_err(|e| {
        magnus::Error::new(
            unsafe { Ruby::get_unchecked() }.exception_runtime_error(),
            e.to_string(),
        )
...
fn serialize_to_toon(result: magnus::Value) -> Result<String, Error> {
    let result_core: kreuzberg::ExtractionResult = {
        let s: String = result.funcall("to_json", ())?;
        serde_json::from_str(&s).map_err(|e| {
            magnus::Error::new(
                unsafe { Ruby::get_unchecked() }.exception_runtime_error(),
                e.to_string(),
...
fn serialize_to_json(result: magnus::Value) -> Result<String, Error> {
    let result_core: kreuzberg::ExtractionResult = {
        let s: String = result.funcall("to_json", ())?;
        serde_json::from_str(&s).map_err(|e| {
            magnus::Error::new(
...
fn extract_file_to_toon(path: String, config: magnus::Value) -> Result<String, Error> {
    let config_core: kreuzberg::ExtractionConfig = {
        let s: String = config.funcall("to_json", ())?;
        serde_json::from_str(&s).map_err(|e| {
            magnus::Error::new(
    ...
    let result = kreuzberg::extract_file_to_toon(std::path::PathBuf::from(path), &config_core).map_err(|e| {
        magnus::Error::new(
            unsafe { Ruby::get_unchecked() }.exception_runtime_error(),
            e.to_string(),
        )
...
fn extract_file_to_json(path: String, config: magnus::Value) -> Result<String, Error> {
    let config_core: kreuzberg::ExtractionConfig = {
        let s: String = config.funcall("to_json", ())?;
        serde_json::from_str(&s).map_err(|e| {
            magnus::Error::new(
    ...
    let result = kreuzberg::extract_file_to_json(std::path::PathBuf::from(path), &config_core).map_err(|e| {
        magnus::Error::new(
            unsafe { Ruby::get_unchecked() }.exception_runtime_error(),
            e.to_string(),
        )
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::extraction::archive::ArchiveMetadata> for ArchiveArchiveMetadata {
    fn from(val: kreuzberg::extraction::archive::ArchiveMetadata) -> Self {
        Self {
            format: val.format,
            file_list: val.file_list.into_iter().map(Into::into).collect(),
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::extraction::archive::ArchiveEntry> for ArchiveArchiveEntry {
    fn from(val: kreuzberg::extraction::archive::ArchiveEntry) -> Self {
        Self {
            path: val.path,
            size: val.size,
            is_dir: val.is_dir,
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<DocExtractionResult> for kreuzberg::DocExtractionResult {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::DocExtractionResult> for DocExtractionResult {
    fn from(val: kreuzberg::DocExtractionResult) -> Self {
        Self {
            content: val.content,
            metadata: val.metadata.into(),
        }
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<DocMetadata> for kreuzberg::DocMetadata {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::DocMetadata> for DocMetadata {
    fn from(val: kreuzberg::DocMetadata) -> Self {
        Self {
            title: val.title,
            subject: val.subject,
            author: val.author,
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::ocr::TesseractConfig> for OcrTesseractConfig {
    fn from(val: kreuzberg::ocr::TesseractConfig) -> Self {
        Self {
            language: val.language,
            psm: val.psm,
            output_format: val.output_format,
...
fn init(ruby: &Ruby) -> Result<(), Error> {
    ...
    let class = module.define_class("ArchiveArchiveMetadata", ruby.class_object())?;
    class.define_singleton_method("new", function!(ArchiveArchiveMetadata::new, 4))?;
    class.define_method("format", method!(ArchiveArchiveMetadata::format, 0))?;
    class.define_method("file_list", method!(ArchiveArchiveMetadata::file_list, 0))?;
    class.define_method("file_count", method!(ArchiveArchiveMetadata::file_count, 0))?;
    class.define_method("total_size", method!(ArchiveArchiveMetadata::total_size, 0))?;

    let class = module.define_class("ArchiveArchiveEntry", ruby.class_object())?;
    class.define_singleton_method("new", function!(ArchiveArchiveEntry::new, 3))?;
    class.define_method("path", method!(ArchiveArchiveEntry::path, 0))?;
    class.define_method("size", method!(ArchiveArchiveEntry::size, 0))?;
    class.define_method("is_dir", method!(ArchiveArchiveEntry::is_dir, 0))?;
    ...
    class.define_method("content", method!(DocExtractionResult::content, 0))?;
    ...
    let class = module.define_class("OcrTesseractConfig", ruby.class_object())?;
    class.define_singleton_method("new", function!(OcrTesseractConfig::new, 1))?;
    class.define_method("language", method!(OcrTesseractConfig::language, 0))?;
    class.define_method("psm", method!(OcrTesseractConfig::psm, 0))?;
    class.define_method("output_format", method!(OcrTesseractConfig::output_format, 0))?;
    class.define_method("oem", method!(OcrTesseractConfig::oem, 0))?;
    class.define_method("min_confidence", method!(OcrTesseractConfig::min_confidence, 0))?;
    class.define_method("preprocessing", method!(OcrTesseractConfig::preprocessing, 0))?;
    class.define_method(
        "enable_table_detection",
        method!(OcrTesseractConfig::enable_table_detection, 0),
    )?;
    class.define_method(
        "table_min_confidence",
        method!(OcrTesseractConfig::table_min_confidence, 0),
    )?;
    class.define_method(
        "table_column_threshold",
        method!(OcrTesseractConfig::table_column_threshold, 0),
    )?;
    class.define_method(
        "table_row_threshold_ratio",
        method!(OcrTesseractConfig::table_row_threshold_ratio, 0),
    )?;
    class.define_method("use_cache", method!(OcrTesseractConfig::use_cache, 0))?;
    class.define_method(
        "classify_use_pre_adapted_templates",
        method!(OcrTesseractConfig::classify_use_pre_adapted_templates, 0),
    )?;
    class.define_method(
        "language_model_ngram_on",
        method!(OcrTesseractConfig::language_model_ngram_on, 0),
    )?;
    class.define_method(
        "tessedit_dont_blkrej_good_wds",
        method!(OcrTesseractConfig::tessedit_dont_blkrej_good_wds, 0),
    )?;
    class.define_method(
        "tessedit_dont_rowrej_good_wds",
        method!(OcrTesseractConfig::tessedit_dont_rowrej_good_wds, 0),
    )?;
    class.define_method(
        "tessedit_enable_dict_correction",
        method!(OcrTesseractConfig::tessedit_enable_dict_correction, 0),
    )?;
    class.define_method(
        "tessedit_char_whitelist",
        method!(OcrTesseractConfig::tessedit_char_whitelist, 0),
    )?;
    class.define_method(
        "tessedit_char_blacklist",
        method!(OcrTesseractConfig::tessedit_char_blacklist, 0),
    )?;
    class.define_method(
        "tessedit_use_primary_params_model",
        method!(OcrTesseractConfig::tessedit_use_primary_params_model, 0),
    )?;
    class.define_method(
        "textord_space_size_is_variable",
        method!(OcrTesseractConfig::textord_space_size_is_variable, 0),
    )?;
    class.define_method(
        "thresholding_method",
        method!(OcrTesseractConfig::thresholding_method, 0),
    )?;
    class.define_method("auto_rotate", method!(OcrTesseractConfig::auto_rotate, 0))?;
    ...
    module.define_module_function("detect_or_validate", function!(detect_or_validate, -1))?;
    ...
    module.define_module_function("extract_email_content", function!(extract_email_content, -1))?;
    ...
    module.define_module_function("render_html_str", function!(render_html_str, 1))?;
    module.define_module_function("render_markdown_str", function!(render_markdown_str, 1))?;
    module.define_module_function("render_djot_str", function!(render_djot_str, 1))?;
    module.define_module_function("render_json_str", function!(render_json_str, 1))?;
    module.define_module_function("render_plain_str", function!(render_plain_str, 1))?;
    ...
    module.define_module_function("reduce_tokens", function!(reduce_tokens, -1))?;
    ...
    module.define_module_function("link", function!(link, -1))?;
    ...
    module.define_module_function("safe_decode", function!(safe_decode, -1))?;
    ...
    module.define_module_function("warm_model", function!(warm_model, -1))?;
    module.define_module_function("download_model", function!(download_model, -1))?;
    ...
    module.define_module_function("generate_cache_key", function!(generate_cache_key, 1))?;
    ...
    module.define_module_function("convert_html_to_markdown", function!(convert_html_to_markdown, 1))?;
    module.define_module_function("extract_doc_text", function!(extract_doc_text, 1))?;
    module.define_module_function("extract_pptx_from_bytes", function!(extract_pptx_from_bytes, 1))?;
    ...
    module.define_module_function("extract_file_to_toon", function!(extract_file_to_toon, 2))?;
    module.define_module_function("extract_file_to_json", function!(extract_file_to_json, 2))?;
