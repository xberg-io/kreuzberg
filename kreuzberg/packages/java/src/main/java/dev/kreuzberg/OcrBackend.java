 ...
 *
 * <p>
 * OCR backends process images and extract text using optical character
 * recognition. They are called when OCR is enabled in the extraction
 * configuration.
 *
 * <h2>Usage</h2>
 *
 ...
 * multiple threads during batch extraction operations.
 *
 * <h2>Error Handling</h2>
 *
 * <p>
 * If OCR fails, throw a {@link KreuzbergException}. The extraction will fail
...
public interface OcrBackend {
	 ...
	 *
	 * <p>
	 * The configuration is provided as a JSON string encoded from
	 * {@link dev.kreuzberg.config.OcrConfig}.
	 *
	 * @param imageBytes
	 *            raw image data
	 * @param configJson
