 ...
 *
 * <p>
 * Enables extraction and insertion of page boundaries, and tracking of which
 * pages chunks span across.
 *
 * @since 4.0.0
 */
public final class PageConfig {
	...
	@JsonCreator
	public PageConfig(@JsonProperty("extract_pages") boolean extractPages,
	...
	public static PageConfig fromMap(Map<String, Object> map) {
		...
		return new PageConfig(asBoolean(map.get("extract_pages"), false),
				asBoolean(map.get("insert_page_markers"), false), (String) map.get("marker_format"));
	}
	...
	public boolean equals(Object obj) {
		...
		return extractPages == other.extractPages && insertPageMarkers == other.insertPageMarkers
	...
	public String toString() {
		return "PageConfig{" + "extractPages=" + extractPages + ", insertPageMarkers=" + insertPageMarkers
	...
	public static final class Builder {
		 ...
		 *
		 * @param insertPageMarkers
		 *            whether to insert markers
		 * @return this builder for chaining
		 */
