 ...
 *
 * <p>
 * Maps byte ranges in the extracted content string (UTF-8 boundaries) to page
 * numbers, enabling page range calculation for chunks.
 *
 * @param byteStart
 *            byte offset where this page starts in the content string (UTF-8
 *            boundary, inclusive)
 * @param byteEnd
 *            byte offset where this page ends in the content string (UTF-8
 *            boundary, exclusive)
 * @param pageNumber
