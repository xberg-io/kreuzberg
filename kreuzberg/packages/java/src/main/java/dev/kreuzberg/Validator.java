 ...
 *
 * <p>
 * Validators check extraction results for quality, completeness, or other
 * criteria. If validation fails, they throw a {@link ValidationException}.
 *
 * <h2>Usage</h2>
 *
 * <pre>{@code
...
public interface Validator {
	 ...
	 *
	 * <p>
	 * If validation passes, this method returns normally. If validation fails, it
	 * throws a {@link ValidationException} with a descriptive message.
	 *
	 * @param result
	 *            the extraction result to validate
	 ...
	 *
	 * @param after
	 *            the validator to run after this one
