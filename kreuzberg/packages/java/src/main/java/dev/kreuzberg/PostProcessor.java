 ...
 *
 * <p>
 * PostProcessors enrich extraction results by transforming content, adding
 * metadata, or performing additional analysis. They are applied after the core
...
public interface PostProcessor {
	 ...
	 *
	 * <p>
	 * Implementations may transform the content, add metadata, or perform any other
	 * modifications. The original result is not modified; instead, a new result
	 * with the changes is returned.
	 *
	 * @param result
	 *            the extraction result to process
	 ...
	 *
	 * @param after
	 *            the processor to apply after this one
