...
Clear-Vu Lighting (CVL) offers to sell and deliver lighting products accordance with the terms and conditions set forth herein. Acceptance of this offer is expressly limited to such terms. CVL hereby objects to and rejects any additional or alternative terms proposed by Buyer, including those contained in Buyer's purchase order, unless CVL expressly agrees to such terms in writing. All orders are subject to credit approval and acceptance by CVL.    Credit availability is granted at the discretion of CVL. We reserve the right to refuse to manufacture any item that is not in stock, or in the event that the order is too small to run on a production basis.
