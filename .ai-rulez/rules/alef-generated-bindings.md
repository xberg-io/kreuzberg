...
3. Run `alef generate` to regenerate all bindings
...
`alef generate && git diff --exit-code packages/ crates/kreuzberg-node/ crates/kreuzberg-wasm/ crates/kreuzberg-ffi/`
